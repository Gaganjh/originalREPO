...
/**
 * Withdrawal Expired notification event.
 * 
 ...
 * @author penciau
 */
public class ExpiredWithdrawalEventLog extends EventLog {

    private static final String EVENT_NAME = WithdrawalEvent.EXPIRE.getEventName();
     ...
     * @param applicationId
     */
    public ExpiredWithdrawalEventLog() {
        super(ExpiredWithdrawalEventLog.class);
    }
