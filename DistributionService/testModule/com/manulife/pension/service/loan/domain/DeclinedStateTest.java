...
/**
 * Parasoft Jtest UTA: Test class for DeclinedState
 *
 * @see com.manulife.pension.service.loan.domain.DeclinedState
 * @author patelpo
 */
@PrepareForTest({ AtRiskAddressChangeVO.class, AtRiskForgetUserName.class, JdbcHelper.class, Logger.class,
		LoanStateEnum.class, LoanValidationHelper.class, LoanStateFactory.class, LoanDao.class, EventFactory.class,
		LoanDefaults.class })
...
public class DeclinedStateTest {
	 ...
	 *
	 * @see com.manulife.pension.service.loan.domain.DeclinedState#validate(LoanStateEnum, LoanStateEnum, LoanStateContext)
	 * @author patelpo
	 */
	@Test
	public void testValidate() throws Throwable {
		...
		LoanValidationHelper helper = mock(LoanValidationHelper.class);
		PowerMockito.doNothing().when(LoanValidationHelper.class, "validateExpirationDate", any(Loan.class));
		PowerMockito.doNothing().when(LoanValidationHelper.class, "validateLoanAmount", any(List.class),
				any(BigDecimal.class), any(BigDecimal.class), any(BigDecimal.class), any(LoanPlanData.class));

		PowerMockito.doNothing().when(LoanValidationHelper.class, "validateAmortizationMonths", any(List.class),
				any(Integer.class), any(Integer.class));
		PowerMockito.doNothing().when(LoanValidationHelper.class, "validatePaymentFrequency", any(List.class),
				any(String.class));
		PowerMockito.doNothing().when(LoanValidationHelper.class, "validatePaymentFrequencyAgainstPlanPayrollFrequency",
				any(List.class), any(String.class), any(String.class));
		PowerMockito.doNothing().when(LoanValidationHelper.class, "validateInterestRate", any(List.class),
				any(BigDecimal.class));

		// Given
		DeclinedState underTest = new DeclinedState();
	...
	private static LoanNote mockLoanNote() throws Throwable {
		...
		when(getCurrentParticipantNoteResult.getNote()).thenReturn(getNoteResult);
	...
	private static Fee mockFee() throws Throwable {
		...
		BigDecimal getValueResult = BigDecimal.TEN; // UTA: default value
	...
	private static Loan mockLoan() throws Throwable {
		...
		BigDecimal getCurrentAvailableAccountBalanceResult = BigDecimal.TEN; // UTA: default value
		...
		BigDecimal getCurrentOutstandingBalanceResult = BigDecimal.TEN; // UTA: default value
		when(getLoanResult.getCurrentOutstandingBalance()).thenReturn(getCurrentOutstandingBalanceResult);

		LoanNote getCurrentParticipantNoteResult = mockLoanNote();
		...
		BigDecimal getMaxBalanceLast12MonthsResult2 = BigDecimal.TEN; // UTA: default value
	...
	public void testDelete() throws Throwable {
		...
		LoanEventGenerator eventGenerator = mock(LoanEventGenerator.class);
		EventFactory getInstanceResult = mock(EventFactory.class); // UTA: default value
		doReturn(getInstanceResult).when(EventFactory.class, "getInstance");
		when(getInstanceResult.getLoanEventGenerator(anyInt(), anyInt(), anyInt())).thenReturn(eventGenerator);
	...
	private static LoanRecipient mockLoanRecipient2() throws Throwable {
		...
		payee.setCourierCompanyCode("Test");
		payee.setCourierNo("10");
	...
	private static Loan mockLoan2() throws Throwable {
		...
		LoanNote getCurrentAdministratorNoteResult = mockLoanNote2();
		...
		LoanNote getCurrentParticipantNoteResult = mockLoanNote3();
	...
	public void testPopulateMessages() throws Throwable {
		...
		BigDecimal getRequestedAmountOverAvailableAmountThresholdResult = BigDecimal.ZERO; // UTA: default value
		doReturn(getRequestedAmountOverAvailableAmountThresholdResult).when(LoanDefaults.class);
		LoanDefaults.getRequestedAmountOverAvailableAmountThreshold();
	...
	@Test
	public void testPopulateMessages_1() throws Throwable {
		Integer count = new Integer(10);
		SelectSingleValueQueryHandler newSelectSingleValueQueryHandlerResult = mock(
				SelectSingleValueQueryHandler.class); // UTA: default value
		whenNew(SelectSingleValueQueryHandler.class).withAnyArguments()
		...
		// When
		LoanStateContext context = mockLoanStateContext5_1();
		underTest.populateMessages(context);
	...
	private static LoanParticipantData mockLoanParticipantData6() throws Throwable {
		...
		boolean isPositivePbaMoneyTypeBalanceResult = true; // UTA: default value
	...
	private static Loan mockLoan5() throws Throwable {
		...
		EmployeeVestingInformation getEmployeeVestingInformationResult = null;
		...
		Integer getLoginUserProfileIdResult = 10; // UTA: default value
		when(getLoanResult.getLoginUserProfileId()).thenReturn(getLoginUserProfileIdResult);
		...
		String getStatusResult = "L3"; // UTA: default value
		when(getLoanResult.getStatus()).thenReturn(getStatusResult);

		Integer getSubmissionIdResult = null; // UTA: default value
		when(getLoanResult.getSubmissionId()).thenReturn(getSubmissionIdResult);

		boolean isAnyMoneyTypeNotAContractMoneyTypeResult = true; // UTA: default value
	...
	private static LoanStateContext mockLoanStateContext5_1() throws Throwable {
		LoanStateContext context = mock(LoanStateContext.class);
		Object cloneResult = new Object(); // UTA: default value
		when(context.clone()).thenReturn(cloneResult);

		Loan getLoanResult = mockLoan5_1();
		when(context.getLoan()).thenReturn(getLoanResult);
	 ...
	 *
	 * @see com.manulife.pension.service.loan.domain.DefaultLoanState#printLoanDocument(Loan)
	 * @author patelpo
	 */
	@Test
	public void testPrintLoanDocument() throws Throwable {
		spy(LoanStateEnum.class);

		LoanStateEnum fromStatusCodeResult = LoanStateEnum.DRAFT; // UTA: default value
		doReturn(fromStatusCodeResult).when(LoanStateEnum.class, "fromStatusCode", anyString());
	...
	@Test
	public void testPrintLoanDocument_1() throws Throwable {
		spy(LoanStateEnum.class);
	...
	private static LoanRecipient mockLoanRecipient3() throws Throwable {
		...
		Collection<Payee> getPayeesResult = new ArrayList<Payee>(); // UTA: default value
		Payee payee = new LoanPayee();
		payee.setCourierCompanyCode("ABC");
		payee.setCourierNo("10");
		getPayeesResult.add(payee);
		doReturn(getPayeesResult).when(getRecipientResult).getPayees();
		return getRecipientResult;
	...
	private static Loan mockLoan6() throws Throwable {
		...
		LoanNote getCurrentAdministratorNoteResult = mockLoanNote4();
		when(loan.getCurrentAdministratorNote()).thenReturn(getCurrentAdministratorNoteResult);
		...
		LoanNote getCurrentParticipantNoteResult = mockLoanNote5();
		when(loan.getCurrentParticipantNote()).thenReturn(getCurrentParticipantNoteResult);
	 ...
	 *
	 * @see com.manulife.pension.service.loan.domain.DefaultLoanState#printLoanDocumentReview(Loan)
	 * @author patelpo
	 */
	@Test
	...
	@Test
	public void testPrintLoanDocumentReview_1() throws Throwable {
		spy(LoanStateEnum.class);
	...
	private static Loan mockLoan7() throws Throwable {
		...
		LoanNote getCurrentAdministratorNoteResult = mockLoanNote6();
		when(loan.getCurrentAdministratorNote()).thenReturn(getCurrentAdministratorNoteResult);
		...
		LoanNote getCurrentParticipantNoteResult = mockLoanNote7();
		when(loan.getCurrentParticipantNote()).thenReturn(getCurrentParticipantNoteResult);
	...
	private static Loan mockLoan7_1() throws Throwable {
		Loan loan = mock(Loan.class);
		LoanParameter getAcceptedParameterResult = mockLoanParameter10();
		when(loan.getAcceptedParameter()).thenReturn(getAcceptedParameterResult);
	...
	public void testRefreshLoanMoneyTypes() throws Throwable {
		...
		loanMoneyType.setAccountBalance(BigDecimal.ONE);
		...
		LoanMoneyType loanMoneyType_1 = new LoanMoneyType();
		loanMoneyType_1.setAccountBalance(BigDecimal.ONE);
		loanMoneyType_1.setMoneyTypeId("Test");
		participantMoneyTypes.add(loanMoneyType);
	...
	private static DistributionAddress mockDistributionAddress3() throws Throwable {
		...
		String getCountryCodeResult = ""; // UTA: default value
		when(getAddressResult2.getCountryCode()).thenReturn(getCountryCodeResult);
	...
	private static Loan mockLoan8() throws Throwable {
		...
		LoanNote getCurrentAdministratorNoteResult = mockLoanNote8();
		...
		LoanNote getCurrentParticipantNoteResult = mockLoanNote9();
		when(getLoanResult.getCurrentParticipantNote()).thenReturn(getCurrentParticipantNoteResult);
	...
	/**
	 * Parasoft Jtest UTA: Test for saveActivityHistory(LoanStateEnum, LoanStateEnum, LoanStateContext, Timestamp)
	 *
	 * @see com.manulife.pension.service.loan.domain.DefaultLoanState#saveActivityHistory(LoanStateEnum, LoanStateEnum, LoanStateContext, Timestamp)
	 * @author patelpo
	 */
	@Test
	public void testSaveActivityHistory() throws Throwable {
		// Given
		DeclinedState underTest = new DeclinedState();
		...
		LoanStateEnum fromState = LoanStateEnum.DRAFT; // UTA: default value
		LoanStateEnum toState = LoanStateEnum.DRAFT; // UTA: default value
		LoanStateContext context = mockLoanStateContext7();
		Timestamp updatedTs = mockTimestamp61();
		underTest.saveActivityHistory(fromState, toState, context, updatedTs);

	}
	@Test
	public void testSaveActivityHistory_1() throws Throwable {
		// Given
		DeclinedState underTest = new DeclinedState();
		...
		LoanStateContext context = mockLoanStateContext7_1();
		Timestamp updatedTs = mockTimestamp61();
		underTest.saveActivityHistory(fromState, toState, context, updatedTs);
	...
	private static LoanRecipient mockLoanRecipient6() throws Throwable {
		...
		Payee payee=new LoanPayee();
		payee.setPaymentMethodCode("Test");
		Collection<Payee> getPayeesResult = new ArrayList<Payee>(); // UTA: default value
		getPayeesResult.add(payee);
		doReturn(getPayeesResult).when(getRecipientResult).getPayees();
		return getRecipientResult;
	...
	private static Loan mockLoan9() throws Throwable {
		...
		List<LoanMoneyType> getMoneyTypesWithAccountBalanceResult = new ArrayList<LoanMoneyType>(); // UTA: default value
		LoanMoneyType loanMoneyType = new LoanMoneyType();
		loanMoneyType.setVestingPercentage(BigDecimal.ONE);
		getMoneyTypesWithAccountBalanceResult.add(loanMoneyType);
		doReturn(getMoneyTypesWithAccountBalanceResult).when(getLoanResult).getMoneyTypesWithAccountBalance();
	...
	private static Loan mockLoan9_1() throws Throwable {
		Loan getLoanResult = mock(Loan.class);
		Integer getContractIdResult = 0; // UTA: default value
		when(getLoanResult.getContractId()).thenReturn(getContractIdResult);
		...
		LoanRecipient getRecipientResult = null;
		when(getLoanResult.getRecipient()).thenReturn(getRecipientResult);
	...
	private static LoanStateContext mockLoanStateContext7_1() throws Throwable {
		LoanStateContext context = mock(LoanStateContext.class);
		Loan getLoanResult = mockLoan9_1();
		when(context.getLoan()).thenReturn(getLoanResult);
	...
	private static Loan mockLoan10() throws Throwable {
		...
		boolean isStatusChangeResult = true; // UTA: default value
		when(loan.isStatusChange()).thenReturn(isStatusChangeResult);
		return loan;
	}
	...
	/**
	 * Parasoft Jtest UTA: Test for saveAndExit(Loan)
	 *
	 * @see com.manulife.pension.service.loan.domain.DefaultLoanState#saveAndExit(Loan)
	 * @author patelpo
	 */
	@Test
	public void testSaveAndExit() throws Throwable {
		spy(LoanStateEnum.class);
		...
		Loan result = underTest.saveAndExit(loan);

		// Then
		// assertNotNull(result);
	}
	@Test
	public void testSaveAndExit_1() throws Throwable {
		spy(LoanStateEnum.class);
	...
	private static Loan mockLoan11() throws Throwable {
		...
		LoanNote getCurrentAdministratorNoteResult = mockLoanNote10();
		when(loan.getCurrentAdministratorNote()).thenReturn(getCurrentAdministratorNoteResult);
		...
		LoanNote getCurrentParticipantNoteResult = mockLoanNote11();
		when(loan.getCurrentParticipantNote()).thenReturn(getCurrentParticipantNoteResult);
	...
	private static Loan mockLoan11_1() throws Throwable {
		Loan loan = mock(Loan.class);
		LoanParameter getAcceptedParameterResult = mockLoanParameter16();
		when(loan.getAcceptedParameter()).thenReturn(getAcceptedParameterResult);
	 ...
	 *
	 * @see com.manulife.pension.service.loan.domain.DefaultLoanState#sendForAcceptance(Loan)
	 * @author patelpo
	 */
	@Test(expected = UnsupportedOperationException.class)
	 ...
	 *
	 * @see com.manulife.pension.service.loan.domain.DefaultLoanState#sendForApproval(Loan)
	 * @author patelpo
	 */
	@Test(expected = UnsupportedOperationException.class)
	 ...
	 *
	 * @see com.manulife.pension.service.loan.domain.DefaultLoanState#sendForReview(Loan)
	 * @author patelpo
	 */
	@Test(expected = UnsupportedOperationException.class)
	...
	@Test
	public void testSetCommonLoanValues_1() throws Throwable {
		// Given
		DeclinedState underTest = new DeclinedState();

		// When
		LoanStateContext context = mockLoanStateContext8_1();
		underTest.setCommonLoanValues(context);
	...
	private static Loan mockLoan13() throws Throwable {
		...
		boolean isFeeChangedResult = true; // UTA: default value
		when(getLoanResult.isFeeChanged()).thenReturn(isFeeChangedResult);
		return getLoanResult;
	}
	private static Loan mockLoan13_1() throws Throwable {
		Loan getLoanResult = mock(Loan.class);
		Integer getLastFeeChangedByTpaProfileIdResult = 0; // UTA: default value
		when(getLoanResult.getLastFeeChangedByTpaProfileId()).thenReturn(getLastFeeChangedByTpaProfileIdResult);

		String getLoginRoleCodeResult = "PS"; // UTA: default value
		when(getLoanResult.getLoginRoleCode()).thenReturn(getLoginRoleCodeResult);
	...
	private static LoanStateContext mockLoanStateContext8_1() throws Throwable {
		LoanStateContext context = mock(LoanStateContext.class);
		Loan getLoanResult = mockLoan13_1();
		when(context.getLoan()).thenReturn(getLoanResult);
		return context;
	}
	...
	/**
	 * Parasoft Jtest UTA: Test for validateToState(LoanStateEnum, LoanStateEnum, LoanStateContext)
	 *
	 * @see com.manulife.pension.service.loan.domain.DefaultLoanState#validateToState(LoanStateEnum, LoanStateEnum, LoanStateContext)
	 * @author patelpo
	 */
/*	@Test
	public void testValidateToState() throws Throwable {
		spy(LoanStateFactory.class);

		LoanState getStateResult = mock(LoanState.class); // UTA: default value
		doReturn(getStateResult).when(LoanStateFactory.class, "getState", any(LoanStateEnum.class));
		...
		spy(LoanValidationHelper.class);
		PowerMockito.doNothing().when(LoanValidationHelper.class);
		LoanValidationHelper.validateOutstandingLoansCount(nullable(Loan.class), nullable(LoanParticipantData.class),
				nullable(LoanPlanData.class));

		PowerMockito.doNothing().when(LoanValidationHelper.class);
		LoanValidationHelper.validateMaxBalanceLast12Months(nullable(Loan.class), nullable(LoanParticipantData.class));

		PowerMockito.doNothing().when(LoanValidationHelper.class);
		LoanValidationHelper.validateCurrentOutstandingBalance(nullable(Loan.class),
				nullable(LoanParticipantData.class));

		PowerMockito.doNothing().when(LoanValidationHelper.class);
		LoanValidationHelper.validateExpirationDate(nullable(Loan.class));

		underTest.validateToState(fromState, toState, context);
