...
/**
 * Comparator implementation by request date only.
 * 
 * @author Mihai Popa
 */
public class LoanAndWithdrawalItemRequestDateSimpleComparator extends LoanAndWithdrawalItemComparator {

	public LoanAndWithdrawalItemRequestDateSimpleComparator() {
		super();
	}
	
	public LoanAndWithdrawalItemRequestDateSimpleComparator(boolean ascending) {
		super(ascending);
	}
