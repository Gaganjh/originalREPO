 ...
 *
 */
public class AddressChangesExternalReportData extends ReportData {
	...
	public AddressChangesExternalReportData() {
		super( new ReportCriteria(AddressChangesExternalReportHandler.REPORT_ID), 0);
