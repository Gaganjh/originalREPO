...
public class OptionTag extends BodyTagSupport {
    ...
    protected String text = null;
        ...
        protected String bundle = Constants.MESSAGES_KEY;
  ...
  protected String locale = Constants.LOCALE_KEY;
   ...
   private String styleClass = null;
    ...
    private SelectTag selectTag()
        ...
        if (selectTag == null) {
            JspException e =
                new JspException("optionTag.select");
