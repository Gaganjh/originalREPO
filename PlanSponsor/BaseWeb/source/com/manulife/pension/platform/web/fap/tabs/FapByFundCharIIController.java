...
/**
 * Action class, to enable the Fund Characteristics 2 tab. It gets the 
 * value object for his tab and sets in request.
 * 
 * @author ayyalsa
 *
 */
public class FapByFundCharIIController extends FapController{
	...
	public String doFilter(
		...
		if (!fapForm.isDisplayOnlyHeaders()) {
			...
			LinkedHashMap<String, List<? extends FundBaseInformation>> currentTabValueObject =
		        	...
		        	getTabValueObject(request, fapForm, FapConstants.FUND_CHAR_II_TAB_ID, false);
    	...
    	request.setAttribute(FapConstants.COLUMNS_INFO_OBJECT, 
    			FapTabUtility.createFundCharacteristics2TabColumns());
