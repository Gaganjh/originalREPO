 ...
 * @author Charles Chan
 */
public class BDSortLinkTag extends PrintFriendlyLinkTag {
	...
	public int doEndTag() throws JspException {
		...
		ReportSort currentSort = getCurrentReportSort(pageContext,formName);
	 ...
	 *             direction.
	 */
	protected ReportSort getCurrentReportSort(PageContext pageContext,String formName)
			throws JspException {
		/*
	...
	public int doStartTag() throws JspException {
		...
		if (currentSort != null) {
			if (currentSort.getSortField().equals(getField())) {
				if(currentSort.isAscending()){
					results.append("  class = \"sort_ascending\" ");
				}else{
					results.append("  class = \"sort_descending\" ");
				}
			}
		}
