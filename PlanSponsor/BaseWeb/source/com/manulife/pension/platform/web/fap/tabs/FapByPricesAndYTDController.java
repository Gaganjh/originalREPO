...
/**
 * Action class, to enable the PricesAndYTD tab. It gets the 
 * value object for his tab and sets in request.
 * 
 * @author ayyalsa
 *
 */
public class FapByPricesAndYTDController extends FapController {
	...
	public String doFilter(
		...
		if (!fapForm.isDisplayOnlyHeaders()) {
			...
			LinkedHashMap<String, List<? extends FundBaseInformation>> currentTabValueObject =
		        	...
		        	getTabValueObject(request, fapForm, FapConstants.PRICES_YTD_TAB_ID, false);
    	...
    	request.setAttribute(FapConstants.COLUMNS_INFO_OBJECT,
    			FapTabUtility.createPricesAndYTDTabColumns());
