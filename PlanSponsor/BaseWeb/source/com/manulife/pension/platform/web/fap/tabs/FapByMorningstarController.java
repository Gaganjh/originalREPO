...
/**
 * Action class, to enable the Morningstar tab. It gets the 
 * value object for his tab and sets in request.
 * 
 * @author ayyalsa
 *
 */
public class FapByMorningstarController extends FapController {
	...
	public String doFilter(
		...
		if (!fapForm.isDisplayOnlyHeaders()) {
			...
			LinkedHashMap<String, List<? extends FundBaseInformation>> currentTabValueObject =
		        	...
		        	getTabValueObject(request, fapForm, FapConstants.MORNINGSTAR_TAB_ID, false);
		...
		request.setAttribute(FapConstants.COLUMNS_INFO_OBJECT, FapTabUtility
				.createMorningstarTabColumns(FapConstants.WEB_FORMAT));
