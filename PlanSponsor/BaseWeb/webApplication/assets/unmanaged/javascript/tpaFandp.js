 ...
 */
function fund(fundId, fundName, managerName, assetClass) {
    this.fundId = fundId;
...
// **********  Dialog functions ********
    ...
    function hideAllSelectBox(except) {
        ...
        for (i = 0; i < x.length; i++) {
            ...
            document.getElementById("viewAdvancedBtn").focus();
        }
...
// ********* Panel Functions ************
    ...
    function toggleAdvancedOptions() {
        ...
        if (section.style.display=='none') {
            setAdvancedFilterButtonText("Hide Customizations");
           // applyBaseFilter();
            enableOrDisableApplyFiltersButton();
            show('btn_newQuery');
            show('btn_editQuery');
    ...
    function enableOrDisableDeleteButton(selectBox, deleteButton) {
     ...
     /**
      * Shows the checkbox "Display only SIG+ Funds" while selecting Signature + in class Drop down
 	 */
     function showOrHideOnlySigPlusFunds(){
