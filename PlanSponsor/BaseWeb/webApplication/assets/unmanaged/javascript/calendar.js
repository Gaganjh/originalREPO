...
function calendar(obj_target) {
	...
	if (!obj_target)
		return cal_error("Error calling the calendar. (Code: 1)");
	if (obj_target.value == null)
		return cal_error("Error calling the calendar.  (Code: 2)");
...
function cal_prs_date1 (str_date) {
	...
	if (arr_date[2] >9999) return cal_error ("Invalid date format: '" + str_date + "'.\nFormat accepted is mm/dd/yyyy.");
