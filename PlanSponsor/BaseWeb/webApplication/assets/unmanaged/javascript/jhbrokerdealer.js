...
$(document).ready(function(){
	...
	$("#site_search_input").select();
	$("#site_search_input_lower").select();
	
	$("table#participants_table").mouseout(function(){
		$("a.transaction_history").css({display:"none"});
	});
	
	$("table#participants_table td").mouseover(function(){
		$("a.transaction_history").css({display:"none"});
			
	});
	
	$("table#participants_table td.name").mouseover(function(){
		$("a.transaction_history").css({display:"none"});
