...
<content:contentBean contentId="<%=BDContentConstants.ADD_BOB_LEVEL1_FINISH%>" 
    type="<%=BDContentConstants.TYPE_MESSAGE%>" id="finishMessage" />

<c:set var="form" value="${createBOBForm}" scope="page"/>

<utils:cancelProtection name="creaetBOBForm" changed="true" exclusion="['action']"/>
...
<report:formatMessages scope="request"/>
	...
	<form:hidden path="action"/>
       ...
       <input type="button" class="blue-btn next" 
	        ...
	        onclick="return doProtectedSubmitBtn(document.createBOBForm, 'add', this)">
        </div> 
