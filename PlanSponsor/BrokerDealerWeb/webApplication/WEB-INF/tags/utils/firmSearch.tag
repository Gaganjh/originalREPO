...
<div class="yui-skin-sam">
	<div id="firmSearch">
		<input type="hidden" name="lastSelectedFirmName" id="lastSelectedFirmName"/>
		...
		<div id="firmSearchContainer"></div>
	</div>
</div>
...
<script type="text/javascript">
    ...
    var oAC = new YAHOO.widget.AutoComplete("${firmName}", "firmSearchContainer", oDS);
	...
	function selectEvent_Callback(e, args) {
		...
		YAHOO.util.Dom.get("lastSelectedFirmName").value = args[2][0];
