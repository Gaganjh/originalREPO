...
<content:contentBean contentId="<%=BDContentConstants.BOB_ASSETS_COLUMN_IN_DI_TAB_FOOTNOTE%>"
        type="<%=BDContentConstants.TYPE_PAGEFOOTNOTE%>"
        id="assetsColumnInDITabFootNote"/>
...
<div class="page_section_subheader controls page_section_subheader_increased_height">
	...
	<bob:bobFilters filterType="quickFilter" actionURL="/do/bob/blockOfBusiness/Discontinued/" reportAsOfDtEnabled="true"/>
...
<div class="report_table">
	<div id="bob_overview_report">
		<div id="report_customization_wrapper">	
			...
			<bob:bobFilters filterType="advancedFilter" actionURL="/do/bob/blockOfBusiness/Discontinued/"/>
...
<div class="footnotes">
	...
	<c:if test="${blockOfBusinessForm.showDIFootnote}">
		<dl><dd><content:getAttribute beanName="assetsColumnInDITabFootNote" attribute="text"/></dd></dl>
	</c:if>
