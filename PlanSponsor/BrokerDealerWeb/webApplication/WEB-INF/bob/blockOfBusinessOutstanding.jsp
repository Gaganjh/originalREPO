...
<content:contentBean contentId="<%=BDContentConstants.BOB_PN_PP_CONTRACT_CNT_ASOFLATESTDATE_FOOTNOTE%>"
        type="<%=BDContentConstants.TYPE_PAGEFOOTNOTE%>"   id="PNAndPPContractCountAsOfLatestDateFootnote"/>
...
<div class="page_section_subheader controls page_section_subheader_increased_height">
	...
	<bob:bobFilters filterType="quickFilter" actionURL="/do/bob/blockOfBusiness/OutstandingProposals/" reportAsOfDtEnabled="false"/>
...
<div class="report_table">
	<div id="bob_overview_report">
		...
		<bob:bobFilters filterType="advancedFilter" actionURL="/do/bob/blockOfBusiness/OutstandingProposals/"/>	
