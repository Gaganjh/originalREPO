...
<div class="page_section_subheader controls page_section_subheader_increased_height">
	...
	<bob:bobFilters filterType="quickFilter" actionURL="/do/bob/blockOfBusiness/Active/" reportAsOfDtEnabled="true"/>
...
<div class="report_table">
	<div id="bob_overview_report">
		<div id="report_customization_wrapper">	
			...
			<bob:bobFilters filterType="advancedFilter" actionURL="/do/bob/blockOfBusiness/Active/"/>
