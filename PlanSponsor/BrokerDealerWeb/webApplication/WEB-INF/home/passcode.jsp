...
<div class="page_section" id="passcode_page">
	<div class="page_module_passcode" id="page_module_passcode">
		...
		<bd:form action="/do/stepupPasscode/" method="POST" onsubmit="return doPreSubmit();" modelAttribute="passcodeForm" name="passcodeForm">
			<p>
			...
			<p>
				...
				<br class="clearFloat" /> <br class="clearFloat" /> <strong><a
					href="javascript:;"
					onclick="doPreSubmit(),document.forms['passcodeForm'].submit();"> Resend
