...
<un:useConstants var="contentConstants"
	className="com.manulife.pension.platform.web.content.CommonContentConstants" />
...
<c:if test="${tabObject.morningstarFootNoteCMAId !=0}">
			<P>
<c:if test="${tabObject.morningstarFootNoteCMAId == contentConstants.MORNINGSTAR_3_5_10_YR_FOOTNOTE}">
...
<c:if test="${tabObject.morningstarFootNoteCMAId == contentConstants.MORNINGSTAR_3_5_YR_FOOTNOTE}">
...
<c:if test="${tabObject.morningstarFootNoteCMAId == contentConstants.MORNINGSTAR_3_YR_FOOTNOTE}">
