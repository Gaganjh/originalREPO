...
<c:set var="phoneNumber" value="${registerFirmRepStep2Form.creationVO.phoneNumber}" />

<script type="text/javascript">
<!--
function doOnload() {
    var address1=document.forms['registerFirmRepStep2Form'].elements['address.address1'];
    if (address1) {
        try {
        	address1.focus();
        } catch (e) {
...
var seqConsIND = true;
 function doServerValidation(csrfToken){
		...
		var url = "/do/registerFirmRep/step2/ajaxvalidator/?"+"_csrf="+csrfToken;
...
<c:set var="form" value="${requestScope.registerFirmRepStep2Form}" scope="page"/>
<div id="content">
<bd:form action="/do/registerFirmRep/step2" modelAttribute="registerFirmRepStep2Form" name="registerFirmRepStep2Form">
...
<br class="clearFloat" />  
<userprofile:terms termId="<%=BDContentConstants.REGISTRATION_FIRM_REP_TERMS_TEXT%>"/>
    <div class="formButtons">
       ...
       <input type="button" class="blue-btn next" 
	        ...
	        onclick="return doProtectedSubmitBtn(document.registerFirmRepStep2Form, 'continue', this)">
    </div> 
    ...
    <div class="formButton">
      <input type="button" class="grey-btn back" 
             ...
             onclick="return doRegistrationCancel(document.registerFirmRepStep2Form, '<content:getAttribute id='cancelMessage' attribute='text' />', this)"> 
    </div>
    </div>
</bd:form>
