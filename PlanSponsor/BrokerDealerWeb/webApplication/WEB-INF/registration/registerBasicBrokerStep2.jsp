...
<c:set var="form" value="${requestScope.registerBasicBrokerStep2Form}" scope="page"/>
...
var seqConsIND = true;
 function doServerValidation(csrfToken){
		...
		var url = "/do/registerExternalBroker/basicBroker/step2/ajaxvalidator/?"+"_csrf="+csrfToken;
...
<div id="content">
	<bd:form action="/do/registerExternalBroker/basicBroker/step2" modelAttribute="registerBasicBrokerStep2Form" name="registerBasicBrokerStep2Form">
		...
		<br class="clearFloat" />  
		<userprofile:terms termId="<%=BDContentConstants.REGISTRATION_BASIC_BROKER_TERMS_TEXT%>"/>
		<br class="clearFloat"/>
       ...
       <div class="formButton"> 
	        ...
	        name="register" value="Register" id="continue"
	        onclick="return doProtectedSubmitBtn(document.registerBasicBrokerStep2Form, 'continue', this)">
         </div> 
	    <div class="formButton">
	      <input type="button" class="grey-btn back" 
	             ...
	             onclick="return doRegistrationCancel(document.registerBasicBrokerStep2Form, '<content:getAttribute id='cancelMessage' attribute='text' />', this)"> 
	    </div>
	    </div>
	</bd:form>
<layout:pageFooter/>
