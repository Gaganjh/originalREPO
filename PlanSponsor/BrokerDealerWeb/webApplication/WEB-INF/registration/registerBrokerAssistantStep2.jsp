...
<c:set var="form" value="${requestScope.registerBrokerAssistantStep2Form}" scope="page"/>
...
var seqConsIND = true;
 function doServerValidation(csrfToken){
		...
		var url = "/do/registerBrokerAssistant/step2/ajaxvalidator/?"+"_csrf="+csrfToken;
...
<div id="content">
	<bd:form action="/do/registerBrokerAssistant/step2" modelAttribute="registerBrokerAssistantStep2Form" name="registerBrokerAssistantStep2Form">
		...
		<div class="OverFlow">
			...
			<div class="inputText">
				<label>
${registerBrokerAssistantStep2Form.creationVO.firstName} ${registerBrokerAssistantStep2Form.creationVO.lastName}
				</label>
			</div>
		...
		<br class="clearFloat" />  
		<userprofile:terms termId="<%=BDContentConstants.REGISTRATION_ASSISTANT_TERMS_TEXT%>"/>
	    ...
	    <div class="formButtons">
	       ...
	       <input type="button" class="blue-btn next" 
		        ...
		        onclick="return doProtectedSubmitBtn(document.registerBrokerAssistantStep2Form, 'continue', this)">
        </div> 
	    <div class="formButton">
	      <input type="button" class="grey-btn back" 
	             ...
	             onclick="return doRegistrationCancel(document.registerBrokerAssistantStep2Form, '<content:getAttribute id='cancelMessage' attribute='text' />', this)"> 
	    </div>
	    </div>
	</bd:form>
<layout:pageFooter/>
