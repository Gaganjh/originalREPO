...
<content:contentBean
	contentId="${bdContentConstants.IPS_PARTICIPANT_OVERLAY_PAGE_TITLE}"
	type="${bdContentConstants.TYPE_MISCELLANEOUS}"
	id="ipsParticipantOverlayTitle" />
	
<content:contentBean
	contentId="${bdContentConstants.IPS_CONTACT_NAME_TEXT}"
	type="${bdContentConstants.TYPE_MISCELLANEOUS}"
	id="ipsContactNameText" />
	
<content:contentBean
	contentId="${bdContentConstants.IPS_CONTACT_INFO_TEXT}"
	type="${bdContentConstants.TYPE_MISCELLANEOUS}"
	id="ipsContactInfoText" />
	
<content:contentBean
	contentId="${bdContentConstants.IPS_CONTACT_COMMENT_TEXT}"
	type="${bdContentConstants.TYPE_MISCELLANEOUS}"
	id="ipsContactCommentText" />
	
<content:contentBean
	contentId="${bdContentConstants.LABEL_STREET_ADDRESS}"
	type="${bdContentConstants.TYPE_MISCELLANEOUS}"
	id="street" />
	
<content:contentBean
	contentId="${bdContentConstants.LABEL_CITY_AND_STATE}"
	type="${bdContentConstants.TYPE_MISCELLANEOUS}"
	id="city" />
	
<content:contentBean
	contentId="${bdContentConstants.LABEL_ZIP_CODE}"
	type="${bdContentConstants.TYPE_MISCELLANEOUS}"
	id="zipCode" />
	<bd:form  method="POST" modelAttribute="ipsViewParticiapantNotificationForm" name="ipsViewParticiapantNotificationForm" action="/do/dummy/" >
...
<table width="350" border="0" cellspacing="0" cellpadding="0">
	...
	<tr height="30">
		...
		<td width="80">
<form:input path="contactName" maxlength="60" size="26" ></form:input>
		</td>
	</tr>	
	<tr height="30">
		<td width="20">
...
-<form:input path="telephoneNumber.phonePrefix" maxlength="3" onkeyup="return autoTab(this, 3, event);" size="3" /><%-- <form:input - name="ipsViewParticiapantNotificationForm" --%>
-<form:input path="telephoneNumber.phoneSuffix" maxlength="4" size="4" /><%-- <form:input - name="ipsViewParticiapantNotificationForm" --%>
	...
	<tr height="30">
		...
		<td width="100">
<form:textarea path="comments" onkeydown="limitText(this.form.comments,this.form.countdown,300)" ><%-- name="ipsViewParticiapantNotificationForm" --%></form:textarea>
		</td>
	</tr>
</table>
...
<table width="325" border="0" cellspacing="0" cellpadding="0">	
    ...
    <tr>
        ...
        <td >
            ...
            <input class="button100Lg" id="Generate" type="button" value="Generate" onclick="doViewReportsPs('${reviewRequestId}','${isFromLandingPage}','true')"/>
        </td>
    </tr>
</table>
</bd:form>
