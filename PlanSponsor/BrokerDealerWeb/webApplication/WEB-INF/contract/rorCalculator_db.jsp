...
function doPrintPDF() {
	var reportURL = new URL("/do/bob/contract/RORCalculatorDb/?action=printPDFReport");
...
<bd:form action="/do/bob/contract/RORCalculatorDb/" method="POST" modelAttribute="rateOfReturnCalculatorForm" name="rateOfReturnCalculatorForm">
<input type="hidden" name="action"/>
<div class="page_section_subheader controls">
      <%-- date filter and table heading section --%>
<h3><content:getAttribute beanName="layoutPageBean" attribute="body1Header"/> <span style="font-size: 13px;">${rateOfReturnCalculatorForm.contractName}</span></h3>
