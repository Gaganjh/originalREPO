...
<html>
<body>
<input type="hidden" name="selectedPlanReviewActivityId" id="selectedPlanReviewActivityId" value="${e:forHtmlAttribute(requestScope.selectedPlanReviewActivityId)}"/>
...
<input type="hidden" name="planReviewHistoryDetailsReportForm" id="_csrf" value="${requestScope._csrf.token}"/>
...
<script type="text/javascript">
	...
	var activityId = document.getElementById("selectedPlanReviewActivityId").value;
	...
	if(planReviewLevel == 'bob') {
		openPDF("/do/bob/planReview/HistoryDetails/?task=viewPdf", activityId, type,csrf);
	} else {
		openPDF("/do/bob/contract/planReview/HistoryDetails/?task=viewPdf", activityId, type,csrf);
	}
	...
	function openPDF(url, activityId, docType,csrf) {
		...
		contractInput.setAttribute("name", "selectedPlanReviewActivityId");
		contractInput.setAttribute("value", activityId);
