...
public class PlanReviewReportPrintHistoryDetailsContractController extends BasePlanReviewHistoryReportController {
	...
	static{
		//TODO: Redirect not added properly S2S
		forwards.put("default","/contract/planReview/individualHistoryDetails.jsp" );
       	forwards.put("planReviewRequest","redirect:/do/bob/contract/planReview/" );
        forwards.put("viewDisable","/contract/planReview/individualHistoryDetails.jsp" );	
        forwards.put("printRequest","/contract/planReview/individualHistoryDetails.jsp" );
        ...
        forwards.put("deletePlanReviewReport","/do/bob/contract/planReview/History/?task=navigatedFromDetails" );
        forwards.put("sort","/contract/planReview/individualHistoryDetails.jsp" );
        forwards.put("contractReviewReportStep1Page","/do/bob/contract/planReview/");
        forwards.put("reSubmitPlanReviewPrintRequest","/contract/planReview/individualHistoryDetails.jsp");
        forwards.put("filter","/contract/planReview/individualHistoryDetails.jsp");
        forwards.put("page","/contract/planReview/individualHistoryDetails.jsp");
        forwards.put("print","redirect:/do/bob/contract/planReview/Print/");
       forwards.put("homePage","/do/home/");
        forwards.put("backToMainHistory","redirect:/do/bob/contract/planReview/History/?task=navigatedFromDetails");
	...
	protected static final Logger logger = Logger.getLogger(PlanReviewReportPrintHistoryDetailsContractController.class);
	
	public PlanReviewReportPrintHistoryDetailsContractController() {
		super(PlanReviewReportPrintHistoryDetailsContractController.class);
	}
	
	String params= "contract";
	...
	@RequestMapping(value ="/contract/planReview/HistoryDetails/" ,method =  {RequestMethod.GET}) 
	...
	@RequestMapping(value = "/contract/planReview/HistoryDetails/", params = {"task=filter"}, method = {RequestMethod.POST})
	...
	@RequestMapping(value = "/contract/planReview/HistoryDetails/", params = {"task=page"}, method = {RequestMethod.POST})
	...
	@RequestMapping(value = "/contract/planReview/HistoryDetails/", params = {"task=sort"}, method = {RequestMethod.POST})
	 ...
	 */
	@RequestMapping(value ="/contract/planReview/HistoryDetails/", params={"task=print"} , method =  {RequestMethod.POST}) 
	 ...
	 * @throws SystemException
	 */
	@RequestMapping(value ="/contract/planReview/HistoryDetails/" ,params={"task=reSubmitPlanReviewPrintRequest"}   , method =  {RequestMethod.POST}) 
	 ...
	 * @throws SystemException
	 */
	@RequestMapping(value ="/contract/planReview/HistoryDetails/", params={"task=backToMainHistory"} , method =  {RequestMethod.POST}) 
	 ...
	 * @throws SystemException
	 */
	@RequestMapping(value ="/contract/planReview/HistoryDetails/", params={"task=shippingDetails"} , method =  {RequestMethod.POST}) 
	 ...
	 * @throws SystemException
	 */
	@RequestMapping(value ="/contract/planReview/HistoryDetails/", params={"task=showViewDisableReport"}, method =  {RequestMethod.POST}) 
	 ...
	 *  
	 */
	@RequestMapping(value ="/contract/planReview/HistoryDetails/", params={"task=deletePlanReviewReport"}, method =  {RequestMethod.POST}) 
	...
	@RequestMapping(value ="/contract/planReview/HistoryDetails/", params={"task=planReviewRequest"}, method =  {RequestMethod.POST}) 
	 ...
	 * @throws SystemException
	 */
	@RequestMapping(value ="/contract/planReview/HistoryDetails/", params={"task=viewPdf"}, method =  {RequestMethod.POST}) 
	...
	@RequestMapping(value ="/contract/planReview/HistoryDetails/", params={"task=openPdfWindow"}, method =  {RequestMethod.POST,}) 
	...
	return forwards.get(errDirect)!=null?forwards.get(errDirect):forwards.get("input");//if input forward not //available, provided default
		...
		String viewPdfRequestType = Encode.forHtmlContent(form.getType());
	 ...
	 * @throws SystemException
	 */
	@RequestMapping(value ="/contract/planReview/HistoryDetails/", params={"task=downloadPdf"}, method =  {RequestMethod.POST}) 
	 ...
	 * @throws SystemException
	 */
	@RequestMapping(value ="/contract/planReview/HistoryDetails/", params={"task=downloadSelectedPdf"}, method =  {RequestMethod.POST}) 
     ...
     * @throws SystemException 
     */
	 @RequestMapping(value ="/contract/planReview/HistoryDetails/", params={"task=checkDownloadPdfGenerated"} , method =  {RequestMethod.GET}) 
     ...
     * @throws SystemException 
     */
    @RequestMapping(value ="/contract/planReview/HistoryDetails/", params={"task=checkDownloadSelectedPdfGenerated"} , method =  {RequestMethod.GET}) 
	 ...
	 * @return ActionForward
	 */
	    @RequestMapping(value ="/contract/planReview/HistoryDetails/", params={"task=csrfError"} , method =  {RequestMethod.POST,RequestMethod.GET}) 
