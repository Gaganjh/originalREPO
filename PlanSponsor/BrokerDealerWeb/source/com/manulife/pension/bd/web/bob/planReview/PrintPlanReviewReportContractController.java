...
public class PrintPlanReviewReportContractController extends BasePlanReviewReportController {
	...
	static{
		forwards.put("input","/contract/planReview/printIndividualPlanReviewReport.jsp");
		forwards.put("default","/contract/planReview/printIndividualPlanReviewReport.jsp");
		forwards.put("sort","/contract/planReview/printIndividualPlanReviewReport.jsp");
	...
	protected static final Logger logger = Logger.getLogger(PrintPlanReviewReportContractController.class);
	...
	public PrintPlanReviewReportContractController() {
		super(PrintPlanReviewReportContractController.class);
	 ...
	 */
	@RequestMapping(value ="/contract/planReview/Print/",  method =  {RequestMethod.GET}) 
	...
	return forwards.get(errDirect)!=null?forwards.get(errDirect):forwards.get("input");//if input forward not //available, provided default
		...
		if (StringUtils.equalsIgnoreCase(BDConstants.PR_CONTRACT_LEVEL_PARAMETER,"contract")) {

			for (PlanReviewReportUIHolder uiHolder : uiHolderList) {
				uiHolder.setPrintContractSelected(true);
			}
		}
...
//TODO need to checkthe value of mapping.getparameter
		//request.setAttribute(BDConstants.BOB_LEVEL_RESULTS_PAGE,mapping.getParameter());
	...
	@RequestMapping(value ="/contract/planReview/Print/",params={"task=filter"} , method =  {RequestMethod.POST}) 
	public String doFilter (@Valid @ModelAttribute("planReviewPrintForm") PlanReviewPrintForm form, BindingResult bindingResult,HttpServletRequest request,HttpServletResponse response) 
			throws IOException,ServletException, SystemException {
	...
	@RequestMapping(value ="/contract/planReview/Print/",params= {"task=planReviewRequest"},  method =  {RequestMethod.POST}) 
	...
	protected String doCommon(
		...
		List<PlanReviewReportUIHolder> planReviewPrintVOList = ((PlanReviewReportForm) actionForm)
	 ...
	 * @throws SystemException
	 */
	@RequestMapping(value ="/contract/planReview/Print/",params= {"task=printShipping"},  method =  {RequestMethod.POST}) 
	 ...
	 * @throws SystemException
	 */
	@RequestMapping(value ="/contract/planReview/Print/",params= {"task=printConfirm"},  method =  {RequestMethod.POST}) 
	 ...
	 * @throws SystemException
	 */
	@RequestMapping(value ="/contract/planReview/Print/",params= {"task=clearPrintReports"},  method =  {RequestMethod.POST}) 
	...
	@RequestMapping(value ="/contract/planReview/Print/",params= {"task=validateUserPrintRequestLimit"},  method =  {RequestMethod.POST}) 
	...
	@RequestMapping(value ="/contract/planReview/Print/",params= {"task=displayPrintErrors"},  method =  {RequestMethod.POST}) 
	 ...
	 * @throws SystemException
	 */
	@RequestMapping(value ="/contract/planReview/Print/",params= {"task=errorMsg"},  method =  {RequestMethod.POST}) 
	 ...
	 * @throws SystemException
	 */
	@RequestMapping(value ="/contract/planReview/Print/",params= {"task=submit"},  method =  {RequestMethod.POST}) 
	 ...
	 * @throws SystemException
	 */
	@RequestMapping(value ="/contract/planReview/Print/",params= {"task=sort"},  method =  {RequestMethod.POST}) 
	...
	@RequestMapping(value ="/contract/planReview/Print/",params= {"task=getStateDropdownValues"},  method =  {RequestMethod.GET}) 
	 ...
	 * @throws SystemException
	 */
	@RequestMapping(value ="/contract/planReview/Print/",params= {"task=history"},  method =  {RequestMethod.POST}) 
	 ...
	 * @throws SystemException
	 */
	@RequestMapping(value ="/contract/planReview/Print/",params= {"task=getBrokerDefaultAddress"},  method =  {RequestMethod.POST}) 
	 ...
	 */
	  @RequestMapping(value ="/contract/planReview/Print/",params= {"task=csrfError"},  method =  {RequestMethod.POST}) 
