...
public class LarkspurRedirectController extends BDController {
    ...
    private static final String URL = "https://larkspurweb.com/planisphere/loginExternal.aspx?ProductSelector=PSP&User=manulifeus&Agree=on&PW=JHancock2020&";
     ...
     * Constructor.
     */
    public LarkspurRedirectController() {
        super(LarkspurRedirectController.class);
    }
	...
	throws IOException,ServletException, SystemException {	
        ...
        if (logger.isDebugEnabled()) {
            logger.debug("Entry -> Larkspur Redirect Action");
        }
        ...
        if (logger.isDebugEnabled()) {
            logger.debug("Exit <- Larkspur Redirect Action");
        }
