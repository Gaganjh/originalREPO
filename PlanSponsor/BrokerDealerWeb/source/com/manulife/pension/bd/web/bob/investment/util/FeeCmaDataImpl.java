...
import com.manulife.pension.bd.web.bob.investment.util.Constants.CmaKeys;
...
public class FeeCmaDataImpl implements FeeCmaData, Serializable {
	...
	// Footnotes 1 CL0
	public String getFooter1ClassZeroLabel(boolean appendComma) throws SystemException { 
		return getContent(CmaKeys.FOOTER_F1_CLASS_ZERO_KEY.getContentId());
	}
	
	// Footnotes 1 NON-CL0
	public String getFooter1NonClassZeroLabel(boolean appendComma) throws SystemException { 
		return getContent(CmaKeys.FOOTER_F1_NON_CLASS_ZERO_KEY.getContentId());
	}
