...
public class BlockOfBusinessOutStandingController extends BDReportController {
	...
	static{
		forwards.put("input","/bob/blockOfBusinessOutstanding.jsp");
		forwards.put("blockOfBusinessOutstanding","/bob/blockOfBusinessOutstanding.jsp");
    	forwards.put("inputRedirect","redirect:/do/bob/blockOfBusiness/OutstandingProposals/");
    	forwards.put("bobToContractInformation","redirect:/do/bob/contract/contractInformation/");
    	forwards.put("default","/bob/blockOfBusinessOutstanding.jsp");
    	forwards.put("sort","/bob/blockOfBusinessOutstanding.jsp");
    	forwards.put("filter","/bob/blockOfBusinessOutstanding.jsp");
    	forwards.put("page","/bob/blockOfBusinessOutstanding.jsp");
    	forwards.put("download","/bob/blockOfBusinessOutstanding.jsp");
    	forwards.put("downloadAll","/bob/blockOfBusinessOutstanding.jsp");
    	forwards.put("printPDF","/bob/blockOfBusinessOutstanding.jsp");
    	forwards.put("refresh","/bob/blockOfBusinessOutstanding.jsp");
    ...
    private Logger logger = Logger.getLogger(BlockOfBusinessOutStandingController.class);
     ...
     * Constructor class.
     */
    public BlockOfBusinessOutStandingController() {
        super(BlockOfBusinessOutStandingController.class);
    }
    ...
    @RequestMapping(value = {"/blockOfBusiness/OutstandingProposals/"},  method ={RequestMethod.POST,RequestMethod.GET}) 
    ...
    @RequestMapping(value = {"/blockOfBusiness/OutstandingProposals/"},params={"task=default"}, method ={RequestMethod.POST,RequestMethod.GET}) 
    ...
    @RequestMapping(value ="/blockOfBusiness/OutstandingProposals/",params={"task=page"}, method =  {RequestMethod.POST,RequestMethod.GET}) 
     ...
     * @throws SystemException
     */
    @RequestMapping(value ="/blockOfBusiness/OutstandingProposals/" ,params={"task=reset"}, method =  {RequestMethod.POST,RequestMethod.GET}) 
    ...
    throws IOException,ServletException, SystemException {
    	...
    	if(result!=null){
    		return StringUtils.contains(result,'/')?result:forwards.get(result);
    	}
    	if(bindingResult.hasErrors()){
    		try {
				beforeDoCommon( (BaseReportForm) actionForm, request, response,request.getServletContext());
    ...
    private void logPageAccess( HttpServletRequest request,
        ...
        String pageAccessed = BDConstants.PAGE_ACCESSED_OUTSTANDING_PROPOSALS_TAB;
    ...
    private String beforeDoCommon( BaseReportForm form,
        ...
        // Find the forward
        String forwardName = BDConstants.OUTSTANDING_PROPOSALS_TAB_FORWARD;
        String currentTab = BDConstants.OUTSTANDING_PROPOSALS_TAB;
		...
		request.setAttribute("showPlanReviewReportsLink",
				Boolean.valueOf(showPlanReviewReportsLink(userProfile, request.getServletContext())));
     ...
     */
    @RequestMapping(value ="/blockOfBusiness/OutstandingProposals/", params={"task=refresh"}, method =  {RequestMethod.POST,RequestMethod.GET}) 
     ...
     * @return boolean
     */
    private boolean showPlanReviewReportsLink(BDUserProfile profile,ServletContext context) {
    ...
    @RequestMapping(value ="/blockOfBusiness/OutstandingProposals/" ,params={"task=viewBpsFeeDetails"}  , method =  {RequestMethod.POST,RequestMethod.GET}) 
    public String doViewBpsFeeDetails (@Valid @ModelAttribute("blockOfBusinessForm") BlockOfBusinessForm actionForm, BindingResult bindingResult,HttpServletRequest request,HttpServletResponse response,@RequestParam("outstandingProposalsTab") String outstandingProposalsTab) 
    throws IOException,ServletException, SystemException {
    	String  forward= preExecute(actionForm, request, response);
        if ( StringUtils.isNotBlank(forward)) {
     	    return StringUtils.contains(forward,'/')?forward:forwards.get(forward); 
    ...
    @RequestMapping(value ="/blockOfBusiness/OutstandingProposals/", params={"task=filter"} , method =  {RequestMethod.POST,RequestMethod.GET}) 
    ...
    @RequestMapping(value ="/blockOfBusiness/OutstandingProposals/", params={"task=sort"}, method ={RequestMethod.GET}) 
    ...
    @RequestMapping(value ="/blockOfBusiness/OutstandingProposals/", params={"task=downloadAll"}, method = {RequestMethod.GET}) 
    ...
    @RequestMapping(value ="/blockOfBusiness/OutstandingProposals/", params={"task=download"}, method ={RequestMethod.GET}) 
    ...
    @RequestMapping(value ="/blockOfBusiness/OutstandingProposals/", params={"task=printPDF"}, method ={RequestMethod.GET}) 
    public String doPrintPDF (@Valid @ModelAttribute("blockOfBusinessForm") BlockOfBusinessForm form, BindingResult bindingResult,HttpServletRequest request,HttpServletResponse response) 
    throws IOException,ServletException, SystemException {
    	String  forward= preExecute(form, request, response);
        if ( StringUtils.isNotBlank(forward)) {
     	    return StringUtils.contains(forward,'/')?forward:forwards.get(forward); 
    ...
    @RequestMapping(value ="/blockOfBusiness/OutstandingProposals/", params={"task=viewTieredFeeDetails"} , method =  {RequestMethod.POST,RequestMethod.GET}) 
    public String doViewTieredFeeDetails (@Valid @ModelAttribute("blockOfBusinessForm") BlockOfBusinessForm actionForm, BindingResult bindingResult,HttpServletRequest request,HttpServletResponse response,@RequestParam("outstandingProposalsTab") String outstandingProposalsTab) 
    throws IOException,ServletException, SystemException {
    	String  forward= preExecute(actionForm, request, response);
        if ( StringUtils.isNotBlank(forward)) {
     	    return StringUtils.contains(forward,'/')?forward:forwards.get(forward); 
