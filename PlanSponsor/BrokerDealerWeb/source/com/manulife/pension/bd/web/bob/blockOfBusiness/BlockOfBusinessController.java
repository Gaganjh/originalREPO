...
public class BlockOfBusinessController extends BDReportController {
	...
	static{
		...
		forwards.put("default","/bob/blockOfBusinessActive.jsp");
		forwards.put("sort","/bob/blockOfBusinessActive.jsp"); 
		forwards.put("printPDF","/bob/blockOfBusinessActive.jsp");
		forwards.put("refresh","/bob/blockOfBusinessActive.jsp");
		forwards.put("contractReviewFilterData","redirect:/do/bob/planReview/");
		forwards.put("filter","/bob/blockOfBusinessActive.jsp");
		forwards.put("page","/bob/blockOfBusinessActive.jsp");
		forwards.put("download","/bob/blockOfBusinessActive.jsp");
		forwards.put("downloadAll","/bob/blockOfBusinessActive.jsp");
		forwards.put("viewBpsFeeDetails","/WEBINF/bob/viewRiaBpsFee.jsp");
		forwards.put("viewTieredFeeDetails","/WEB-INF/bob/viewRiaTieredFee.jsp");
		forwards.put("viewBlendFeeDetails","/WEB-INF/bob/viewRiaBlendFee.jsp");
    ...
    private Logger logger = Logger.getLogger(BlockOfBusinessController.class);
     ...
     * Constructor class.
     */
    public BlockOfBusinessController() {
        super(BlockOfBusinessController.class);
    }
     ...
     */  
    @RequestMapping(value = {"/blockOfBusiness/Active/"}, params={"task=page"}, method =  {RequestMethod.POST,RequestMethod.GET}) 
    ...
    @RequestMapping(value = {"/blockOfBusiness/Active/"},  method =  {RequestMethod.GET}) 
    ...
    @RequestMapping(value ="/blockOfBusiness/Active/",params={"task=default"}, method ={RequestMethod.POST,RequestMethod.GET}) 
	...
	return forwards.get(errDirect)!=null?forwards.get(errDirect):forwards.get("input");//if input forward not //available, provided default
       ...
       String  forward = doDefault( actionForm, request, response);
        return StringUtils.contains(forward, '/') ? forward : forwards.get(forward);
    }  
     ...
     * @throws SystemException
     */
    @RequestMapping(value ={"/blockOfBusiness/Active/"},params={"task=reset"},method ={RequestMethod.POST,RequestMethod.GET}) 
    ...
    throws IOException,ServletException, SystemException {
    	String result  = preExecute(actionForm, request, response);
    	if(result!=null){
    		return result;
    	}
    	if(bindingResult.hasErrors()){
    ...
    private void logPageAccess( HttpServletRequest request,
        ...
        String pageAccessed = BDConstants.PAGE_ACCESSED_ACTIVE_TAB;
    ...
    private String beforeDoCommon( BaseReportForm form,
        ...
        // Find the forward
        String forwardName = BDConstants.ACTIVE_TAB_FORWARD;
        String currentTab = BDConstants.ACTIVE_TAB;
        ...
        // Show the Footnotes describing the Assets column in DI tab.//Handled in a sepreate class
            reportForm.setShowDIFootnote(Boolean.FALSE);
        //CL 131060 change
		...
		request.setAttribute("showPlanReviewReportsLink",
				Boolean.valueOf(showPlanReviewReportsLink(userProfile, servlet)));
            ...
            for (String currentTab : currentTabs) {
            	...
            	if(reportData == null && !isApplicableColumnsAvailable(allApplicableColumnsMap)){
            		bobColumns = BOBColumnCriteria.getApplicableColumns(currentTab, userRole,
                            userProfile.isInMimic());
                    for (String columnID : BlockOfBusinessUtility.columnsList) {
                        if (bobColumns.isColumnEnabledForPdfAndCsv(columnID) && !isRiaOrFiduciaryColumn(columnID)) {
                            allApplicableColumnsMap.put(columnID, Boolean.TRUE);
                        }
                    }
            	}
     ...
     * @return
     */
    private boolean isRiaOrFiduciaryColumn(String columnID) {
    	if(BlockOfBusinessReportData.RIA_ASSET_BASED_BPS_FEE_AMT.equals(columnID) ||
    			...
    			BlockOfBusinessReportData.RIA_ASSET_BASED_BPS_MIN_FEE_AMT.equals(columnID) ||
    			...
    			BlockOfBusinessReportData.COFID_321_ASSET_BASED_BPS_FEE.equals(columnID) ||
    			BlockOfBusinessReportData.COFID_321_DOLLAR_BASED_FEE_AMT.equals(columnID)||
    			BlockOfBusinessReportData.COFID_338_ASSET_BASED_BPS_FEE.equals(columnID) ||
    			BlockOfBusinessReportData.COFID_338_DOLLAR_BASED_FEE_AMT.equals(columnID)){
    		return true;
    	}
		return false;
	}
...
@InitBinder
     ...
     */
    @RequestMapping(value ="/blockOfBusiness/Active/", params={"task=refresh"}, method =  {RequestMethod.POST,RequestMethod.GET}) 
    ...
    /**
     * Invokes the filter task
     *
     * @see #doCommon(ActionMapping, BaseReportForm, HttpServletRequest,
     *      HttpServletResponse, boolean)
     */
    @RequestMapping(value ="/blockOfBusiness/Active/", params={"task=filter"}, method ={RequestMethod.POST,RequestMethod.GET}) 
    ...
    @RequestMapping(value ="/blockOfBusiness/Active/", params={"task=sort"}, method ={RequestMethod.GET}) 
     ...
     *      HttpServletResponse, boolean)
     */
    @RequestMapping(value ="/blockOfBusiness/Active/", params={"task=printPDF"},method = {RequestMethod.GET}) 
     ...
     *      HttpServletResponse, boolean)
     */
    @RequestMapping(value ="/blockOfBusiness/Active/", params={"task=download"}, method =  {RequestMethod.GET}) 
     ...
     *      HttpServletResponse, boolean)
     */
    @RequestMapping(value ="/blockOfBusiness/Active/", params={"task=downloadAll"}  , method =  {RequestMethod.GET}) 
     ...
     */
	@RequestMapping(value ="/planReview/blockOfBusiness/", params={"task=planReviewReports"}, method =  {RequestMethod.POST,RequestMethod.GET}) 
	public String doPlanReviewReports (@Valid @ModelAttribute("blockOfBusinessForm") BlockOfBusinessForm actionForm, BindingResult bindingResult,HttpServletRequest request,HttpServletResponse response) 
	throws IOException,ServletException, SystemException {
		String  forward= preExecute(actionForm, request, response);
        if ( StringUtils.isNotBlank(forward)) {
     	    return StringUtils.contains(forward,'/')?forward:forwards.get(forward); 
	...
	return forwards.get(errDirect)!=null?forwards.get(errDirect):forwards.get("input");//if input forward not //available, provided default
        ...
        if (logger.isDebugEnabled()) {
            logger.debug("entry -> doPlanReviewReports() in BlockOfBusinessAction.");
        }
        
      

        if (actionForm.getIsPageAccessed() == null || !actionForm.getIsPageAccessed()) {
            // Log Page Access into MRL.
            logPageAccess( request, BDSessionHelper.getUserProfile(request));
            // Indicator that the page has already been accessed.
            actionForm.setIsPageAccessed(Boolean.TRUE);
        }
		...
		request.getSession(false).setAttribute(
				...
				buildContractReviewReportList((BlockOfBusinessReportData) request
						.getAttribute(BDConstants.REPORT_BEAN)));
		
		if (logger.isDebugEnabled()) {
			logger.debug("exit -> doPlanReviewReports() in BlockOfBusinessAction.");
		}
		
		
		
		  forward = findForward(getTask(request));
        return StringUtils.contains(forward, '/') ? forward : forwards.get(forward);
     ...
     * @return boolean
     */
    private boolean showPlanReviewReportsLink(BDUserProfile profile,ServletContext servlet) {
    ...
    @RequestMapping(value ="/blockOfBusiness/Active/" ,params={"task=viewBpsFeeDetails"}  , method =  {RequestMethod.POST,RequestMethod.GET}) 
    public String doViewBpsFeeDetails (@Valid @ModelAttribute("blockOfBusinessForm") BlockOfBusinessForm actionForm, BindingResult bindingResult,HttpServletRequest request,HttpServletResponse response) 
    throws IOException,ServletException, SystemException {
    	String  forward= preExecute(actionForm, request, response);
        if ( StringUtils.isNotBlank(forward)) {
     	    return StringUtils.contains(forward,'/')?forward:forwards.get(forward); 
    ...
    @RequestMapping(value ="/blockOfBusiness/Active/", params={"task=viewTieredFeeDetails"} , method =  {RequestMethod.POST,RequestMethod.GET}) 
    public String doViewTieredFeeDetails (@Valid @ModelAttribute("blockOfBusinessForm") BlockOfBusinessForm actionForm, BindingResult bindingResult,HttpServletRequest request,HttpServletResponse response) 
    throws IOException,ServletException, SystemException {
    	String  forward= preExecute(actionForm, request, response);
        if ( StringUtils.isNotBlank(forward)) {
     	    return StringUtils.contains(forward,'/')?forward:forwards.get(forward); 
