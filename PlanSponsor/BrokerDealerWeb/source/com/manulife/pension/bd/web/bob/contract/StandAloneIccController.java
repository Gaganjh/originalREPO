...
public class StandAloneIccController extends ICCReportController {
    ...
    public StandAloneIccController() { super(StandAloneIccController.class); }
    
    @Override
    boolean isDocumentAllowed(Access404a5 access) {
        
        Qualification iccQual = access.getAccess(Facility.INVESTMENT_COMPARATIVE_CHART);
        return
                iccQual != null
    ...
    @Override
    String getPdfSessionCacheAttributeName() { return "generatedICCArray"; }
    
    @Override
    String getPdfFileName(int contractId) { return "ICC_" + contractId + ".pdf"; }
    ...
    byte[] getPdfFileStream(
        ...
        return
                FundServiceDelegate.getInstance().getIccFileStream(
                        contractId,
                        topLogoPath,
                        bottomLogoPath,
                        context, user);
    }
    @RequestMapping(value ="/investment/iccReport/",  method =  {RequestMethod.GET}) 
    ...
    @RequestMapping(value ="/investment/iccReport/",params={"action=checkPdfReportGenerated"}   , method =  {RequestMethod.GET}) 
    ...
    @RequestMapping(value ="/investment/iccReport/" ,params={"action=openErrorPdf"}, method =  {RequestMethod.GET}) 
