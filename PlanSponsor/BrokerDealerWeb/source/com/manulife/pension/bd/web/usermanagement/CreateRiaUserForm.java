...
public class CreateRiaUserForm extends BaseForm {
	...
	public long getNoRolePartyId() {
		return noRolePartyId;
	}

	public void setNoRolePartyId(long noRolePartyId) {
		this.noRolePartyId = noRolePartyId;
	}
