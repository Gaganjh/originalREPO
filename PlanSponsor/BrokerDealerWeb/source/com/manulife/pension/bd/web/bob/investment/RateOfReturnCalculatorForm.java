...
public class RateOfReturnCalculatorForm extends AutoForm {
	...
	public void reset(  HttpServletRequest arg1) {
		...
		this.setStartDate(fieldEmpty);
		this.setEndDate(fieldEmpty);
	}
	...
	public void setParticipantFirstName(String participantFirtsName) {
		this.participantFirstName = participantFirtsName;
	}
