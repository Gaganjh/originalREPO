...
/**
 * This is the action form class for the NBDW version of the Benefit Base Page.
 * 
 * @author Ilamparithi
 *
 */
public class ParticipantBenefitBaseInformationForm extends BaseReportForm {
 ...
 // Lifetime Income Amount Details
     ...
     * 
     * @param serviceInquiryLog
     *            The serviceInquiryLog to set
     */
     ...
     * 
     * @param showFootnote
     *            a flag to decide whether to show the footnote
     */
    ...
    /**
     * @param bbBatchDateLessThenETL
     *            the bbBatchDateLessThenETL to set
     */
    ...
    /**
     * returns "Y" or "N" value to decide whether Trading Expiration Date should
     * be displayed or not
     * 
     * @return
     */
    ...
    /**
     * This method is set 'Y' or 'N' value based on trading restriction
     ...
     */
    public void setDisplayTradingExpirationDate(
            String displayTradingExpirationDate) {
     ...
     */
    public void setRateForLastIncomeEnhancement(
            String rateForLastIncomeEnhancement) {
