...
public class FieldHighlightTag extends TagSupport {
    ...
    private static Logger logger = Logger.getLogger(FieldHighlightTag.class);

    private static final String ERROR_IMAGE_SOURCE = "/assets/unmanaged/images/icons/icon_message_error.gif";

    private static final String WARNING_IMAGE_SOURCE = "/assets/unmanaged/images/icons/icon_message_warning.gif";
    ...
    private static final String ALERT_IMAGE_SOURCE = "/assets/unmanaged/images/icons/icon_message_warning.gif";
  ...
  //  private static final String BdBaseAction.ERROR_KEY = Environment.getInstance().getErrorKey();
    ...
    public int doStartTag() throws JspException {
        ...
        Collection errors = (Collection) pageContext.findAttribute(errorKey);
        Collection warnings = (Collection) pageContext.findAttribute(BDConstants.WARNING_MESSAGES);
