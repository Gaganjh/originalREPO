...
public class PlanReviewHistorySummaryContractReportController extends
	...
	static{
		forwards.put("input","/contract/planReview/contractHistorySummaryPlanReviewReport.jsp");
		forwards.put("default","/contract/planReview/contractHistorySummaryPlanReviewReport.jsp");
		forwards.put("sort","/contract/planReview/contractHistorySummaryPlanReviewReport.jsp");
		forwards.put("page","/contract/planReview/contractHistorySummaryPlanReviewReport.jsp");
		forwards.put("filter","/contract/planReview/contractHistorySummaryPlanReviewReport.jsp");
		forwards.put("reset","/contract/planReview/contractHistorySummaryPlanReviewReport.jsp");
		forwards.put("navigatedFromDetails","/contract/planReview/contractHistorySummaryPlanReviewReport.jsp");
		forwards.put("contractReviewReportStep1Page","redirect:/do/bob/contract/planReview/");
		forwards.put("ViewPlanReviewReportFromHistory","redirect:/do/bob/contract/planReview/Results/");
		forwards.put("historyReportDetails","redirect:/do/bob/contract/planReview/HistoryDetails/");
		forwards.put("planReviewRequest","redirect:/do/bob/contract/planReview/");
		forwards.put("reSubmitPlanReviewRequest","/contract/planReview/contractHistorySummaryPlanReviewReport.jsp");
		forwards.put("bobPage","redirect:/do/bob/blockOfBusiness/Active/");
		forwards.put("viewDisable","/contract/planReview/contractHistorySummaryPlanReviewReport.jsp");
		forwards.put("homePage","redirect:/do/home/");
		
		}

	protected static final Logger logger = Logger.getLogger(PlanReviewHistorySummaryContractReportController.class);
	...
	public PlanReviewHistorySummaryContractReportController() {
		super(PlanReviewHistorySummaryContractReportController.class);
	}
	...
	@RequestMapping(value ="/contract/planReview/History/" ,method =  {RequestMethod.GET}) 
	...
	@RequestMapping(value = "/contract/planReview/History/", params = {"task=filter"}, method = {RequestMethod.POST})
	...
	@RequestMapping(value = "/contract/planReview/History/", params = {"task=page"}, method = {RequestMethod.POST})
	...
	@RequestMapping(value = "/contract/planReview/History/", params = {"task=sort"}, method = {RequestMethod.POST})
	...
	@RequestMapping(value ="/contract/planReview/History/", params={"task=navigatedFromDetails"} , method =  {RequestMethod.POST}) 
	...
	throws IOException,ServletException, SystemException {
		 ...
		 actionForm = (PlanReviewReportHistoryForm) resetForm(actionForm, request);
		 forward = doCommon( actionForm, request, response);
		
		return StringUtils.contains(forward,'/')?forward:forwards.get(forward); 
		
	}
	@RequestMapping(value ="/contract/planReview/History/", params={"task=navigatedFromResults"} , method =  {RequestMethod.POST}) 
	 ...
	 * 
	 */
	@RequestMapping(value ="/contract/planReview/History/", params={"task=viewPlanReviewReportFromHistory"} , method =  {RequestMethod.POST}) 
	...
	@RequestMapping(value ="/contract/planReview/History/", params={"task=planReviewRequest"} , method =  {RequestMethod.POST}) 
	...
	private   PlanReviewHistorySummaryReportValidator planReviewHistorySummaryReportValidator;
	...
	@RequestMapping(value ="/contract/planReview/History/", params={"task=download"} , method =  {RequestMethod.POST}) 
	 ...
	 *             +
	 */
	@RequestMapping(value ="/contract/planReview/History/", params={"task=historyReportDetails"} , method =  {RequestMethod.POST}) 
	...
	private String buildCsvString(BDUserProfile userProfile,
		...
		logger.info("Contract:"+buff.toString());
		return buff.toString();
    ...
    protected Collection doValidate(ActionForm form,
		...
		validateSearchParameters(errorMessages, reportForm, request, "contract");
		return errorMessages;
	...
	@RequestMapping(value ="/contract/planReview/History/", params={"task=reset"} , method =  {RequestMethod.POST}) 
	 ...
	 * @throws SystemException
	 */
	@RequestMapping(value ="/contract/planReview/History/", params={"task=reSubmitPlanReviewRequest"} , method =  {RequestMethod.POST}) 
