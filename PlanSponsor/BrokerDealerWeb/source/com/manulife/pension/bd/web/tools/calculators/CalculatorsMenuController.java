package com.manulife.pension.bd.web.tools.calculators;
...
import com.manulife.pension.bd.web.validation.pentest.BDValidatorFWCalculatorMenu;
...
public class CalculatorsMenuController extends BDController {

	public static HashMap<String,String>forwards=new HashMap<String,String>();
	static{
		forwards.put("calculatorsMenu","/tools/calculators/calculatorsMenu.jsp");
		}

    private static final String CALCULATORS_MENU = "calculatorsMenu";

    public CalculatorsMenuController() {
        super(CalculatorsMenuController.class);
    }

    /* (non-Javadoc)
     * @see com.manulife.pension.platform.web.controller.BaseAction#doExecute(org.apache.struts.action.ActionMapping, org.apache.struts.action.Form, javax.servlet.http.HttpServletRequest, javax.servlet.http.HttpServletResponse)
     */
	...
	throws IOException,ServletException, SystemException {	
		 if(bindingResult.hasErrors()){
			 ...
			 if(errDirect!=null){
				 ...
				 forwards.get("calculatorsMenu");//if input forward not //available, provided default
			 }
		 }
        BDUserProfile userProfile = getUserProfile(request);
        return forwards.get(CALCULATORS_MENU);
    }
    ...
    @Autowired
	   private BDValidatorFWCalculatorMenu  bdValidatorFWCalculatorMenu;
@InitBinder
	  public void initBinder(HttpServletRequest request,ServletRequestDataBinder  binder) {
	    binder.bind( request);
	    binder.addValidators(bdValidatorFWCalculatorMenu);
	}
}