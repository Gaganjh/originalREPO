...
public class RateOfReturnCalculatorController extends BaseAutoController {
	...
	static{
		forwards.put("input","/contract/rorCalculator.jsp");
		forwards.put("default","/contract/rorCalculator.jsp");
		forwards.put("calculate","/contract/rorCalculator.jsp");
		forwards.put("reset","/contract/rorCalculator.jsp");
    ...
    @RequestMapping(value ="/contract/RORCalculator/",  method =  {RequestMethod.GET}) 
    ...
    throws  SystemException, RemoteException {
        ...
        String profileId = bob.getPptProfileId();
        ...
        actionForm.setParticipantFirstName(pptName[0].trim());
        actionForm.setParticipantLastName(pptName[1].trim());
        // TODO Auto-generated method stub
        return forwards.get(DEFAULT);
    }

    @RequestMapping(value ="/contract/RORCalculator/" ,params={"action=reset"} , method =  {RequestMethod.POST}) 
    ...
    throws  SystemException {
        ...
        form.reset( request);
        form.setRateOfReturn("");
        form.setResultsCalculatedFlag(false);
        return forwards.get(RESET);
    }
    @RequestMapping(value ="/contract/RORCalculator/" ,params={"action=calculate"} , method =  {RequestMethod.POST}) 
     ...
     */
  @Autowired
  private RateOfReturnCalculatorValidator rateOfReturnCalculatorValidator;
	 ...
	 * @throws SystemException
	 */
    @RequestMapping(value ="/contract/RORCalculator/", params={"action=printPDFReport"}  , method =  {RequestMethod.GET,RequestMethod.POST}) 
    public String doPrintPDFReport (@ModelAttribute("rateOfReturnCalculatorForm") RateOfReturnCalculatorForm form, BindingResult bindingResult,HttpServletRequest request,HttpServletResponse response) 
    throws  SystemException {
        ...
        ByteArrayOutputStream pdfOutStream = prepareXMLandGeneratePDF(form, report, request);
	...
	public Document prepareXMLFromReport(AutoForm form, ReportData investmentCostReportData, HttpServletRequest request)
        ...
        LayoutPage layoutPageBean = getLayoutPage(BDPdfConstants.RATE_OF_RETURN_CALCULATOR_PATH, request);
