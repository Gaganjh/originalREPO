...
import com.manulife.pension.bd.web.taglib.AbstractChangeHistoryTag;
...
public class IPSAndDetailsChangeHistoryTag extends AbstractChangeHistoryTag {
	...
	/**
	 * Populate the change history VO by taking the values from
	...
	protected ChangeHistoryVO getChangeHistoryVO() throws SystemException {
		...
		if (value instanceof InvestmentPolicyStatementVO) {
			...
			changeHistoryVO.setPreviousUpdatedTs(investmentPolicyStatementVO
					.getStartTS());
			changeHistoryVO
					.setCurrentUser(new ChangeHistoryVO().new ChangeUserInfo(
							investmentPolicyStatementVO.getCreatedUserId(),
							investmentPolicyStatementVO.getCreatedUserIdType(),
							investmentPolicyStatementVO
									.getCreatedUserLastName(),
							investmentPolicyStatementVO
									.getCreatedUserFirstName()));
			changeHistoryVO
					.setPreviousUser(new ChangeHistoryVO().new ChangeUserInfo(
							investmentPolicyStatementVO.getCreatedUserId(),
							investmentPolicyStatementVO.getCreatedUserIdType(),
							investmentPolicyStatementVO
									.getCreatedUserLastName(),
							investmentPolicyStatementVO
									.getCreatedUserFirstName()));
			changeHistoryVO
					.setPreviousSourceChannelCode(investmentPolicyStatementVO
