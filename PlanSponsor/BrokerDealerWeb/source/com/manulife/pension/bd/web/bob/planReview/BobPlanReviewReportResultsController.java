...
public class BobPlanReviewReportResultsController extends BasePlanReviewReportController {
	...
	static{
		forwards.put("input","/planReview/resultsBobPlanReviewReports.jsp");
		forwards.put("default","/planReview/resultsBobPlanReviewReports.jsp");
		...
		forwards.put("sort","/planReview/resultsBobPlanReviewReports.jsp" );
		forwards.put("backToMainHistory","/do/bob/planReview/History/?task=navigatedFromDetails");
		
				}
	
	
	
	protected static final Logger logger = Logger.getLogger(BobPlanReviewReportResultsController.class);
	 ...
	 */
	public BobPlanReviewReportResultsController() {
		super(BobPlanReviewReportResultsController.class);
	}
	 ...
	 */
	@RequestMapping(value = {"/planReview/Results/"},  method =  {RequestMethod.GET}) 
	...
	return forwards.get(errDirect)!=null?forwards.get(errDirect):forwards.get("default");//if input forward not //available, provided default
		...
		super.doDefault( actionForm, request,
				response);
	 ...
	 * @throws SystemException
	 */
	@RequestMapping(value = {"/planReview/Results/"}, params={"task=viewPdf"} , method =  {RequestMethod.POST}) 
	 ...
	 * @throws SystemException
	 */
	@RequestMapping(value = {"/planReview/Results/"}, params={"task=downloadPdf"}, method =  {RequestMethod.POST}) 
	 ...
	 * @throws SystemException
	 */
	@RequestMapping(value = {"/planReview/Results/"}, params={"task=downloadSelectedPdf"}, method =  {RequestMethod.POST}) 
	 ...
	 * @throws SystemException
	 */
	@RequestMapping(value = {"/planReview/Results/"},params={"task=print"}, method =  {RequestMethod.POST}) 
	 ...
	 * @throws SystemException
	 */
	@RequestMapping(value = {"/planReview/Results/"}, params={"task=history"} , method =  {RequestMethod.POST}) 
	 ...
	 * @throws SystemException
	 */
	@RequestMapping(value = {"/planReview/Results/"}, params={"task=planReviewRequest"} , method =  {RequestMethod.POST}) 
	...
	@RequestMapping(value = {"/planReview/Results/"}, params={"task=navigatedFromResults"} , method =  {RequestMethod.POST}) 
	...
	@RequestMapping(value = {"/planReview/Results/"}, params={"task=openPdfWindow"} , method =  {RequestMethod.POST}) 
     ...
     * @throws SystemException 
     */
	@RequestMapping(value = {"/planReview/Results/"}, params={"task=checkDownloadPdfGenerated"} , method =  {RequestMethod.GET}) 
	...
	public String preExecute (PlanReviewResultForm form,HttpServletRequest request,HttpServletResponse response) 
			throws IOException,ServletException, SystemException {
