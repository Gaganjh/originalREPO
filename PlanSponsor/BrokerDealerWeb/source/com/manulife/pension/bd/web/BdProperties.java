 ...
 * in the bd.properties file. (Copied from psw)
 *
 * @author   Chris Shin
...
public class BdProperties {
	...
	private static BdProperties theInstance;
	...
	private static final String PROPERTIES_FILE_NAME= "/bd.properties";
	
	/** runtime properties */
	private Properties runtimeProperties;
		
	/**
	 * Constructs a BdProperties object.
	 * Since we are implementing this as a Singleton, the constructor is private.
	 **/
	private BdProperties() throws SystemException {
            // read properties
            runtimeProperties = new Properties();
            InputStream in = null;
            try {
				 in = BdProperties.class.getResourceAsStream(PROPERTIES_FILE_NAME);
				runtimeProperties.load(in);
            } catch (FileNotFoundException ex) {
                throw new SystemException(ex, "com.manulife.pension.ps.web.BdProperties", "BdProperties", "Exception when trying to open properties file: ");
            } catch (IOException e) {
               	throw new SystemException(e,"com.manulife.pension.ps.web.BdProperties", "BdProperties", "Exception when trying to open properties file: " + e.toString() );
            }finally{
            	try {
            		if (in != null){ 
					in.close();
	...
	public static BdProperties getInstance() throws SystemException {

		if (theInstance == null) {
			theInstance = new BdProperties();
		}
		return theInstance;
	}
	/**
