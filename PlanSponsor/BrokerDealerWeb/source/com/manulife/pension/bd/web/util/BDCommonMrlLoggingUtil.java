...
public class BDCommonMrlLoggingUtil {
	/**
	 * FRW - logUnAuthAcess in MRL 
	 * @param request
	...
	/**
	 * Check ON/OF Switch is enable in Websphere nameing variable 
	 * @return
	 * @throws SystemException
	 */
	public static boolean isMrlLoggingFunctionalityAvailable()
		    throws SystemException
		  {
		    ...
		    String accessControlViolationLoggingEnabled = environment.getNamingVariable(BDConstants.ACCESS_CONTROL_VIOLATION_ENABLED, null);
