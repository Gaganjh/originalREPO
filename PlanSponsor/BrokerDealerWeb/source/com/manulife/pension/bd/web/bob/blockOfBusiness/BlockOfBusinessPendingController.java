...
public class BlockOfBusinessPendingController extends BDReportController {
	...
	static{
		forwards.put("input","/bob/blockOfBusinessPending.jsp");
		forwards.put("blockOfBusinessPending","/bob/blockOfBusinessPending.jsp");
    	forwards.put("inputRedirect","redirect:/do/bob/blockOfBusiness/Pending/");
    	forwards.put("bobToContractInformation","redirect:/do/bob/contract/contractInformation/");
    	forwards.put("bobToSecureDocumentUpload","redirect:/do/bob/secureDocumentUpload/submit/");
    	forwards.put("default","/bob/blockOfBusinessPending.jsp");
    	forwards.put("sort","/bob/blockOfBusinessPending.jsp");
    	forwards.put("filter","/bob/blockOfBusinessPending.jsp");
    	forwards.put("page","/bob/blockOfBusinessPending.jsp");
    	forwards.put("download" ,"/bob/blockOfBusinessPending.jsp");
    	forwards.put("downloadAll","/bob/blockOfBusinessPending.jsp");
    	forwards.put("printPDF","/bob/blockOfBusinessPending.jsp");
    	forwards.put("refresh","/bob/blockOfBusinessPending.jsp");
    ...
    private Logger logger = Logger.getLogger(BlockOfBusinessPendingController.class);
     ...
     * Constructor class.
     */
    public BlockOfBusinessPendingController() {
        super(BlockOfBusinessPendingController.class);
    }
    ...
    public String preExecute( ActionForm form,
        ...
        if (contractNum != null) {
            ...
            if (BDSessionHelper.getBobContext(request) == null
                ...
                forward = forwards.get(BDConstants.BOB_SECURE_DOCUMENT_UPLOAD_REDIRECT_FORWARD);
            }
...
//TODO need to take cared below line 222
    ...
    @RequestMapping(value ="/blockOfBusiness/Pending/",  method ={RequestMethod.POST,RequestMethod.GET}) 
    ...
    @RequestMapping(value ="/blockOfBusiness/Pending/",params={"task=default"}, method ={RequestMethod.POST,RequestMethod.GET}) 
    ...
    @RequestMapping(value ="/blockOfBusiness/Pending/" ,params={"task=filter"}, method =  {RequestMethod.POST,RequestMethod.GET}) 
    ...
    @RequestMapping(value ="/blockOfBusiness/Pending/", params={"task=sort"}, method =  {RequestMethod.POST,RequestMethod.GET}) 
    ...
    @RequestMapping(value ="/blockOfBusiness/Pending/", params={"task=page"}, method =  {RequestMethod.POST,RequestMethod.GET}) 
    ...
    @RequestMapping(value ="/blockOfBusiness/Pending/",
    	    params={"task=printPDF"}, method =  {RequestMethod.POST,RequestMethod.GET})  
    ...
    @RequestMapping(value ="/blockOfBusiness/Pending/" ,params={"task=downloadAll"}, method =  {RequestMethod.POST,RequestMethod.GET}) 
     ...
     * @throws SystemException
     */
    @RequestMapping(value ="/blockOfBusiness/Pending/" ,params={"task=reset"}, method =  {RequestMethod.POST,RequestMethod.GET}) 
    ...
    private void logPageAccess( HttpServletRequest request,
        ...
        String pageAccessed = BDConstants.PAGE_ACCESSED_PENDING_TAB;
        /*if (BDConstants.PENDING_TAB.equals(pendingTab)) {
    ...
    private String beforeDoCommon( BaseReportForm form,
        ...
        // Find the forward
        String forwardName = BDConstants.PENDING_TAB_FORWARD;
        String currentTab = BDConstants.PENDING_TAB;
        /*if (BDConstants.PENDING_TAB.equals(pendingTab)) {
...
@InitBinder
     ...
     */
    @RequestMapping(value ="/blockOfBusiness/Pending/", params={"task=refresh"}  , method =  {RequestMethod.POST,RequestMethod.GET}) 
    ...
    @RequestMapping(value ="/blockOfBusiness/Pending/" ,params={"task=viewBpsFeeDetails"}  , method =  {RequestMethod.POST,RequestMethod.GET}) 
    public String doViewBpsFeeDetails (@Valid @ModelAttribute("blockOfBusinessForm") BlockOfBusinessForm actionForm, BindingResult bindingResult,HttpServletRequest request,HttpServletResponse response,@RequestParam("pendingTab") String pendingTab) 
    throws IOException,ServletException, SystemException {
    	String  forward= preExecute(actionForm, request, response);
        if ( StringUtils.isNotBlank(forward)) {
     	    return StringUtils.contains(forward,'/')?forward:forwards.get(forward); 
    ...
    @RequestMapping(value ="/blockOfBusiness/Pending/", params={"task=viewTieredFeeDetails"} , method =  {RequestMethod.POST,RequestMethod.GET}) 
    public String doViewTieredFeeDetails (@Valid @ModelAttribute("blockOfBusinessForm") BlockOfBusinessForm actionForm, BindingResult bindingResult,HttpServletRequest request,HttpServletResponse response,@RequestParam("pendingTab") String pendingTab) 
    throws IOException,ServletException, SystemException {
    	String  forward= preExecute(actionForm, request, response);
        if ( StringUtils.isNotBlank(forward)) {
     	    return StringUtils.contains(forward,'/')?forward:forwards.get(forward); 
