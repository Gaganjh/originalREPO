...
public class EditInternalUserController extends AbstractAddEditUserController {
	...
	static {
		forwards.put("input", "/profiles/editInternalUser.jsp");
		forwards.put("confirm", "redirect:/do/profiles/editInternalUser/?action=confirm");
		forwards.put("refresh", "/do/profiles/editInternalUser/?action=refresh");
		forwards.put("confirmPage", "/profiles/editInternalUserConfirmation.jsp");
	 ...
	 * Constructor.
	 */
	public EditInternalUserController() {
		super(EditInternalUserController.class);
	 ...
	 * 
	 * @see
	 * com.manulife.pension.platform.web.controller.BaseAction#postExecute(
	 ...
	 *      javax.servlet.http.HttpServletResponse)
	 */
	@RequestMapping(value = "/editInternalUser/", method = { RequestMethod.GET })
	...
	@RequestMapping(value = "/editInternalUser/", params = { "action=cancel" }, method = { RequestMethod.POST,
			RequestMethod.GET })
	...
	@RequestMapping(value = "/editInternalUser/", params = { "action=save" }, method = { RequestMethod.POST,
			RequestMethod.GET })
	...
	@RequestMapping(value = "/editInternalUser/", params = { "action=confirm" }, method = { RequestMethod.POST,
			RequestMethod.GET })
	...
	@RequestMapping(value = "/editInternalUser/", params = { "action=refresh" }, method = { RequestMethod.POST,
			RequestMethod.GET })
	...
	@RequestMapping(value = "/editInternalUser/", params = { "action=finish" }, method = { RequestMethod.POST,
			RequestMethod.GET })
	...
	@RequestMapping(value = "/editInternalUser/", params = { "action=printPDF" }, method = { RequestMethod.POST,
			RequestMethod.GET })
