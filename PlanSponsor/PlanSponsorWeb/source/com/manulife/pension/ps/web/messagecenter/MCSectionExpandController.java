...
public class MCSectionExpandController extends MCSectionController {
	...
	public MCSectionExpandController() {
		logger = Logger.getLogger(MCSectionExpandController.class);
	}
	...
	protected void updatePreference(HttpServletRequest request,
		...
		pref.expandSection(selectedSection, "true".equals(request
				.getParameter(MCConstants.ParamExpand)));
	}
	/**This code has been changed and added  to 
   	 * Validate form and request against penetration attack, prior to other validations.
   	 */
	@RequestMapping(value ="/sectionExpand", method ={RequestMethod.GET})
...
*/			
				ControllerForward forward = new ControllerForward("detail"+CommonConstants.ERROR_RDRCT, "/do" + "/messagecenter/detail"+"?tabId="+MCUtils.getId(request, ParamTabId),true);
