...
/**
 * 
 * Handles the census submission upload process. 
 * 
 * @author Diana Macean
 * 
 */
...
@SessionAttributes({"submissionCensusForm"})

public class SubmissionCensusController extends AbstractSubmitController {
	
	@ModelAttribute("submissionCensusForm") 
	public SubmissionCensusForm populateForm() 
	{
		return new SubmissionCensusForm();
	}
	public static Map<String,String> forwards = new HashMap<>();
	static{
		forwards.put(INPUT,"/tools/submissionCensus.jsp");
		forwards.put("tools","redirect:/do/tools/toolsMenu/");
		forwards.put("confirm","redirect:/do/tools/censusUpload/?action=confirm");
		forwards.put("refresh","redirect:/do/tools/censusUpload/?action=refresh"); 
		forwards.put("confirmPage","/tools/submissionCensusConfirmation.jsp");
	 ...
	 * Constructor.
	 */
	public SubmissionCensusController() {
		super(SubmissionCensusController.class);
	}

	@RequestMapping(value ="/censusUpload/",  method = {RequestMethod.GET}) 
	public String doDefault(@Valid @ModelAttribute("submissionCensusForm") SubmissionCensusForm actionForm, BindingResult bindingResult,HttpServletRequest request,HttpServletResponse response) 
	 ...
	 */
	@RequestMapping(value ="/censusUpload/" ,params={"actionLabel=send"}, method = {RequestMethod.POST}) 
	public String doSend (@Valid @ModelAttribute("submissionCensusForm") SubmissionCensusForm form, BindingResult bindingResult,HttpServletRequest request,HttpServletResponse response) 
	throws SystemException {
	 ...
	 * @return
	 */
	@RequestMapping(value ="/censusUpload/", params={"action=confirm"} , method =  {RequestMethod.GET}) 
	public String doConfirm (@Valid @ModelAttribute("submissionCensusForm") SubmissionCensusForm form, BindingResult bindingResult,HttpServletRequest request,HttpServletResponse response) 
	throws SystemException {
	...
	@RequestMapping(value ="/censusUpload/",params={"action=refresh"}   , method = {RequestMethod.GET}) 
	public String doRefresh (@Valid @ModelAttribute("submissionCensusForm") SubmissionCensusForm form, BindingResult bindingResult,HttpServletRequest request,HttpServletResponse response) 
	throws SystemException {
	...
	protected void populateForm(AutoForm form, UserProfile userProfile)
		...
		SubmissionCensusForm theForm = (SubmissionCensusForm) form;
	...
	protected String validate(
		...
		SubmissionCensusForm form = (SubmissionCensusForm) actionForm;
	...
	throws SystemException, UploadFileCannotFoundOrEmptyException {
		...
		if (file != null && StringUtils.isNotEmpty(file.getOriginalFilename())) {
			try {
				...
				throw new SystemException(e, SubmissionCensusController.class.getName(), "processUploadRequest", "");
			}
