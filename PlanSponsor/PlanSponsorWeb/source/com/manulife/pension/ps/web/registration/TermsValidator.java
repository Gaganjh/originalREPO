...
public class TermsValidator  implements Validator{
	...
	private static Logger logger = Logger.getLogger(TermsValidator.class);
	@Override
	...
	public void validate(Object target, Errors errors) {
		...
		if (PsValidator1.getInstance().validateSanitizeCatalogedFormFields(form, errorList, request) == false) {
	    ...
	    if(
	    		form.getAction()!=null && 
	    				form.getAction().equalsIgnoreCase(ACTION_ACCEPT)
	    ){
	    	
	    	form.setTermsValid(true);
