...
public class FeeDisclosureUtility {
	...
	public static boolean isFeeDisclsoureAvaiable(Contract contract) throws SystemException, RemoteException {
		...
		boolean hasStableValueFund = checkIfStableValueFundAvailable(contract.getContractNumber(), new Date());
		...
		Date apolloDate = getAsOfDateForWebPage();
		
		boolean isR1andRPFundAvaliableForSelectedContact = checkR1andRPFundAvaliableForSelectedContact(contract.getContractNumber(), apolloDate);
	...
	/*
	 *  This method used to check  weather Stable value fund available
     * @param contractNumber
     * @throws SystemException
     */
	public static boolean checkIfStableValueFundAvailable(int contractNumber, Date asOfDate)
			throws SystemException {
		String svfFundId = getStableValueFundId(contractNumber, asOfDate);
		return (svfFundId != null && !svfFundId.trim().equals(""));
	}
	
	/**
	 * Returns Stable value fund id associated with this contract.
	 *
	 * @param contractNumber
	 * @param asOfDate
	 ...
	 * @throws SystemException
	 */
	public static String getStableValueFundId(int contractNumber, Date asOfDate)
			throws SystemException {
		ContractServiceDelegate contractServiceDelegate = ContractServiceDelegate.getInstance();
		return contractServiceDelegate.getStableValueFundId(contractNumber, asOfDate);
	}
	 ...
	 */
	public static Date getAsOfDateForWebPage() throws SystemException {
	 ...
	 * @param contractNumber
	 * @param asOfDate
	 * @return true if the contract has LT fund for given asOfDate.
	 * @throws SystemException
	 */
