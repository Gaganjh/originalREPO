...
import com.manulife.pension.platform.web.fap.tabs.FapByFundCharIIController;
...
public class PSFapByFundCharIIController extends FapByFundCharIIController {
	...
	@RequestMapping(value ="/fapByFundCharII/", params = { "action=filter" }, method = { RequestMethod.POST })
	...
	/*@RequestMapping(value ="/fapByFundCharII/", method = { RequestMethod.POST, RequestMethod.GET })
	...
	@RequestMapping(value ="/fapByFundCharII/", params = { "action=sort,task=sort" }, method = { RequestMethod.POST,
			RequestMethod.GET })
	...
	@RequestMapping(value ="/fapByFundCharII/", params = { "action=reportsAndDownload",
	...
	@RequestMapping(value ="/fapByFundCharII/", params = { "action=changeDropDownList",
	...
	@RequestMapping(value ="/fapByFundCharII/", params = { "action=storeFapFormInSession",
