...
import com.manulife.pension.platform.web.fap.tabs.FapByPricesAndYTDController;
...
public class PSFapByPricesAndYTDController extends FapByPricesAndYTDController {
	...
	@RequestMapping(value = "/fapByPricesAndYTD/", params = { "action=filter" }, method = { RequestMethod.POST })
...
//TODO dead code is need to be remove once each and every tab flow has been working successfully
	 ...
	 *//*
	@RequestMapping(value ="/fapByPricesAndYTD/" ,params={"action=sort,task=sort"} , method =  {RequestMethod.POST,RequestMethod.GET}) 
	...
	@RequestMapping(value ="/fapByPricesAndYTD/", params={"action=reportsAndDownload","task=reportsAndDownload"},method =  {RequestMethod.POST,RequestMethod.GET}) 
...
@RequestMapping(value = "/fapByPricesAndYTD/", params = { "action=changeDropDownList",
...
@RequestMapping(value = "/fapByPricesAndYTD/", params = { "action=storeFapFormInSession",
...
@RequestMapping(value ="/fapByPricesAndYTD/", method =  {RequestMethod.POST,RequestMethod.GET}) 
public String doExecute (@Valid @ModelAttribute("fapForm") FapForm form, BindingResult bindingResult,HttpServletRequest request,HttpServletResponse response) 
throws IOException,ServletException, SystemException {
	if(bindingResult.hasErrors()){
		FapForm fapForm = (FapForm) form;
		fapForm.setMessagesExist(true);
