...
public class ManageUsersReportController extends ReportController {
	...
	static {
		forwards.put("input", "/profiles/manageInternalUsers.jsp");
		forwards.put("default", "/profiles/manageInternalUsers.jsp");
		forwards.put("sort", "/profiles/manageInternalUsers.jsp");
		forwards.put("filter", "/profiles/manageInternalUsers.jsp");
		forwards.put("page", "/profiles/manageInternalUsers.jsp");
		forwards.put("showAll", "/profiles/manageInternalUsers.jsp");
	}
	 ...
	 * Constructor.
	 */
	public ManageUsersReportController() {
		super();
	}
	 ...
	 * @param className
	 */
	public ManageUsersReportController(Class className) {
		super(className);
	}
	...
	SessionHelper.setLastVisitedManageUsersPage(request, "internal");
	...
	protected void populateReportForm(BaseReportForm reportForm, HttpServletRequest request) {
		...
		/*if (isManageTpaUsers(mapping) || TpaumHelper.isTPAUM(getUserProfile(request))) {
		...
		} else if (isManageInternalUsers(mapping)) {*/
			if (filter == null || (!filter.equals(ManageUsersReportData.FILTER_EMPLOYEE_NUMBER)
					&& !filter.equals(ManageUsersReportData.FILTER_EMPLOYEE_LAST_NAME)
					&& !filter.equals(ManageUsersReportData.FILTER_INTERNAL_USER_ID)
					&& !filter.equals(ManageUsersReportData.FILTER_PSW_ROLE)
					&& !filter.equals(ManageUsersReportData.FILTER_BDW_ROLE))) {
				theForm.setFilter(ManageUsersReportData.FILTER_EMPLOYEE_NUMBER);
				theForm.setFilterValue("");
			}
	/*	} else {
			UserProfile userProfile = getUserProfile(request);
			...
			if (contract != null) {
				...
				if (role.isExternalUser() && !contract.isBusinessConverted()) {
					theForm.setFilter(ManageUsersReportData.FILTER_CONTRACT_NUMBER_EXCLUDE_EXTERNAL_USER_MANAGERS);
				}
			} else {
				theForm.setFilterValue("");
			}
...
*/
	...
	@RequestMapping(value = "/manageInternalUsers/", method = { RequestMethod.GET })
	 ...
	 */
	@RequestMapping(value = "/manageInternalUsers/", params = { "task=showAll"}, method = {
			 RequestMethod.GET })
	 ...
	 */
	@RequestMapping(value = "/manageInternalUsers/", params = { "task=filter"}, method = {
			 RequestMethod.GET })
	...
	@RequestMapping(value = "/manageInternalUsers/", params = { "task=page"}, method = {
			 RequestMethod.GET })
	...
	@RequestMapping(value = "/manageInternalUsers/", params = { "task=sort"}, method = {
			RequestMethod.GET })
	...
	@RequestMapping(value = "/manageInternalUsers/", params = { "action=download"}, method = {
			 RequestMethod.GET })
	...
	@RequestMapping(value = "/manageInternalUsers/", params = { "action=downloadAll"}, method = {
			 RequestMethod.GET })
