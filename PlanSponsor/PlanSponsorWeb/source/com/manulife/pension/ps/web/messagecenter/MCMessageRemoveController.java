...
/**
 * Action to remove the message from the recipient view
 * 
 * @author guweigu
 * 
 */
...
public class MCMessageRemoveController extends MCMessageController {
	...
	public MCMessageRemoveController() {
		logger = Logger.getLogger(MCMessageRemoveController.class);
	}
	...
	protected void doAction(HttpServletRequest request,
		...
		getMessageServiceFacade().removeMessage(
