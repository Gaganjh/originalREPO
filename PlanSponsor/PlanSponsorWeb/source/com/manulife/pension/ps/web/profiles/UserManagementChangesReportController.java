...
public class UserManagementChangesReportController extends SecurityReportController {
	...
	static {
		forwards.put("input", "redirect:/do/profiles/userManagementChangesInternal/");
		forwards.put("default", "/profiles/userManagementChangesInternal.jsp");
		forwards.put("save", "/profiles/userManagementChangesInternal.jsp");
		forwards.put("sort", "/profiles/userManagementChangesInternal.jsp");
		forwards.put("page", "/profiles/userManagementChangesInternal.jsp");
		forwards.put("print", "/profiles/userManagementChangesInternal.jsp");
		forwards.put("filter", "/profiles/userManagementChangesInternal.jsp");
	}

	public static final String REPORT_NAME_INTERNAL = "userManagementChangesInternal";
	...
	protected static final String INTERNAL_DOWNLOAD_COLUMN_HEADING = "Changed by team code, Changed by, Contract number, Contract name, Team code, JH rep, User role, User name, Date of Change, Action, Item, Old value, New value, Attribute";
	 ...
	 */
	@RequestMapping(value = "/userManagementChangesInternal/", params = { "task=download" }, method = { RequestMethod.GET })
	...
	@RequestMapping(value = "/userManagementChangesInternal/", method = { RequestMethod.POST, RequestMethod.GET })
	...
	@RequestMapping(value = "/userManagementChangesInternal/", params = { "task=filter" }, method = {RequestMethod.POST })
	...
	@RequestMapping(value = "/userManagementChangesInternal/", params = {  "task=print" }, method = {RequestMethod.GET })
	public String doPrint(@Valid @ModelAttribute("userManagementChangesReportForm") UserManagementChangesReportForm form, BindingResult bindingResult,
	...
	@RequestMapping(value = "/userManagementChangesInternal/", params = {  "task=page" }, method = {
			 RequestMethod.GET })
	...
	@RequestMapping(value = "/userManagementChangesInternal/", params = { "task=sort" }, method = {
			 RequestMethod.GET })
	...
	@RequestMapping(value ="/userManagementChangesInternal/", params = { 
	...
	private byte[] getInternalDownloadData(BaseReportForm reportForm, ReportData report,
		...
		while (iterator.hasNext()) {
			...
			if (theItem.getUserRole() != null) {
				...
				buffer.append(escapeField("N/A")).append(COMMA);
			}

			if (StringUtils.isNotEmpty(theItem.getLastName())) {
				buffer.append(theItem.getFirstName() + " " + theItem.getLastName()).append(COMMA);
			} else {
				buffer.append(theItem.getFirstName()).append(COMMA);
			}
