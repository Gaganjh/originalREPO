...
public class MCMessageDetailCarViewController extends PsAutoController{
	...
	public MCMessageDetailCarViewController() {
		logger = Logger.getLogger(MCMessageDetailCarViewController.class);
	}


	@RequestMapping(value ="/messageDetail", method =  {RequestMethod.POST,RequestMethod.GET}) 
	public String doDefault(@Valid @ModelAttribute("messageDetailForm") MCDetailForm form,/* @RequestParam("carView") String carView,*/BindingResult bindingResult,HttpServletRequest request,HttpServletResponse response) 
	...
	return forwards.get(errDirect)!=null?forwards.get(errDirect):forwards.get("default");//if input forward not //available, provided default
		...
		//form.setCarView( StringUtils.equals(carView, "carView"));
