...
public class PsAccessDeniedHandler implements org.springframework.security.web.access.AccessDeniedHandler {
	...
	public void handle(HttpServletRequest request,
      ...
      if (session==null || (exception instanceof MissingCsrfTokenException && request.getRequestedSessionId() != null
		...
		dispatcher = request.getRequestDispatcher("/WEB-INF/global/layout/publichomelayout.jsp");
