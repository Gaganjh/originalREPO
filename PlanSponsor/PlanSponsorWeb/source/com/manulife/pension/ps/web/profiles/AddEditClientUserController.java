...
public class AddEditClientUserController extends AbstractAddEditClientUserController {
	...
	static {
		forwards.put("input", "/profiles/addExternalUser.jsp");
		forwards.put("confirm", "redirect:/do/profiles/addUser/?action=confirm");
		forwards.put("refresh", "redirect:/do/profiles/addUser/?action=refresh");
		forwards.put("confirmPage", "/profiles/addExternalUserConfirmation.jsp");
		forwards.put("planSponsorContacts", "redirect:/do/contacts/planSponsor/");
		forwards.put("changePermissions", "redirect:/do/profiles/userPermissions/?action=add");
	}
	 ...
	 * Constructor.
	 */
	public AddEditClientUserController() {
		super(AddEditClientUserController.class);
	...
	@RequestMapping(value = "/addUser/", params = { "action=cancel" }, method = RequestMethod.POST)
	public String doCancel(@ModelAttribute("clientAddEditUserForm") AddEditClientUserForm form,
	...
	@RequestMapping(value = "/addUser/", params = { "action=save" }, method = RequestMethod.POST)
	public String doSave(@Valid @ModelAttribute("clientAddEditUserForm") AddEditClientUserForm form,
		...
		Collection formErrors = doValidate(form, model, request);

		if (!formErrors.isEmpty()) {
			SessionHelper.setErrorsInSession(request, formErrors);
			model.remove("mapping", "add");
	...
	@RequestMapping(value = "/addUser/", params = { "action=finish" }, method = RequestMethod.GET)
	...
	@RequestMapping(value = "/addUser/", params = { "action=confirm" }, method = RequestMethod.GET)
	public String doConfirm(@ModelAttribute("clientAddEditUserForm") AddEditClientUserForm form,
	...
	protected void populateForm(HttpServletRequest request, AddEditClientUserForm form, UserInfo userInfo)
		...
		if (form.getContractAccesses().size() == userInfo.getContractPermissions().length
				&& ClientUserContractAccessActionHelper.canManageAllContracts(loginUserInfo, userInfo)) {
	...
	@RequestMapping(value = "/addUser/", params = { "action=addContract" }, method = { RequestMethod.POST,
			RequestMethod.GET })
	 ...
	 * @throws SystemException
	 */
	@RequestMapping(value = "/addUser/", params = { "action=deleteContract" }, method = { RequestMethod.POST,
			RequestMethod.GET })
	...
	@RequestMapping(value = "/addUser/", params = { "action=changePermissions" }, method = RequestMethod.POST)
	...
	@RequestMapping(value = "/addUser/", params = { "action=viewPermissions" }, method = RequestMethod.POST)
	 ...
	 * @throws SystemException
	 */
	@RequestMapping(value = "/addUser/", params = { "action=changeWebAccess" }, method = RequestMethod.POST)
	public String doChangeWebAccess(@ModelAttribute("clientAddEditUserForm") AddEditClientUserForm form,
			HttpServletRequest request, HttpServletResponse response) throws SystemException {
	 ...
	 * @throws SystemException
	 */
	@RequestMapping(value = "/addUser/", params = { "action=changeRole" }, method = RequestMethod.POST)
	public String doChangeRole(@ModelAttribute("clientAddEditUserForm") AddEditClientUserForm form,
			HttpServletRequest request, HttpServletResponse response) throws SystemException {
		...
		try {
			...
			contract = ContractServiceDelegate.getInstance().getContractDetails(Integer.parseInt(contractNumber),
					EnvironmentServiceDelegate.getInstance().retrieveContractDiDuration(profile.getRole(), 0, null));
	...
	public String doDefault(@Valid @ModelAttribute("clientAddEditUserForm") AddEditClientUserForm form,
			BindingResult bindingResult, ModelMap model, HttpServletRequest request, HttpServletResponse response)
			throws SystemException {
		if (bindingResult.hasErrors()) {
			String errDirect = (String) request.getSession().getAttribute(CommonConstants.ERROR_RDRCT);
	...
	@RequestMapping(value = "/addUser/", params = { "action=refresh" }, method = { RequestMethod.POST,
			RequestMethod.GET })
	public String doRefresh(@Valid @ModelAttribute("clientAddEditUserFor") AddEditClientUserForm form,
			BindingResult bindingResult, ModelMap model, HttpServletRequest request, HttpServletResponse response)
			throws SystemException {
		if (bindingResult.hasErrors()) {
			String errDirect = (String) request.getSession().getAttribute(CommonConstants.ERROR_RDRCT);
	...
	@RequestMapping(value = "/addUser/", params = { "action=reset" }, method = { RequestMethod.POST,
			RequestMethod.GET })
	public String doReset(@ModelAttribute("clientAddEditUserForm") AddEditClientUserForm form,
			HttpServletRequest request, HttpServletResponse response)
	...
	@RequestMapping(value = "/addUser/", params = { "action=unlock" }, method = { RequestMethod.POST,
			RequestMethod.GET })
