...
public class CommonEmployeeSnapshotController extends EmployeeSnapshotController {
...
public static HashMap<String,String> forwards = new HashMap<String,String>();
    ...
    public CommonEmployeeSnapshotController() {
        super(CommonEmployeeSnapshotController.class);
    }
     ...
     */
   	public String doSave(EditEmployeeSnapshotForm actionForm, BindingResult bindingResult,HttpServletRequest request,HttpServletResponse response) 
   		   	throws IOException,ServletException, SystemException {
    
        return doSave( actionForm, request, response, false);
    }

    public String doShowPreviousValue(
    		EditEmployeeSnapshotForm actionForm, BindingResult bindingResult,HttpServletRequest request,HttpServletResponse response) 
    	   		   	throws IOException,ServletException, SystemException {
     ...
     * @throws SystemException
     */
    public String doSaveIgnoreWarning( AutoForm actionForm,
    ...
    protected String doSave( AutoForm actionForm,
        ...
        try {
            ...
            if (errors.size() > 0) {
                ...
                checkIfEligibilityOrPlanDataChanged(oldEmployee,employee,f,userProfile.getCurrentContract().getContractNumber());
 ...
 */
    ...
    */
     ...
     */
   	public String doDefault (EditEmployeeSnapshotForm actionForm, BindingResult bindingResult,HttpServletRequest request,HttpServletResponse response) 
   	throws IOException,ServletException, SystemException {
        if (logger.isDebugEnabled())
...
//			Check if EC csf is on for this contract.
     ...
     */
   	...
   	public String doContinueEdit(EditEmployeeSnapshotForm actionForm, HttpServletRequest request,HttpServletResponse response) 
   		   	throws IOException,ServletException, SystemException {
     ...
     */
   	...
   	public String doEmployeeStatusHistory(EditEmployeeSnapshotForm actionForm, BindingResult bindingResult,HttpServletRequest request,HttpServletResponse response) 
   		   	throws IOException,ServletException, SystemException {
    ...
    public String doCancel( EditEmployeeSnapshotForm actionForm, BindingResult bindingResult,HttpServletRequest request,HttpServletResponse response) 
   		   	throws IOException,ServletException, SystemException {
        EmployeeSnapshotForm form = (EmployeeSnapshotForm) actionForm;
        return forwardToSource( request, form);
    }
     ...
     * @throws SystemException
     */
   	public String doReset (EditEmployeeSnapshotForm f, BindingResult bindingResult,HttpServletRequest request,HttpServletResponse response) 
   	throws IOException,ServletException, SystemException {
        UserProfile userProfile = getUserProfile(request);
