...
import com.manulife.pension.platform.web.fap.tabs.FapByMorningstarController;
...
public class PSFapByMorningstarController extends FapByMorningstarController {
	...
	@RequestMapping(value ="/fapByMorningstar/", params = { "action=filter" }, method = { RequestMethod.POST })
...
/*	@RequestMapping(value = "/fapByMorningstar/", method = { RequestMethod.POST, RequestMethod.GET })
	...
	@RequestMapping(value = "/fapByMorningstar/", params = { "action=sort,task=sort" }, method = { RequestMethod.POST,
			RequestMethod.GET })
	...
	@RequestMapping(value = "/fapByMorningstar/", params = { "action=reportsAndDownload",
	...
	@RequestMapping(value = "/fapByMorningstar/", params = { "action=changeDropDownList",
	...
	@RequestMapping(value = "/fapByMorningstar/", params = { "action=storeFapFormInSession",
