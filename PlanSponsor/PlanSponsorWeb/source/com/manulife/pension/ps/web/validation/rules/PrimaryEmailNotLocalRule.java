 ...
 * @author nallaba
 */
public class PrimaryEmailNotLocalRule extends EmailLocalRule {
	 ...
	 * @param aContractId
	 */
	public PrimaryEmailNotLocalRule ( int aContractId ) {
		super( ErrorCodes.PRIMARY_EMAIL_MUST_BE_EXTERNAL );
