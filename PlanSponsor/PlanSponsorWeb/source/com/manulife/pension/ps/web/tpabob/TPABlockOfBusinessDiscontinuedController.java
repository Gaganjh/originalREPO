...
public class TPABlockOfBusinessDiscontinuedController extends ReportController{
	...
	/*        if (userProfile.getRole().isInternalUser()) {
		 ...
		 * @throws IOException 
		 */
	    @RequestMapping(value ="/tpaBlockOfBusinessDiscontinued/", params= {"task=csvDownloadPage"},method = { RequestMethod.POST, RequestMethod.GET })
		public String doCsvDownloadPage(@ModelAttribute("tpaBlockOfBusinessForm") TPABlockOfBusinessForm form, HttpServletRequest request, HttpServletResponse response)
			...
			String currentTab = Constants.TPA_DISCONTINUED_TAB_ID;
			/*
	    ...
	    @RequestMapping(value ="/tpaBlockOfBusinessDiscontinued/", method =  {RequestMethod.POST,RequestMethod.GET}) 
	    ...
	    @RequestMapping(value ="/tpaBlockOfBusinessDiscontinued/" ,params={"task=filter"}  , method =  {RequestMethod.POST,RequestMethod.GET}) 
	   ...
	   @RequestMapping(value ="/tpaBlockOfBusinessDiscontinued/", params={"task=page"}, method =  {RequestMethod.POST,RequestMethod.GET}) 
	   ...
	   @RequestMapping(value ="/tpaBlockOfBusinessDiscontinued/", params={"task=sort"}  , method =  {RequestMethod.POST,RequestMethod.GET}) 
	   ...
	   @RequestMapping(value ="/tpaBlockOfBusinessDiscontinued/",
	   ...
	   @RequestMapping(value ="/tpaBlockOfBusinessDiscontinued/" ,params={"task=downloadAll"}, method =  {RequestMethod.POST,RequestMethod.GET}) 
