...
public class PSFapByPerformanceAndFeesController extends FapByPerformanceAndFeesController {
	...
	@RequestMapping(value ="/fapByPerformanceAndFees", params = {"action=filterPerformanceAndFeesMonthly" }, method = { RequestMethod.POST })
	...
	@RequestMapping(value ="/fapByPerformanceAndFees", params = {"action=filterPerformanceAndFeesQuarterly" }, method = { RequestMethod.POST })
	...
	/*	@RequestMapping(value ="/fapByPerformanceAndFees/", params = { "action=sort,task=sort" }, method = {
	...
	public String doSort(@Valid @ModelAttribute("fapForm") FapForm form, BindingResult bindingResult,
		...
		if (bindingResult.hasErrors()) {
			...
			if (errDirect != null) {
				...
				return forwards.get(errDirect) != null ? forwards.get(errDirect) : forwards.get("sessionExpired");// if
																													// input
																													// forward
																													// not
																													// //available,
	...
	@RequestMapping(value ="/fapByPerformanceAndFees/", params = { "action=reportsAndDownload",
	...
	@RequestMapping(value ="/fapByPerformanceAndFees/", params = { "action=changeDropDownList",
	...
	@RequestMapping(value ="/fapByPerformanceAndFees/", params = { "action=storeFapFormInSession",
