...
import com.manulife.pension.platform.web.fap.tabs.FapByFundCharIController;
...
public class PSFapByFundCharIController extends FapByFundCharIController {
	...
	@RequestMapping(value = "/fapByFundCharI/", params = { "action=filter" }, method = { RequestMethod.POST })
	...
	/*
		@RequestMapping(value ="/fapByFundCharI/", method = { RequestMethod.POST, RequestMethod.GET })
	...
	@RequestMapping(value = "/fapByFundCharI/", params = { "action=sort,task=sort" }, method = { RequestMethod.POST,
			RequestMethod.GET })
	...
	@RequestMapping(value = "/fapByFundCharI/", params = { "action=reportsAndDownload",
	...
	@RequestMapping(value = "/fapByFundCharI/", params = { "action=changeDropDownList",
	...
	@RequestMapping(value = "/fapByFundCharI/", params = { "action=storeFapFormInSession",
