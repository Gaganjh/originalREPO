...
public class UnSuspendTpaUserController extends AbstractTpaUserController {
	...
	static {
		forwards.put("input", "/profiles/unsuspendTpaProfile.jsp");
		forwards.put("confirm", "/profiles/unsuspendProfileConfirm.jsp");
		forwards.put("refresh", "redirect:/do/profiles/unsuspendTpaProfile/?action=refresh");
		...
		forwards.put("viewPermissions", "redirect:/do/profiles/tpaFirmUserPermissions/?action=view&source=unsuspend");
	 ...
	 * Constructor.
	 */
	public UnSuspendTpaUserController() {
		super(UnSuspendTpaUserController.class);
	}
	...
	@RequestMapping(value = "/unsuspendTpaProfile/", params = { "action=confirm" }, method = { RequestMethod.POST,
			RequestMethod.GET })
	...
	@RequestMapping(value = "/unsuspendTpaProfile/", params = { "action=finish" }, method = { RequestMethod.POST,
			RequestMethod.GET })
	public String doFinish(@Valid @ModelAttribute("addEditUserForm") AddEditUserForm form, BindingResult bindingResult,
		...
		model.addAttribute("mapping", "unsuspend");
	...
	@RequestMapping(value = "/unsuspendTpaProfile/", params = { "action=back" }, method = { RequestMethod.POST,
			RequestMethod.GET })
	...
	@RequestMapping(value = "/unsuspendTpaProfile/", params = { "action=refresh" }, method = { RequestMethod.POST,
			RequestMethod.GET })
	 ...
	 */
	@RequestMapping(value = "/unsuspendTpaProfile/", method = { RequestMethod.POST, RequestMethod.GET })
	...
	@RequestMapping(value = "/unsuspendTpaProfile/", params = { "action=resetPassword" }, method = { RequestMethod.POST,
			RequestMethod.GET })
	...
	// code lifted from managePasswordAction.
	@RequestMapping(value = "/unsuspendTpaProfile/", params = { "action=unlockPassword" }, method = {
	...
	@RequestMapping(value = "/unsuspendTpaProfile/", params = { "action=suspend" }, method = { RequestMethod.POST,
			RequestMethod.GET })
	...
	@RequestMapping(value = "/unsuspendTpaProfile/", params = { "action=unsuspend" }, method = { RequestMethod.POST,
			RequestMethod.GET })
	...
	@RequestMapping(value = "/unsuspendTpaProfile/", params = { "action=delete" }, method = { RequestMethod.POST,
			RequestMethod.GET })
	...
	@RequestMapping(value = "/unsuspendTpaProfile/", params = "action=view permissions", method = { RequestMethod.POST,
			RequestMethod.GET })
	 ...
	 */
	@RequestMapping(value = "/unsuspendTpaProfile/", params = { "action=refreshReset" }, method = { RequestMethod.POST,
			RequestMethod.GET })
	 ...
	 * @return The input forward.
	 */
	@RequestMapping(value = "/unsuspendTpaProfile/", params = { "action=refreshUnlock" }, method = { RequestMethod.POST,
			RequestMethod.GET })
	...
	@RequestMapping(value = "/unsuspendTpaProfile/", params = { "action=reload" }, method = { RequestMethod.POST,
			RequestMethod.GET })
	...
	@RequestMapping(value = "/unsuspendTpaProfile/", params = { "action=printPDF" }, method = { RequestMethod.POST,
			RequestMethod.GET })
