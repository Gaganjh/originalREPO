...
public class SuspendTpaUserController extends AbstractTpaUserController {
	...
	static {
		forwards.put("input", "/profiles/suspendTpaProfile.jsp");
		forwards.put("confirm", "/profiles/suspendProfileConfirm.jsp");
		forwards.put("refresh", "redirect:/do/profiles/suspendTpaProfile/?action=refresh");
		...
		forwards.put("viewPermissions", "redirect:/do/profiles/tpaFirmUserPermissions/?action=view&source=suspend");
	 ...
	 * Constructor.
	 */
	public SuspendTpaUserController() {
		super(SuspendTpaUserController.class);
	}
	...
	@RequestMapping(value = "/suspendTpaProfile/", params = { "action=refresh" }, method = { RequestMethod.POST,
			RequestMethod.GET })
	 ...
	 */
	@RequestMapping(value = "/suspendTpaProfile/", method = { RequestMethod.POST, RequestMethod.GET })
	public String doDefault(@Valid @ModelAttribute("addEditUserForm") AddEditUserForm form, BindingResult bindingResult,
		...
		model.addAttribute("mapping", "suspend");
		/*
	...
	@RequestMapping(value = "/suspendTpaProfile/", params = { "action=resetPassword" }, method = { RequestMethod.POST,
			RequestMethod.GET })
	...
	// code lifted from managePasswordAction.
	@RequestMapping(value = "/suspendTpaProfile/", params = { "action=unlockPassword" }, method = { RequestMethod.POST,
			RequestMethod.GET })
	...
	@RequestMapping(value = "/suspendTpaProfile/", params = { "action=suspend" }, method = { RequestMethod.POST,
			RequestMethod.GET })
	...
	@RequestMapping(value = "/suspendTpaProfile/", params = { "action=unsuspend" }, method = { RequestMethod.POST,
			RequestMethod.GET })
	...
	@RequestMapping(value = "/suspendTpaProfile/", params = { "action=delete" }, method = { RequestMethod.POST,
			RequestMethod.GET })
	...
	@RequestMapping(value = "/suspendTpaProfile/", params = { "action=confirm" }, method = { RequestMethod.POST,
			RequestMethod.GET })
	...
	@RequestMapping(value = "/suspendTpaProfile/", params = { "action=finish" }, method = { RequestMethod.POST,
			RequestMethod.GET })
	...
	@RequestMapping(value = "/suspendTpaProfile/", params = { "action=back" }, method = { RequestMethod.POST,
			RequestMethod.GET })
	...
	@RequestMapping(value = "/suspendTpaProfile/", params = "action=view permissions", method = { RequestMethod.POST,
			RequestMethod.GET })
	 ...
	 */
	@RequestMapping(value = "/suspendTpaProfile/", params = { "action=refreshReset" }, method = { RequestMethod.POST,
			RequestMethod.GET })
	 ...
	 * @return The input forward.
	 */
	@RequestMapping(value = "/suspendTpaProfile/", params = { "action=refreshUnlock" }, method = { RequestMethod.POST,
			RequestMethod.GET })
	public String doRefreshUnlock(@Valid @ModelAttribute("addEditUserForm") AddEditUserForm form,
		...
		/*
		 * if (form.getUserName() == null) { // return
		 * mapping.findForward(MANAGE_USERS_ACTION); // }
		 */
		model.addAttribute("mapping", "suspend");
	...
	@RequestMapping(value = "/suspendTpaProfile/", params = { "action=reload" }, method = { RequestMethod.POST,
			RequestMethod.GET })
	...
	@RequestMapping(value = "/suspendTpaProfile/", params = { "action=printPDF" }, method = { RequestMethod.POST,
			RequestMethod.GET })
