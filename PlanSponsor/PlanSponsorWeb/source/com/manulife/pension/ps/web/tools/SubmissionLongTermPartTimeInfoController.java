...
/**
 * 
 * Handles the Long Term Part Time Information File submission upload process. 
 * 
 * @author Venkata Bobbadi
 * 
 */
@Controller
@RequestMapping(value ="/tools")
@SessionAttributes({"submissionLongTermPartTimeInfoForm"})

public class SubmissionLongTermPartTimeInfoController extends AbstractSubmitController {
	
	@ModelAttribute("submissionLongTermPartTimeInfoForm") 
	public SubmissionLongTermPartTimeInfoForm populateForm() 
	{
		return new SubmissionLongTermPartTimeInfoForm();
	}
	public static Map<String,String> forwards = new HashMap<>();
	static{
		forwards.put(INPUT,"/tools/submissionLongTermPartTimeInfo.jsp");
		forwards.put("tools","redirect:/do/tools/toolsMenu/");
		forwards.put("confirm","redirect:/do/tools/uploadLongTermPartTimeInfo/?action=confirm");
		forwards.put("refresh","redirect:/do/tools/uploadLongTermPartTimeInfo/?action=refresh"); 
		forwards.put("confirmPage","/tools/submissionLongTermPartTimeInfoConfirmation.jsp");
	 ...
	 * Constructor.
	 */
	public SubmissionLongTermPartTimeInfoController() {
		super(SubmissionLongTermPartTimeInfoController.class);
	}

	@RequestMapping(value ="/uploadLongTermPartTimeInfo/",  method = {RequestMethod.GET}) 
	public String doDefault(@Valid @ModelAttribute("submissionLongTermPartTimeInfoForm") SubmissionLongTermPartTimeInfoForm actionForm, BindingResult bindingResult,HttpServletRequest request,HttpServletResponse response) 
	 ...
	 */
	@RequestMapping(value ="/uploadLongTermPartTimeInfo/" ,params={"actionLabel=send"}, method = {RequestMethod.POST}) 
	public String doSend (@Valid @ModelAttribute("submissionLongTermPartTimeInfoForm") SubmissionLongTermPartTimeInfoForm form, BindingResult bindingResult,HttpServletRequest request,HttpServletResponse response) 
	throws SystemException {
	 ...
	 * @return
	 */
	@RequestMapping(value ="/uploadLongTermPartTimeInfo/", params={"action=confirm"} , method =  {RequestMethod.GET}) 
	public String doConfirm (@Valid @ModelAttribute("submissionLongTermPartTimeInfoForm") SubmissionLongTermPartTimeInfoForm form, BindingResult bindingResult,HttpServletRequest request,HttpServletResponse response) 
	throws SystemException {
	...
	@RequestMapping(value ="/uploadLongTermPartTimeInfo/",params={"action=refresh"}   , method = {RequestMethod.GET}) 
	public String doRefresh (@Valid @ModelAttribute("submissionLongTermPartTimeInfoForm") SubmissionLongTermPartTimeInfoForm form, BindingResult bindingResult,HttpServletRequest request,HttpServletResponse response) 
	throws SystemException {
	...
	protected void populateForm(AutoForm form, UserProfile userProfile)
		...
		SubmissionLongTermPartTimeInfoForm theForm = (SubmissionLongTermPartTimeInfoForm) form;

		theForm.setDisplayFileUploadSection(userProfile.isAllowedUploadSubmissions()
	...
	protected String validate(
		...
		SubmissionLongTermPartTimeInfoForm form = (SubmissionLongTermPartTimeInfoForm) actionForm;
	...
	throws SystemException, UploadFileCannotFoundOrEmptyException {
		...
		if (file != null && StringUtils.isNotEmpty(file.getOriginalFilename())) {
			try {
				...
				throw new SystemException(e, SubmissionLongTermPartTimeInfoController.class.getName(), "processUploadRequest", "");
			}
