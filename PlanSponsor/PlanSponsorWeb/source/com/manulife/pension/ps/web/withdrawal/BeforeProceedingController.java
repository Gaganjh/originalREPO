...
public class BeforeProceedingController extends BaseWithdrawalController {
	...
	static{
	forwards.put("default","/withdrawal/beforeProceedingInitiate.jsp");
	forwards.put("defaultForPrintFriendly","/withdrawal/beforeProceedingInitiate.jsp?printFriendly=true");
	forwards.put("cancel","redirect:/do/withdrawal/loanAndWithdrawalRequestsInit/");
	forwards.put("next", "redirect:/do/withdrawal/entryStep1/");
    ...
    public BeforeProceedingController() {
        super(BeforeProceedingController.class);
    }
     ...
     */
    @RequestMapping(value ={"/beforeProceedingInitiate/"},  method =  {RequestMethod.GET}) 
...
//          GIFL 1C      
    ...
    /**
     * Determines the correct  forward to return to the originating page.
     * 
     * @param originator The originating page.
     * @return String - The String representing the originating page.
     */
     ...
     * @return String The forward to process.
    ...
    @RequestMapping(value ={"/beforeProceedingInitiate/"}, params= {"action=cancel"}, method =  {RequestMethod.POST}) 
    ...
    @RequestMapping(value = {"/beforeProceedingInitiate/"}, params= {"action=next"}, method =  {RequestMethod.POST}) 
    ...
    @RequestMapping(value ={"/beforeProceedingInitiate/"}, params= {"action=printPDF"}, method =  {RequestMethod.GET})
	   public String doPrintPDF(@Valid @ModelAttribute("withdrawalBeforeProceedingForm") BeforeProceedingForm form,BindingResult bindingResult,
