 ...
 */
public class EditContributionDetailBean implements Serializable {
	...
	private Collection contributionsByMoneyType;
	 ...
	 * constructor
	 */
	public EditContributionDetailBean() {
	}
	...
	/**
	 * @return Returns the contributionsByMoneyType.
	 */
	public Collection getContributionsByMoneyType() {
		return contributionsByMoneyType;
	}
	/**
	 * @param contributionsByMoneyType The contributionsByMoneyType to set.
	 */
	public void setContributionsByMoneyType(Collection contributionsByMoneyType) {
		this.contributionsByMoneyType = contributionsByMoneyType;
	}
	/**
	...
	/**
	 * @return Returns the totalContributions.
	 */
