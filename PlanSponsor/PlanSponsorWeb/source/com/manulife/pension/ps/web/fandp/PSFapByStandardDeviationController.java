...
import com.manulife.pension.platform.web.fap.tabs.FapByStandardDeviationController;
...
public class PSFapByStandardDeviationController extends FapByStandardDeviationController {
	...
	@RequestMapping(value = "/fapByStandardDeviation/", params = { "action=filter" }, method = { RequestMethod.POST })
	...
	/*@RequestMapping(value = "/fapByStandardDeviation/", method = { RequestMethod.POST, RequestMethod.GET })
	...
	@RequestMapping(value = "/fapByStandardDeviation/", params = { "action=sort,task=sort" }, method = {
	...
	@RequestMapping(value = "/fapByStandardDeviation/", params = { "action=reportsAndDownload",
	...
	@RequestMapping(value = "/fapByStandardDeviation/", params = { "action=changeDropDownList",
	...
	@RequestMapping(value = "/fapByStandardDeviation/", params = { "action=storeFapFormInSession",
