...
/**
 * Sort a section based on the requested sorting key & order
 * 
 * @author guweigu
 *
 */
...
public class MCSectionSortController extends MCSectionController {
	...
	public MCSectionSortController() {
		logger = Logger.getLogger(MCSectionSortController.class);
	}
	...
	protected void updatePreference(HttpServletRequest request,
		...
		pref.setSectionSort(selectedSection, request
				.getParameter(MCConstants.ParamSortKey), "true"
				.equals(request
	...
	@RequestMapping(value ="/sectionSort", method = {RequestMethod.GET})
