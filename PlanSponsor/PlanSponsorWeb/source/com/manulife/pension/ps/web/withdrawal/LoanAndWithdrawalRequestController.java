...
import com.manulife.pension.ps.web.validation.pentest.PSValidatorFWWithdrawalDefault;
...
/**
 * LoanAndWithdrawalRequestAction is the action class for the loan and withdrawal requests page.
 * 
 * @author Paul_Glenn
 */
@Controller
...
public class LoanAndWithdrawalRequestController extends BaseWithdrawalReportController {
	@ModelAttribute("loanAndWithdrawalRequestsForm") 
	public LoanAndWithdrawalRequestsForm populateFormLoan() 
	{
		return new LoanAndWithdrawalRequestsForm();
		
	}
	@ModelAttribute("searchWithdrawalRequestForm") 
	public SearchParticipantRequestWithdrawalForm populateFormSearch() 
	{
		return new SearchParticipantRequestWithdrawalForm();
		
	}

	private static final Logger logger = Logger.getLogger(LoanAndWithdrawalRequestController.class);
    ...
    private static final String CLASS_NAME = LoanAndWithdrawalRequestController.class.getName();
	...
	forwards.put("participantSearch","redirect:/do/withdrawal/searchSummary/");
	forwards.put("loanParticipantSearch","redirect:/do/loan/searchSummary/");
	forwards.put("sort","/WEB-INF/do/withdrawal/loanAndWithdrawalRequestsPage/");
	forwards.put("filter","/WEB-INF/do/withdrawal/loanAndWithdrawalRequestsPage/");
	forwards.put("print","/WEB-INF/do/withdrawal/loanAndWithdrawalRequestsPage/");
	forwards.put("page","/WEB-INF/do/withdrawal/loanAndWithdrawalRequestsPage/");
    ...
    @RequestMapping(value = "/loanAndWithdrawalRequests/", method = {RequestMethod.GET})
    public String doDefault(@Valid @ModelAttribute("loanAndWithdrawalRequestsForm") LoanAndWithdrawalRequestsForm reportForm,BindingResult bindingResult,
    ...
    public String doViewItem(final BaseReportForm reportForm,
		...
		return forwards.get( VIEW_ITEM_MAPPING);
    }
	...
	@Autowired
    private PSValidatorFWWithdrawalDefault psValidatorFWDefault;  
    ...
    @RequestMapping(value ="/loanAndWithdrawalRequests/" ,params={"task=sort"}, method =  {RequestMethod.POST}) 
    public String doSort(@Valid @ModelAttribute("loanAndWithdrawalRequestsForm")  LoanAndWithdrawalRequestsForm reportForm,BindingResult bindingResult,
            final HttpServletRequest request, final HttpServletResponse response)
            throws SystemException, ServletException, IOException {
    	
    	String forward=doSort(reportForm, request, response);
    	 return StringUtils.contains(forward,'/')?forward:forwards.get(forward); 
           }
    @RequestMapping(value ="/loanAndWithdrawalRequests/" ,params={"task=page"}, method =  {RequestMethod.POST}) 
    public String doPage(@Valid @ModelAttribute("loanAndWithdrawalRequestsForm")  LoanAndWithdrawalRequestsForm reportForm,BindingResult bindingResult,
            final HttpServletRequest request, final HttpServletResponse response)
            throws SystemException, ServletException, IOException {
    	
    	 String forward=doPage(reportForm, request, response);
    	 return StringUtils.contains(forward,'/')?forward:forwards.get(forward); 
           }
    /**
     * Method called when user clicks on the viewItem button for a record. Forwards the request to
     * the View Request page. No Validation is to be performed as is the case of the edititem which
     * goes to the Before Proceeding
     * @throws IOException 
     * @throws ServletException 
     */
    @RequestMapping(value ="/loanAndWithdrawalRequests/" ,params={"task=viewItem"}, method =  {RequestMethod.POST}) 
    public String doViewItem(@Valid @ModelAttribute("loanAndWithdrawalRequestsForm")  LoanAndWithdrawalRequestsForm reportForm,BindingResult bindingResult,
            final HttpServletRequest request, final HttpServletResponse response)
            throws SystemException, ServletException, IOException {
    	
    	 String forward=doViewItem(reportForm, request, response);
    	 return StringUtils.contains(forward,'/')?forward:forwards.get(forward); 
           }

    @RequestMapping(value ="/loanAndWithdrawalRequests/" ,params={"task=filter"}, method =  {RequestMethod.POST})
   	public String doFilter(@Valid @ModelAttribute("loanAndWithdrawalRequestsForm")  LoanAndWithdrawalRequestsForm reportForm,
       	...
       	Collection<GenericException> error=doValidate(reportForm, request);
       	if(!error.isEmpty()){
     ...
     * the edit one
     */
    @RequestMapping(value ="/loanAndWithdrawalRequests/" ,params={"action=editItem"}, method =  {RequestMethod.POST}) 
    public String doEditItem(  @Valid @ModelAttribute("loanAndWithdrawalRequestsForm")  LoanAndWithdrawalRequestsForm reportForm,BindingResult bindingResult,
            final HttpServletRequest request, final HttpServletResponse response)
            throws IOException, ServletException, SystemException {
    ...
    @RequestMapping(value ="/loanAndWithdrawalRequests/" ,params={"task=resetFilters"}, method =  {RequestMethod.POST}) 
    public String doResetFilters(
             @Valid @ModelAttribute("loanAndWithdrawalRequestsForm")  LoanAndWithdrawalRequestsForm reportForm,BindingResult bindingResult, final HttpServletRequest request,
    ...
    @RequestMapping(value ="/loanAndWithdrawalRequests/" ,params={"task=participantSearch"}, method =  {RequestMethod.POST}) 
    public String doParticipantSearch(
             @Valid @ModelAttribute("loanAndWithdrawalRequestsForm")  LoanAndWithdrawalRequestsForm reportForm,BindingResult bindingResult, final HttpServletRequest request,
            final HttpServletResponse response) throws IOException, ServletException,
            SystemException {
    	
    	Collection<GenericException> errors=doValidate(reportForm, request);
    	if(!errors.isEmpty()){
    		return forwards.get("input");
    	}
		final StopWatch stopWatch = new StopWatch();
		...
		return forwards.get("participantSearch");
    }
    @RequestMapping(value ="/loanAndWithdrawalRequests/" ,params={"task=loanParticipantSearch"}, method =  {RequestMethod.POST,RequestMethod.GET}) 
    public String doLoanParticipantSearch(
		...
		return forwards.get("loanParticipantSearch");
    }
