...
<html>
<title>Add Plan Sponsor Relationship Manager</title>
<body>
<h1>Add Plan Sponsor Relationship Manager</h1>
<p>
<form method="POST" action="/servlet/AddRMUser">
	...
	<tr>
	  <td><b>Relationship Manager's First Name:</b></td>
	  <td><input type="text" name="firstName" maxlength="32" /><td/>
	</tr>
	<tr>
	  <td><b>Relationship Manager's LastName:</b></td>
	  <td><input type="text" name="lastName" maxlength="32" /><td/>
	</tr>
	<tr>
	  <td><b>Relationship Manager's Email:</b></td>
	  <td><input type="text" name="email" maxlength="70" /><td/>
	</tr>
	<tr>
	  <td><b>Relationship Manager's Employee Number:</b></td>
