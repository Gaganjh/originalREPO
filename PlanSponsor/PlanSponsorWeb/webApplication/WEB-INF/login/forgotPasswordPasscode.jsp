...
<ps:form method="POST" action="/do/login/forgotPasswordPasscodeValidation/" modelAttribute="passwordResetAuthenticationForm" name="passwordResetAuthenticationForm" onsubmit="return doPreSubmit();">
							...
							<tr>
								...
								<td colspan="13" width="100%">
										<content:getAttribute beanName="resendPassword" attribute="text"/>&nbsp;<br>
											<strong><a href="#" onclick="document.forms['passwordResetAuthenticationForm'].submit();">
