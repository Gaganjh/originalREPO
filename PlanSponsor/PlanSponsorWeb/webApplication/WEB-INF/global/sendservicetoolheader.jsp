<%--New header in Send service page --%>
...
<c:set var="additionalJSP" value="${layoutBean.param('additionalIntroJsp')}" /> 
	            ...
	            <table>
	              <tr>
					...
					<logicext:and name="<%= Constants.USERPROFILE_KEY%>" property="currentContract.contractAllocated" op="notEqual" value="false"/>
						<logicext:then>
							<content:contentBean contentId="<%=ContentConstants.SEND_SERVICE_NMC_ACCESS_LINK %>"
