...
<c:set var="headerPage" value="${requestScope.layoutBean.headerPage}" scope="page" />
<c:set var="bodyPage" value="${requestScope.layoutBean.bodyPage}" scope="page" />
<c:set var="footerPage" value="${requestScope.layoutBean.footerPage}" scope="page" />
<c:set var="layoutPageBean" value="${requestScope.layoutBean.layoutPageBean}" scope="request" />
...
<c:forEach items="${requestScope.layoutBean.styleSheets}" var="sheets" >
...
<c:forEach items="${requestScope.layoutBean.javascripts}" var="scripts" >
