...
<%-- change window title for edit mode --%>			 	 
<% if (censusDetailsHelper.isEditMode()) { %>
<script type="text/javascript">
var temp = new Array();
temp = document.title.split('View');
document.title = temp[0] + 'Edit' + temp[1];
</script>
<% } %>
...
<c:if test="${layoutBean.getParam('suppressReportTools') !=true}">
			 	        <jsp:include page="/WEB-INF/tools/viewCensusDetailsToolsSection.jsp" flush="true" />
</c:if>
	              <%-- End of How To --%>
	            </td>
	          </tr>
