...
SubmissionUploadDetailBean paymentDetail = (SubmissionUploadDetailBean) pageContext.getAttribute("detail");
%>
...
<span class="highlightBold" id="accountsRow${theIndex}Total"><render:number property="instruction.totalValue" type="c"/></span>
			</td>
</c:if>
		</tr>
</c:forEach>
...
<c:if test="${detail.displayCreditPaymentSection ==true}">
			<td class="datadivider" width="1"></td>
			<td align="right">
				<table class="databorder" border="0" cellpadding="0" cellspacing="0" width="60">
					<tbody>
						<tr>
							<td><img src="/assets/unmanaged/images/spacer.gif" height="1" width="1"></td>
						</tr>
