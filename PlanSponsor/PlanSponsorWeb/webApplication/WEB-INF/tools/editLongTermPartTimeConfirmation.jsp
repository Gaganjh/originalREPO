...
<%@ page import="com.manulife.pension.ps.web.tools.EditLongTermPartTimeDetailBean" %>


<%
LongTermPartTimeDetailsReportData theReport = (LongTermPartTimeDetailsReportData)session.getAttribute(Constants.REPORT_BEAN);
pageContext.setAttribute("theReport",theReport,PageContext.PAGE_SCOPE);
EditLongTermPartTimeDetailBean detail = (EditLongTermPartTimeDetailBean)session.getAttribute(Constants.EDIT_LONG_TERM_PART_TIME_CONFIRM_DETAIL_DATA);
pageContext.setAttribute("detail",detail,PageContext.PAGE_SCOPE);
EditLongTermPartTimeDetailBean bean = (EditLongTermPartTimeDetailBean)session.getAttribute(Constants.EDIT_LONG_TERM_PART_TIME_CONFIRM_DETAIL_DATA);
...
<td><strong class="highlight">${sessionScope.editLongTermPartTimeDetailBean.confirmationNumber}</strong></td>
                          </tr>
                          <tr>
	                        <td nowrap><strong>Resubmitted by&nbsp;</strong></td>
<td><strong class="highlight">${sessionScope.editLongTermPartTimeDetailBean.sender}</strong></td>
                          </tr>
						  <tr>
...
<td><strong class="highlight">${sessionScope.editLongTermPartTimeDetailBean.numberOfRecords}</strong></td>
						  </tr>
						  <tr>
							  <td><strong>Submission type&nbsp;</strong></td>
<td><strong class="highlight">${sessionScope.editLongTermPartTimeDetailBean.submissionType}</strong></td>
						  </tr>
                          <tr>
                      		<td nowrap>&nbsp;</td>
                      		<td>&nbsp;</td>
