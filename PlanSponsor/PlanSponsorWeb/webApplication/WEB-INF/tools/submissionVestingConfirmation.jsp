...
<content:contentBean contentId="<%=ContentConstants.MISCELLANEOUS_TOOLS_VESTING_UPLOAD_BUTTON_DESCRIPTION%>"
                      type="<%=ContentConstants.TYPE_MISCELLANEOUS%>"
...
<td><input type="button" onclick="javascript:print(); return false;" name="actionLabel" class="button100Lg" value="print"/></td>
					<td width='15'></td>
<td><input type="submit" class="button175" onclick="window.location.href='/do/tools/vestingUpload/'; return false;" value="upload another file" /> </td>
		          </tr>
		          <tr>
