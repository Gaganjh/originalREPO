...
<jsp:useBean id="submissionLongTermPartTimeInfoForm" scope="session" class="com.manulife.pension.ps.web.tools.SubmissionLongTermPartTimeInfoForm" />
<%
...
<script type="text/javascript" > 
	function isFormChanged() {
		...
		if (isFileSectionShown) {
			var uploadFormObj = getFormByName("submissionLongTermPartTimeInfoForm");
	...
	<% if (submissionLongTermPartTimeInfoForm.isDisplayFileUploadSection()) { %>
	...
	function confirmSend() {
		...
		if (uploadcredit != 1 ) {
			...
			writeError("<content:getAttribute beanName="messageValidUploadInProgress" attribute="text"/>"+ "&nbsp;[" + <%=ContentConstants.SUBMISSION_UPLOAD_IN_PROGRESS%> + "]" +"<br>If you have trouble with your upload click <a href=\"/do/tools/uploadLongTermPartTimeInfo/\">here</a> to start over.");
		   	return false;
	...
	<A NAME="TopOfPage"></A>&nbsp;
          <table width="100%" border="0" cellpadding="0" cellspacing="0" class="fixedTable">
				...
				<td>
					<DIV id="inProgressDivision" style="display: none;";>
						<TABLE BORDER=0 CELLPADDING=1 CELLSPACING=0>
							...
							<br>If you have trouble with your upload click <a href="/do/tools/uploadLongTermPartTimeInfo/">here</a> to start over.
							</TD>
							</TR>
						</TABLE> 
					</DIV>
            ...
            <tr>
              <td height="20">
    	 		   <ps:form action="/do/tools/uploadLongTermPartTimeInfo/" modelAttribute="submissionLongTermPartTimeInfoForm" name="submissionLongTermPartTimeInfoForm" enctype="multipart/form-data" method="POST" onsubmit="return confirmSend();">
