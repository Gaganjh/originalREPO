...
<%
VestingDetailItem submissionItem = (VestingDetailItem)pageContext.getAttribute("submissionItem");
...
<% 
	int moneyTypesDisplayed = 3;
	int moneyTypeSize = 70;
	...
	if(vestingDetailsForm.isDisplayApplyLTPTCreditingField()){
		fieldApplyLTPTCreditingSize = 40;
	}
	...
	boolean maskSSN = vestingDetailsForm.isMaskSSN();
	boolean fixedTableVisible = false;
	String style_scrolling="overflow:scroll; overflow-y:hidden; z-index:2; width:750px;"; 
			...
			<tr class="tablehead" height="25">
				<td class="tableheadTD1" colspan="4">
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
					  <tr>
						<td width="28%" class="tableheadTD" nowrap>
				        ...
				        <td width="5%" align="right" class="tableheadTD">
				            <report:pageCounter report="theReport" formName="vestingDetailsForm"/>
				        </td>
				...
				<table witdh="100%" border="0" cellpadding="0" cellspacing="0">
					...
					<tr class="tablesubhead">
						<td align="center" width="20">
							<b><report:sort field="sourceRecordNo" direction="asc" formName="vestingDetailsForm">#</report:sort></b>
						</td>
						<td class="dataheaddivider" width="1"><b><img src="/assets/unmanaged/images/s.gif" width="1" height="1"></b></td>
						<td width="85">
							<b><report:sort field="ssn" direction="asc" formName="vestingDetailsForm">SSN</report:sort></b>
						</td>
						<td class="dataheaddivider" width="1"><b><img src="/assets/unmanaged/images/s.gif" width="1" height="1"></b></td>
						<td width="65">
							<b><report:sort field="empId" direction="asc" formName="vestingDetailsForm">Employee<br>ID</report:sort></b>
						</td>
						<td class="dataheaddivider" width="1"><b><img src="/assets/unmanaged/images/s.gif" width="1" height="1"></b></td>
						<td width="110">
							<b>First name</b>
						...
						<td class="dataheaddivider" width="1"><b><img src="/assets/unmanaged/images/s.gif" width="1" height="1"></b></td>
						<td width="110">
							<b><report:sort field="name" direction="asc" formName="vestingDetailsForm">Last name</report:sort></b>
						</td>
						<td class="dataheaddivider" width="1"><b><img src="/assets/unmanaged/images/s.gif" width="1" height="1"></b></td>
						<td width="30">
						...
						<td class="dataheaddivider" width="1"><b><img src="/assets/unmanaged/images/s.gif" width="1" height="1"></b></td>
						<td align="left" width="110"><b>Vesting<br>effective date</b></td>
...
<%String partIndex = pageContext.getAttribute("partIndex").toString();%>
					...
					int rowHeight = 20; if (participant.isDoubleRowHeight()) { rowHeight = 37; } %>
...
<c:if test="${submissionItem.vestingCSF==serviceProvided}">

							<b>Vesting<br>effective date</b>
</c:if>
<c:if test="${submissionItem.vestingCSF==serviceCalculated}">
<c:if test="${empty submissionItem.tpaSystemName}">
							<b>VYOS Date</b>
</c:if>
...
<c:set var="identifier" value="${moneyTypeHeader.moneyTypeId}"/>
							<td align="right" width="<%=moneyTypeSize%>">
								<report:errorIcon errors="<%=theReport%>" codes="M9,MV,C7,C4" value="${identifier.toString()}S"  />
...
${participant.vyos}&nbsp;&nbsp;&nbsp;
			...
			<table width="<%=750 - tableShrinkSize%>" border="0" cellpadding="0" cellspacing="0">
			<tr>
			  <td colspan="4" align="right"><report:pageCounter report="theReport" arrowColor="black" formName="vestingDetailsForm"/></td>
			</tr>
			</table>
