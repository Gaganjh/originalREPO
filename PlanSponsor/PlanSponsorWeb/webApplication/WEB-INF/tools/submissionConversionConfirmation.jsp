...
<td ><strong class="highlight">${detail.fileInformation}</strong></td>
                          </tr>
                          <tr>
                            <td height="14" nowrap><strong>File name </strong></td>
		...
		<tr align="center">
			...
			<td colspan="2">
		        ...
		        <table border="0" cellspacing="0" cellpadding="0" align="center">
		          <tr>	
<td title="<content:getAttribute beanName="historyButtonDescription" attribute="text"/>" ><input type="submit" class="button175" onclick="window.location.href='/do/tools/submissionHistory/'; return false;" value="submission history" /></td>
					<td width='15'></td>
<td title="<content:getAttribute beanName="printButtonDescription" attribute="text"/>" ><input type="button" onclick="javascript:print(); return false;" name="actionLabel" class="button100Lg" value="print"/></td>
					<td width='15'></td>
<td title="<content:getAttribute beanName="uploadButtonDescription" attribute="text"/>" ><input type="submit" class="button175" onclick="window.location.href='/do/tools/uploadConversionFile/'; return false;" value="upload another file" /></td>
		          </tr>
		        </table>
			</td>
			<td></td>
