...
<input type="hidden" name="advisorName" value="${fapForm.advisorName}"  /><%--  - name="fapForm" --%>
</c:if>  
<c:if test="${fapForm.advisorNameDisplayed}">
Enter Advisor Name: <form:input path="fapForm.advisorName" maxlength="30" /><%--  name="fapForm" --%>
<br /><br />
</c:if> 
<input type="hidden" name="advisorNameDisplayed" value="${fapForm.advisorNameDisplayed}"/><%--  - name="fapForm" --%>

<table>
    <tr>
        <td>
            <div class="button_login">
                <input style="font-size: 11px;width:100px" id="triggerIreport" type="button" value="Go" onclick="doViewReports()"/>
                <input style="width: 100px; font-size: 11px;" id="cancelIreport" type="button" value="Cancel" onclick="doCancelIreport()"/>
            </div>
        </td>
    </tr>
</table>
