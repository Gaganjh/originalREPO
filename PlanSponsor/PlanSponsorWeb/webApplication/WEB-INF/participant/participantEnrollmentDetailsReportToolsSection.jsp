...
<% 
 ...
 %>
          ...
          <% if (contentId.intValue() == ContentConstants.COMMON_PRINT_REPORT_TEXT) {
			  ...
			  <%-- PPR 50.	User must have a specific permission to be able to download the
			  	   address report. --%>

	          <%
	          	if (SecurityManager.getInstance().isUserAuthorized(userProfile, "/do/participant/partEnrollDetailDownload/") ) {
	          %>
                ...
                <%  String extension = null;
                	...
                	String result = "?task=download&ext=" + java.net.URLEncoder.encode(extension);
                	href= result;
			  		onclick="return true;";
                %>
			  <%
			  	} else { showLink = false; } //end if
			  %>
