...
<jsp:useBean id="participantAddressesReportForm" scope="session" type="com.manulife.pension.ps.web.participant.ParticipantAddressesReportForm" />
...
<c:if test="${participantAddressesReportForm.allowedToEdit ==false}">
<c:if test="${participantAddressesReportForm.allowedToAutoEnrollment ==false}">
...
<c:if test="${participantAddressesReportForm.allowedToEdit ==false}">
<c:if test="${participantAddressesReportForm.allowedToAutoEnrollment ==true}">
...
<c:if test="${participantAddressesReportForm.allowedToEdit ==true}">
<c:if test="${participantAddressesReportForm.allowedToAutoEnrollment ==false}">
<c:if test="${participantAddressesReportForm.allowedToAdd ==false}">
...
<c:if test="${participantAddressesReportForm.allowedToAdd ==true}">
...
<c:if test="${participantAddressesReportForm.allowedToAutoEnrollment ==true}">
<c:if test="${participantAddressesReportForm.allowedToAdd ==false}">
<c:set var="excludes"><%=ContentConstants.MISCELLANEOUS_CENSUS_ADD_EMPLOYEE_HOWTO%></c:set>
									<ps:howToBox howToLinks="howToLinks" howToTitle="HowToTitle" excludes="excludes"/>
</c:if>
<c:if test="${participantAddressesReportForm.allowedToAdd ==true}">
...
<c:if test="${layoutBean.getParam('suppressReportTools') !=true}">
	 	        <jsp:include page="participantAddressesReportToolsSection.jsp" flush="true" />
</c:if>
