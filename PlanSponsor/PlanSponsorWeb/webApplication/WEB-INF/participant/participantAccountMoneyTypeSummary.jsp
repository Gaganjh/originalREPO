...
<c:if test="${participantAccountForm.showNetContribEarnings ==false}">
				...
				<c:if test="${empty param.printFriendly }" >          
          		...
          		<c:if test="${not empty param.printFriendly }" >  
            		<td colspan="16" valign="bottom" class="box"><img src="/assets/unmanaged/images/participant_account_1.gif" width="117" height="30" border="0"><img src="/assets/unmanaged/images/money_type_summary_2.gif" width="118" height="30"><img src="/assets/unmanaged/images/money_type_details_1.gif" width="118" height="30" border="0"><img src="/assets/unmanaged/images/net_EE_deferrals_off.gif" width="118" height="30"></td>          
          		</c:if>
</c:if>
          <td height="30" class="databorder"><img src="/assets/unmanaged/images/s.gif" width="1" height="1"></td>
       </ps:isInternalOrTpa>
...
<c:if test="${participantAccountForm.showNetContribEarnings ==false}">
	        	...
	        	<c:if test="${not empty param.printFriendly }" >  
	        		<td colspan="16" valign="bottom" class="box"><img src="/assets/unmanaged/images/participant_account_1.gif" width="117" height="30" border="0"><img src="/assets/unmanaged/images/money_type_summary_2.gif" width="118" height="30"><img src="/assets/unmanaged/images/money_type_details_1.gif" width="118" height="30" border="0"></td>          
	        	</c:if>
</c:if>
	   	<td height="30" class="databorder"><img src="/assets/unmanaged/images/s.gif" width="1" height="1"></td>
...
<c:if test="${details.showLoanFeature eq'YES'}">
		    <td width="244" colspan="5" align="right" valign="bottom" class="tablesubhead"><b>Total assets excluding loans($)</b></td>    	  
...
<% if(style==1) style=2;else style=1; %>
        <tr>
          ...
          <td colspan="4" class="datacell<%=style%>"><b>Employee contributions<img src="/assets/unmanaged/images/s.gif" width="1" height="1"></b></td>
...
<c:if test="${details.showLoanFeature eq'YES'}">
            <td align="right" colspan="5" class="datacell<%=style%>">
  			  <render:number property="account.totalEmployeeContributionsAssets" defaultValue = ""  pattern="###,###,##0.00"/>
            </td>
            <td width="1" align="right" class="datadivider"><img src="/assets/unmanaged/images/s.gif" width="1" height="1"></td>
            <td align="right" colspan="5" class="datacell<%=style%>">
  			  <render:number property="account.totalEmployeeContributionsLoanAssets" defaultValue = ""  pattern="###,###,##0.00"/>              
            </td>
</c:if>
<c:if test="${details.showLoanFeature ne'YES'}">
		    <td colspan="5" align="right" class="datacell<%=style%>">&nbsp;</td>    	  
            <td colspan="6" align="right" valign="bottom" class="datacell<%=style%>">
              <render:number property="account.totalEmployeeContributionsAssets" defaultValue = ""  pattern="###,###,##0.00"/>
            </td>
</c:if>
          <td class="databorder"><img src="/assets/unmanaged/images/s.gif" width="1" height="1"></td>
...
<c:set var="employeeMoneyTypeSize" value="${account.employeeMoneyTypeTotals}"/>

<c:if test="${employeeMoneyTypeSize ne '0'}">
<c:forEach items="${theEmployeeMoneyTypeTotals}" var="employeeMoneyTypeTotals" >
  <% if(style==1) style=2;else style=1; %>
        <tr>
          <td class="databorder"><img src="/assets/unmanaged/images/s.gif" width="1" height="1"></td>
          <td colspan="4" class="datacell<%=style%>">
<span class="highlight">${employeeMoneyTypeTotals.moneyTypeName}</span>
          </td>
          <td class="datadivider"><img src="/assets/unmanaged/images/s.gif" width="1" height="1"></td>
<c:if test="${details.showLoanFeature eq'YES'}">
            <td align="right" colspan="5" class="datacell<%=style%>">
              <span class="highlight">
                <render:number property="employeeMoneyTypeTotals.balance" defaultValue = ""  pattern="###,###,##0.00"/>
              </span>  
            </td>
            <td width="1" align="right" class="datadivider"><img src="/assets/unmanaged/images/s.gif" width="1" height="1"></td>
            <td align="right" colspan="5" class="datacell<%=style%>">
              <span class="highlight">
                <render:number property="employeeMoneyTypeTotals.loanBalance" defaultValue = ""  pattern="###,###,##0.00"/>
              </span>
            </td>
</c:if>
<c:if test="${details.showLoanFeature ne'YES'}">
...
<c:if test="${employerMoneyTypeSize ne '0'}">
