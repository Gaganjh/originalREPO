...
<c:if test="${participantAccountForm.showNetContribEarnings ==true}">
				...
				<c:if test="${empty param.printFriendly }" >
              		<td colspan="16" valign="bottom" class="box"><a name="columns"></a><a href="javascript:selectMoneyReport('/do/participant/participantAccount/');"> </a><img src="/assets/unmanaged/images/participant_account_2.gif" width="117" height="30"><a href="javascript:selectMoneyReport('/do/participant/participantAccountMoneyTypeSummary/');"><img src="/assets/unmanaged/images/money_type_summary_1.gif" width="118" height="30" border="0"></a><a href="javascript:selectMoneyReport('/do/participant/participantAccountMoneyTypeDetails/');"><img src="/assets/unmanaged/images/money_type_details_1.gif" width="118" height="30" border="0"></a><a href="javascript:selectMoneyReport('/do/participant/participantAccountNetContribEarnings/');"><img src="/assets/unmanaged/images/after_tax_tab_off.gif" width="118" height="30" border="0"></a><a href="javascript:selectMoneyReport('/do/participant/participantAccountNetDeferral/');"><img src="/assets/unmanaged/images/net_EE_deferrals_off.gif" width="118" height="30" border="0"></a></td>
            	</c:if>
            	<c:if test="${not empty param.printFriendly }" >
              		<td colspan="16" valign="bottom" class="box"><img src="/assets/unmanaged/images/participant_account_2.gif" width="117" height="30"><img src="/assets/unmanaged/images/money_type_summary_1.gif" width="118" height="30" border="0"><img src="/assets/unmanaged/images/money_type_details_1.gif" width="118" height="30" border="0"><img src="/assets/unmanaged/images/after_tax_tab_off.gif" width="118" height="30" border="0"><img src="/assets/unmanaged/images/net_EE_deferrals_off.gif" width="118" height="30" border="0"></td>
            	</c:if>
</c:if>
<c:if test="${participantAccountForm.showNetContribEarnings ==false}">
				<!--if no after tax money - suppress the after tax money tab-->
				<c:if test="${empty param.printFriendly }" >
              		<td colspan="16" valign="bottom" class="box"><a name="columns"></a><a href="javascript:selectMoneyReport('/do/participant/participantAccount/');"> </a><img src="/assets/unmanaged/images/participant_account_2.gif" width="117" height="30"><a href="javascript:selectMoneyReport('/do/participant/participantAccountMoneyTypeSummary/');"><img src="/assets/unmanaged/images/money_type_summary_1.gif" width="118" height="30" border="0"></a><a href="javascript:selectMoneyReport('/do/participant/participantAccountMoneyTypeDetails/');"><img src="/assets/unmanaged/images/money_type_details_1.gif" width="118" height="30" border="0"></a><a href="javascript:selectMoneyReport('/do/participant/participantAccountNetDeferral/');"><img src="/assets/unmanaged/images/net_EE_deferrals_off.gif" width="118" height="30" border="0"></a></td>
            	</c:if>
            	<c:if test="${not empty param.printFriendly }" >
              		<td colspan="16" valign="bottom" class="box"><img src="/assets/unmanaged/images/participant_account_2.gif" width="117" height="30"><img src="/assets/unmanaged/images/money_type_summary_1.gif" width="118" height="30" border="0"><img src="/assets/unmanaged/images/money_type_details_1.gif" width="118" height="30" border="0"><img src="/assets/unmanaged/images/net_EE_deferrals_off.gif" width="118" height="30" border="0"></td>
            	</c:if> 
</c:if>
			<td height="30" class="databorder"><img src="/assets/unmanaged/images/s.gif" width="1" height="1"></td>
</c:if>
...
<c:if test="${participantAccountForm.asOfDateCurrent ==false}">
            <td height="30" class="databorder"><img src="/assets/unmanaged/images/s.gif" width="1" height="1"></td>
            <td colspan="1" valign="bottom" class="box"><a name="columns"></a><a href="javascript:selectMoneyReport('/do/participant/participantAccount/');"> </a><img src="/assets/unmanaged/images/participant_account_2.gif" width="117" height="30"></td>
      		<td colspan="15" align="left"><content:getAttribute beanName="moneyTypeReportsNotAvailable" attribute="text">
				  <content:param>
...
<c:if test="${participantAccountForm.showNetContribEarnings ==false}">
				<!--if no after tax money - suppress the after tax money tab-->         
           		<c:if test="${empty param.printFriendly }" >
              		<td colspan="16" valign="bottom" class="box"><a name="columns"></a><a href="javascript:selectMoneyReport('/do/participant/participantAccount/');"> </a><img src="/assets/unmanaged/images/participant_account_2.gif" width="117" height="30"><a href="javascript:selectMoneyReport('/do/participant/participantAccountMoneyTypeSummary/');"><img src="/assets/unmanaged/images/money_type_summary_1.gif" width="118" height="30" border="0"></a><a href="javascript:selectMoneyReport('/do/participant/participantAccountMoneyTypeDetails/');"><img src="/assets/unmanaged/images/money_type_details_1.gif" width="118" height="30" border="0"></a></td>
            	</c:if>
            	<c:if test="${not empty param.printFriendly }" >
              		<td colspan="16" valign="bottom" class="box"><img src="/assets/unmanaged/images/participant_account_2.gif" width="117" height="30"><img src="/assets/unmanaged/images/money_type_summary_1.gif" width="118" height="30" border="0"><img src="/assets/unmanaged/images/money_type_details_1.gif" width="118" height="30" border="0"></td>
            	</c:if>
</c:if>
            <td height="30" class="databorder"><img src="/assets/unmanaged/images/s.gif" width="1" height="1"></td>
</c:if>
...
<td colspan="${participantAccountForm.colspan}" width="90" align="right" valign="bottom" class="tablesubhead"><b>Percentage <br>of total(%)</b></td>
          ...
          <td colspan="3" width="154" align="right" valign="bottom" class="tablesubhead"><b>Ongoing contributions(%)</b></td>
</c:if>
<c:if test="${participantAccountForm.asOfDateCurrent ==false}">
...
<td width="90" height="1" colspan="${participantAccountForm.colspan}" align="right"></td>
    <td height="1" align="right"></td>
    <td width="122" height="1" colspan="1" align="right"></td>
    <td height="1" align="right"></td>
    <td width="122" height="1" colspan="1" align="right" ></td>
</c:if>
<c:if test="${participantAccountForm.asOfDateCurrent ==false}">
...
<c:if test="${participantAccountForm.asOfDateCurrent ==true}">
          <td align="right" class="datadivider"><img src="/assets/unmanaged/images/s.gif" width="1" height="1"></td>
          <td colspan="1" align="right" class="datacell<%=style%>"><b>Employee</b></td>
          <td align="right" class="datadivider"><img src="/assets/unmanaged/images/s.gif" width="1" height="1"></td>
          <td colspan="1" align="right" class="datacell<%=style%>"><b>Employer</b></td>
</c:if>
          <td class="databorder"><img src="/assets/unmanaged/images/s.gif" width="1" height="1"></td>
        </tr>
...
<c:if test="${participantAccountForm.asOfDateCurrent ==true}">
          <td align="right" class="datadivider"><img src="/assets/unmanaged/images/s.gif" width="1" height="1"></td>
          <td colspan="1" align="right" class="datacell<%=style%>"><render:number property="fund.employeeOngoingContributions" pattern="##0.00%" defaultValue="0.00%" scale="4" /></td>
          <td align="right" class="datadivider"><img src="/assets/unmanaged/images/s.gif" width="1" height="1"></td>
...
<% if(style==1) style=2;else style=1; %>
        <tr>
          <td class="databorder"><img src="/assets/unmanaged/images/s.gif" width="1" height="1"></td>
          <td colspan="4" class="datacell<%=style%>">&nbsp;&nbsp;<span class="highlight">Employee assets</span><img src="/assets/unmanaged/images/s.gif" width="1" height="1"></td>
          <td class="datadivider"><img src="/assets/unmanaged/images/s.gif" width="1" height="1"></td>
          <td align="right" class="datacell<%=style%>">
...
<c:if test="${fund.fundTotalNumberOfUnitsHeld !=0}">
				<render:number property="fund.employeeNumberOfUnitsHeld" defaultValue = "0.00"  pattern="###,###,##0.000000" scale="6"/>
</c:if>
</c:if>
<c:if test="${option.category.categoryCode ==PB}">
			&nbsp;
...
<c:if test="${option.category.categoryCode !=PB}">
<c:if test="${fund.fundTotalNumberOfUnitsHeld ==0}">
<c:if test="${fund.employeeCompositeRate !=0}">
				  <render:number property="fund.employeeCompositeRate" pattern="###.00" defaultValue="0" scale="4" />%
</c:if>
</c:if>
...
<c:if test="${option.category.categoryCode ==PB}">
          ...
          <td align="right" class="datadivider"><img src="/assets/unmanaged/images/s.gif" width="1" height="1"></td>
          <td class="datacell<%=style%>" align="right"><span class="highlight"><render:number property="fund.employeeBalance" defaultValue = "0.00"  pattern="###,###,##0.00"/></span></td>
          <td align="right" class="datadivider"><img src="/assets/unmanaged/images/s.gif" width="1" height="1"></td>
<td colspan="${participantAccountForm.colspan}" class="datacell<%=style%>" align="right">&nbsp;</td>
        <!--   Requirement PPR.85 -->
<c:if test="${participantAccountForm.asOfDateCurrent ==true}">
          <td align="right" class="datadivider"><img src="/assets/unmanaged/images/s.gif" width="1" height="1"></td>
...
<% if(style==1) style=2;else style=1; %>
        <tr>
          <td class="databorder"><img src="/assets/unmanaged/images/s.gif" width="1" height="1"></td>
          <td colspan="4" class="datacell<%=style%>">&nbsp;&nbsp;<span class="highlight">Employer assets<br>            
            <img src="/assets/unmanaged/images/s.gif" width="1" height="1"></span></td>
          <td class="datadivider"><img src="/assets/unmanaged/images/s.gif" width="1" height="1"></td>
          <td align="right" class="datacell<%=style%>">
	  <span class="highlight">
<c:if test="${option.category.categoryCode !=PB}">
...
<c:if test="${fund.fundTotalNumberOfUnitsHeld !=0}">
				<render:number property="fund.employerNumberOfUnitsHeld" defaultValue = "0.00"  pattern="###,###,##0.000000" scale="6"/>
</c:if>
</c:if>
<c:if test="${option.category.categoryCode ==PB}">
			&nbsp;
...
<c:if test="${option.category.categoryCode !=PB}">
<c:if test="${fund.fundTotalNumberOfUnitsHeld ==0}">
<c:if test="${fund.employerCompositeRate !=0}">
				  <render:number property="fund.employerCompositeRate" pattern="###.00" defaultValue="0" scale="4" />%
</c:if>
...
<c:if test="${option.category.categoryCode ==PB}">
          ...
          <td align="right" class="datadivider"><img src="/assets/unmanaged/images/s.gif" width="1" height="1"></td>
          <td align="right" class="datacell<%=style%>"><span class="highlight"><render:number property="fund.employerBalance" defaultValue = "0.00"  pattern="###,###,##0.00"/></span></td>
          <td align="right" class="datadivider"><img src="/assets/unmanaged/images/s.gif" width="1" height="1"></td>
<td colspan="${participantAccountForm.colspan}" align="right" class="datacell<%=style%>">&nbsp;</td>
      <!--     Requirement PPR.85 -->
<c:if test="${participantAccountForm.asOfDateCurrent ==true}">
