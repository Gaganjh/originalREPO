...
<content:contentBean contentId="<%=ContentConstants.PAYROLL_SELF_SERVICE_CONTRACT_INTRO_TEXT%>"
                     type="<%=ContentConstants.TYPE_MISCELLANEOUS%>"
                     id="payrollSelfServiceContractIntro"/>
  ...
  <tr>
    ...
    <td width="730" valign="top">
	  ...
	  <table width="730" border="0" cellspacing="0" cellpadding="0">
	    <tr>
	      <td width="530" ><img src="/assets/unmanaged/images/s.gif" width="530" height="1"></td>
	    ...
	    <tr>
	      <td valign="top">
	      <img src="/assets/unmanaged/images/s.gif" width="530" height="23"><br>
	        ...
	        <table width="530" border="0" cellspacing="0" cellpadding="0">
	          <tr>
	            ...
	            <td valign="top"><br>
				  ...
				  <c:otherwise>
				  	<content:getAttribute beanName="payrollSelfServiceContractIntro" attribute="text"/>
				  </c:otherwise>
				  </c:choose>
         		</td>
	            <td width="20"><img src="/assets/unmanaged/images/s.gif" width="20" height="1"></td>
...
<c:if test="${layoutBean.getParam('suppressReportTools') !=true}">
	 	        <jsp:include page="taskCenterTasksReportToolsSection.jsp" flush="true" />
</c:if>
