...
<c:if test="${empty  technicalDifficulties}">
	<c:if test="${empty param.printFriendly }" >
		<script language="javascript" type="text/javascript" src="/assets/unmanaged/javascript/calendar.js"></script>
		<script type="text/javascript" >
			function doReset() {
				document.forms['tpaCustomizeContractChangeHistoryReportForm'].task.value = 'default';
				document.tpaCustomizeContractChangeHistoryReportForm.submit();
			}
			function doBack() {
				document.forms['tpaCustomizeContractChangeHistoryReportForm'].task.value = 'back';
				document.tpaCustomizeContractChangeHistoryReportForm.submit();
			}
		</script>
	</c:if>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	<tr>
		...
		<td width="100%" valign="top">
			...
			&nbsp;
			<ps:form method="POST" action="/do/viewTpaCustomizedContractFeeChangeHistory/" modelAttribute="tpaCustomizeContractChangeHistoryReportForm" name="tpaCustomizeContractChangeHistoryReportForm">
							...
							<TD colSpan=9><TABLE border=0 cellSpacing=0 cellPadding=0
									...
									<TBODY>
										...
										<TR>
											...
											<TD><IMG src="/assets/unmanaged/images/s.gif" width=1
												height=1></TD>	
											<TD><IMG src="/assets/unmanaged/images/s.gif" width=215
												height=1></TD>
											<TD><IMG src="/assets/unmanaged/images/s.gif" width=1
												height=1></TD>
											<TD><IMG src="/assets/unmanaged/images/s.gif" width=1
										...
										<TR class=tablehead>
											...
											<td align="right" colspan="3" class="tableheadTDinfo">
											   <c:if test="${not empty  theReport.details}">
													<b><report:pageCounter report="theReport" formName="tpaCustomizeContractChangeHistoryReportForm" /></b>
												</c:if>
										  </td>
...
<form:options items="${tpaCustomizeContractChangeHistoryReportForm.displayNames}" />
...
<form:select path="standardScheduleApplied" disabled="${param.printFriendly}" >
 ...
 <form:select path="selectedFeeType" disabled="${param.printFriendly}">
																	...
																	<form:option value=""></form:option>
<form:options items="${tpaCustomizeContractChangeHistoryReportForm.tpaStandardFees}" itemValue="code" itemLabel="description"/>

																	<c:if
																		test="${ not empty tpaCustomizeContractChangeHistoryReportForm.tpaCustomFees }">
																		<form:option value=" ">--------------------------------------------------</form:option>
<form:options items="${tpaCustomizeContractChangeHistoryReportForm.tpaCustomFees}" itemValue="code" itemLabel="description"/>
										...
										<TR class=tablesubhead>
											...
											<TD height=25 vAlign=center align=left>
											   <report:sort field="changeDate" direction="asc" formName="tpaCustomizeContractChangeHistoryReportForm">
											...
											<TD class=dataheaddivider height=25><IMG
												src="/assets/unmanaged/images/s.gif" width=1 height=1></TD>
											<TD height=25 vAlign=center align=left>
											    <report:sort field="userName" direction="asc" formName="tpaCustomizeContractChangeHistoryReportForm">
													<strong>User</strong>
												</report:sort>
											</TD>
											<TD class=dataheaddivider height=25><IMG
												src="/assets/unmanaged/images/s.gif" width=1 height=1></TD>
											<TD height=25 vAlign=center align=left>
											    <report:sort field="type" direction="asc" formName="tpaCustomizeContractChangeHistoryReportForm">
													<strong>Type</strong>
												</report:sort>
											</TD>
											<TD class=dataheaddivider height=25><IMG
											...
											<TD height=25 vAlign=center align=right>
											    <report:sort field="changedValue" direction="asc" formName="tpaCustomizeContractChangeHistoryReportForm">
													<strong>Value</strong>
												</report:sort>
											</TD>
											<TD class=dataheaddivider height=25><IMG
												src="/assets/unmanaged/images/s.gif" width=1 height=1></TD>
											<TD height=25 vAlign=center align=right>
											    <report:sort field="standardScheduleApplied" direction="asc" formName="tpaCustomizeContractChangeHistoryReportForm">
...
<input type="button" onclick="return doBack();" name="button" class="button134" value="back"/>
