...
<jsp:useBean id="deferralForm" scope="session" type="com.manulife.pension.ps.web.transaction.DeferralChangeDetailsReportForm" /> 
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>    
    <td width="100%" valign="top">
    	...
    	<c:if test="${empty param.printFriendly}" >
        	<a href="/do/transaction/participantTransactionHistory/?profileId=<%=deferralForm.getProfileId()%>">Transaction History</a>
    	</c:if>
...
<c:if test="${not empty details}">
      ...
      <ps:form style="margin-bottom:0;" modelAttribute="deferralChangeDetailsForm" name="deferralChangeDetailsForm" method="POST" action="/do/transaction/participantTransactionHistory/">
<input type="hidden" name="profileId"/>
      ...
      <table width="340" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr class="tablehead">
          <td class="tableheadTD1" colspan="3"><b>Deferral change summary</b></td>
        </tr>
        <tr>
          ...
          <td width="338" align="left" valign="top" class="datacell1">
	        <table width="338" border="0" cellpadding="2" cellspacing="0">
	          <tr>
                ...
                <td width="228">Deferral update</td>	          
	          </tr>
...
<td width="228">${details.fullName}</td>
      ...
      <table border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="76"><img src="/assets/unmanaged/images/s.gif" width="76" height="1"></td>
          <td width="1"><img src="/assets/unmanaged/images/s.gif" width="1" height="1"></td>
          ...
          <td width="70"><img src="/assets/unmanaged/images/s.gif" width="70" height="1"></td>
          <td width="1"><img src="/assets/unmanaged/images/s.gif" width="1" height="1"></td>
          <td width="52"><img src="/assets/unmanaged/images/s.gif" width="52" height="1"></td>
          <td width="1"><img src="/assets/unmanaged/images/s.gif" width="1" height="1"></td>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr class="tablehead">
                <td class="tableheadTD1" valign="middle" width="360" >
                  <span class="">
<b>Details - ${deferralForm.transactionDateFormatted}</b>
                  </span> 
                </td>
              </tr>
            </table>
        ...
        <tr class="tablesubhead">
            <td class="databorder"><img src="/assets/unmanaged/images/s.gif" width="1" height="1"></td>   
            <td align="left"><b>Requested date</b></td>
            ...
            <td class="dataheaddivider"><img src="/assets/unmanaged/images/s.gif" width="1" height="1"></td>
            <td align="left"><b>Value requested</b></td>
            <td class="dataheaddivider"><img src="/assets/unmanaged/images/s.gif" width="1" height="1"></td>
            <td align="left"><b>Value updated</b></td>
            <td class="dataheaddivider"><img src="/assets/unmanaged/images/s.gif" width="1" height="1"></td>
...
<td>${theItem.valueBefore} <%-- filter="false" --%></td>
                <td class="datadivider"><img src="/assets/unmanaged/images/s.gif" width="1" height="1"></td>
<td>${theItem.valueRequested} <%-- filter="false" --%></td>
                <td class="datadivider"><img src="/assets/unmanaged/images/s.gif" width="1" height="1"></td>
<td>${theItem.valueUpdated} <%-- filter="false" --%></td>
                <td class="datadivider"><img src="/assets/unmanaged/images/s.gif" width="1" height="1"></td>
<td>${theItem.status}</td>
                <td class="datadivider"><img src="/assets/unmanaged/images/s.gif" width="1" height="1"></td>
<% if (userProfile.isInternalUser()) { %>                
		        <td colspan="2" title="<%=itemVal.getProcessedByInternal()%>" >
<% } else {  %>
	            <td colspan="2">
<% } %>		        
${theItem.changedBy}</td>
	    ...
	    <% if (itemVal.genSecondLine()) { %>
          ...
          <% } %>
		        ...
		        <td></td>
                <td class="datadivider"><img src="/assets/unmanaged/images/s.gif" width="1" height="1"></td>
<td colspan="12">${theItem.webComments} <%-- filter="false" --%></td>
                <td class="databorder"><img src="/assets/unmanaged/images/s.gif" width="1" height="1"></td>
		    </tr> 
		<% } %>
        ...
        <%-- Final boarder row --%>                    
        <ps:roundedCorner numberOfColumns="16"
                          emptyRowColor="white"
                          oddRowColor="white"
                          evenRowColor="beige"
                          name="theReport"
        ...
        <tr>
          <td colspan="16" align="right"><report:pageCounter report="theReport" arrowColor="black"/></td>
        </tr>
      </table>
