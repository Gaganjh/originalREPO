...
<%@page import="com.manulife.pension.ps.web.profiles.DeleteProfileForm"%>

<c:set var="theForm" value="${sessionScope.deleteProfileForm}"/>
...
<ps:form cssClass="margin-bottom:0;" method="POST"
	action="/do/profiles/deleteProfile/"name="deleteProfileForm" modelAttribute="deleteProfileForm">
