...
<script type="text/javascript">
	...
	function editProfile(theProfileId, contractNumber) {
		return doSubmit('/do/profiles/addContract/?profileId=' + theProfileId
				+ "&contractNumber=" + contractNumber
				+ "&clientUserAction=addContract");
	}
...
<ps:form method="POST" action="/do/profiles/viewContractInfo/" name="clientAddEditUserForm" modelAttribute="clientAddEditUserForm">
...
<td valign="top">${theForm.secondaryEmail}</td>
														...
														<tr class="datacell1">
															<td width="200" valign="top"><strong><span
																	id="label_telephone">Telephone&nbsp;</span></strong></td>
...
${theForm.telephoneExtension}
														...
														<tr class="datacell1">
															<td width="200" valign="top"><strong><span
																	id="label_fax">Fax&nbsp;</span></strong></td>
...
<td valign="top">${theForm.comments}</td>
...
<td valign="top">${theForm.webAccess}</td>
														...
														<logicext:if name="clientAddEditUserForm"
															...
															value="<%=AddEditClientUserForm.FORM_YES_CONSTANT%>">
															<logicext:then>
...
${theForm.profileStatus}
										...
										<jsp:include page="/WEB-INF/profiles/contractAccessViewContractInfoItem.jsp"/>
								...
								<table border="0" cellpadding="0" cellspacing="0" width="450">
									<tbody>
										<tr>
											<td align="right">
												<div align="left">
													<input name="backButton" value="back"
														onClick="return setActionAndSubmit('finish')"
														class="button134" type="submit">
												</div>
											</td>
											<c:if test="${userProfile.role.roleId ne 'PLC'}">
												<td align="right"><logicext:if
														name="clientAddEditUserForm" property="webAccess"
														op="equal"
														value="<%=AddEditClientUserForm.FORM_YES_CONSTANT%>">
														<logicext:and name="clientAddEditUserForm"
															property="profileStatus" op="notequal"
															value="<%=AddEditClientUserForm.PROFILE_STATUS_SUSPENDED%>" />
														<logicext:then>
															<input name="action"
																value="<%=AddEditClientUserForm.BUTTON_LABEL_RESET%>"
																class="button134" type="submit"
																onclick="return doSubmit('/do/profiles/viewUser/?action=reset&fromPSContactTab=true')">
														</logicext:then>
													</logicext:if></td>
												<td align="right"><logicext:if
														name="clientAddEditUserForm" property="profileStatus"
														op="notequal"
														value="<%=AddEditClientUserForm.PROFILE_STATUS_SUSPENDED%>">
														<logicext:then>
<c:set var="theProfileId" value="${clientAddEditUserForm.profileId}" />  

															<input name="action" value="edit this profile"
																onClick="editProfile('${theProfileId}', null);"
																class="button134" type="submit">
														</logicext:then>
													</logicext:if></td>
											</c:if>
										...
										<tr>
											<td width="150" align="right">
												<div align="left">
													<logicext:if name="clientAddEditUserForm"
														property="passwordState" op="equal"
														value="<%=com.manulife.pension.service.security.utility.SecurityConstants.LOCKED_PASSWORD_STATUS%>">
														<logicext:and name="clientAddEditUserForm"
															property="profileStatus" op="notequal"
															value="<%=AddEditClientUserForm.PROFILE_STATUS_SUSPENDED%>" />
														<logicext:then>
															<input name="action"
																value="<%=AddEditClientUserForm.BUTTON_LABEL_UNLOCK%>"
																class="button134" type="submit"
																onclick="return doSubmit('/do/profiles/viewContractInfo/?action=unlock')">
														</logicext:then>
													</logicext:if>
												</div>
											</td>
