...
<c:if test="${csfForm.displayNoticeGeneration !=true}">
		...
		<td width="20" align="right"><ps:fieldHilight name="vestingPercentagesMethod" singleDisplay="true" className="errorIcon" displayToolTip="true"/></td>
...
<c:if test="${userProfile.internalUser ==true}">
			<td colspan="2" width="302">&nbsp;
				<form:select id="vestingPercentagesMethod" path="vestingPercentagesMethod" onchange="checkVestingMethod();">
...
<c:if test="${userProfile.internalUser !=true}">
			<td colspan="2" width="302">&nbsp;
				<form:select path="vestingPercentagesMethod" onchange="checkVestingMethod();">
					<form:option value="NA">Service not available</form:option>
					<form:option value="TPAP">Submitted electronically by TPA</form:option>
</form:select>
			</td>
...
<c:if test="${csfForm.displayNoticeGeneration !=true}">
		...
		<td colspan="2" width="302">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
			<tr>
<td width="55"><form:radiobutton path="vestingDataOnStatement" value="Yes" />Yes</td>
<td width="247"><form:radiobutton path="vestingDataOnStatement" value="No" />No</td>
			</tr>
			</table>
		</td>
