...
&nbsp;&nbsp;&nbsp;&nbsp;<a href="#" onclick="javascript:openLoanFeatures();">Loan features at a glance</a>
				...
				<td width="1" class="greyborder"><img
					src="/assets/unmanaged/images/spacer.gif" border="0" height="1"	width="1"></td>
<td width="55"><form:radiobutton path="participantInitiateLoansInd" value="Yes"/>Yes</td>
<td width="247"><form:radiobutton path="participantInitiateLoansInd" value="No"/>No</td>
				<ps:trackChanges name="csfForm" property="participantInitiateLoansInd" />
			</tr>
</c:if>
        ...
        <tr class="datacell1">
			...
			<td width="1" class="greyborder"><img
				src="/assets/unmanaged/images/spacer.gif" border="0" height="1"	width="1"></td>
<td width="55"><form:radiobutton path="participantWithdrawalInd" value="Yes"/>Yes</td>
<td width="247"><form:radiobutton path="participantWithdrawalInd" value="No"/>No</td>
			<ps:trackChanges name="csfForm" property="participantWithdrawalInd" />
		</tr>
