				...
				<tr class="datacell1" id="sadSection">
					...
					<td colspan="2">&nbsp; 
						...
						<c:if test="${ csfForm.managedAccountSectionEditable}">
						    ...
						    <img        onclick="javascript:popupCalendar('managedAccountServiceAvailableToPptDate')"
							            src="/assets/unmanaged/images/cal.gif" border="0"> (mm/dd/yyyy)
						</c:if>           
					</td>
					<ps:trackChanges name="csfForm" property="managedAccountServiceAvailableToPptDate" />
				</tr>
			</c:if>
		</c:if>
	</tbody>
