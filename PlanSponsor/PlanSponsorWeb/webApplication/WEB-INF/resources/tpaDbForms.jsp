...
<tr>
	...
	<td width="54%">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				<td><img src="/assets/unmanaged/images/s.gif" width="500" height="15"></td>
			</tr>
		    <tr>
		   		<td>
			   		<table width="720" border="0" cellspacing="0" cellpadding="0">
						...
						<tr class="tablehead">
							<td class="tableheadTD1" colspan="4"><b><a href="/do/resources/tpaGaForms/">Defined Contribution</a> | Defined Benefit</b></td>
							<!-- <td colspan="4" class="tableheadTD" align="center"></td> -->
						</tr>
											
					<ps:tpaformsTable collection="tpaforms" layoutPage="layoutPageBean" typeOfForm="db"/>
					</table>
		   </tr>
	    </table>
