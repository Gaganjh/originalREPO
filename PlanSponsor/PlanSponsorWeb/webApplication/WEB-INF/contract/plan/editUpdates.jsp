...
<c:forEach items="${planDataForm.planDataUi.vestingSchedules}" var="vestingSchedule" varStatus="vestingScheduleStatus">
  <c:if test="${vestingSchedule.vestingSchedule.vestingScheduleType == scheduleConstants.VESTING_SCHEDULE_CUSTOMIZED}">
