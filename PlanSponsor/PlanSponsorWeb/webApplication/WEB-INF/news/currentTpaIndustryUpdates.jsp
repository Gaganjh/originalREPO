...
<content:contentUpdatesByGroup id="currentUpdates" collection="allCurrentUpdates" groupId="<%=ContentConstants.TPA_INDUSTRY_UPDATES_GROUP%>"/>
<content:contentUpdatesByGroup id="archivedUpdates" collection="allArchivedUpdates" groupId="<%=ContentConstants.TPA_INDUSTRY_UPDATES_GROUP%>"/>
...
<a href="/do/news/archivedTpaIndustryUpdates/#X${archUpdate.id}">
					more&gt;&gt;</a>
					<br><br>
				</td>
			...
			<tr>
				<td><b><content:getAttribute attribute="body3Header" beanName="layoutPageBean"/></b></td>
			</tr>
			<tr>
				<td class="greyText">
					<table width="100%" border="0" cellspacing="0" cellpadding="0" >
