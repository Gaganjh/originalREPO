...
<%// Since the tab's title is coming dynamically from content database, giving the name as tab 1,tab2.... %>
	<c:choose>
		<c:when test="${param.page == 'tab2'}">
			<c:set var="contentIdForTabContent" value="${contentConstants.TPA_LEGISLATIVE_UPDATES_TAB2}"  />
		</c:when>
		<c:when test="${param.page == 'tab3'}">
			<c:set var="contentIdForTabContent" value="${contentConstants.TPA_LEGISLATIVE_UPDATES_TAB3}"  />
		</c:when>
		<c:when test="${param.page == 'tab4'}">
			<c:set var="contentIdForTabContent" value="${contentConstants.TPA_LEGISLATIVE_UPDATES_TAB4}"  />
		</c:when>
		<c:when test="${param.page == 'tab5'}">
			<c:set var="contentIdForTabContent" value="${contentConstants.TPA_LEGISLATIVE_UPDATES_TAB5}"  />
		</c:when>
		<c:when test="${param.page == 'tab6'}">
			<c:set var="contentIdForTabContent" value="${contentConstants.TPA_LEGISLATIVE_UPDATES_TAB6}"  />
		</c:when>
	</c:choose>
	...
	<content:contentBean contentId="${contentConstants.TPA_LEGISLATIVE_UPDATES_TAB2}"
		type="${contentConstants.TYPE_MISCELLANEOUS}" beanName="Tab2" />
		
	<content:contentBean contentId="${contentConstants.TPA_LEGISLATIVE_UPDATES_TAB3}"
		type="${contentConstants.TYPE_MISCELLANEOUS}" beanName="Tab3" /> 
		
	<content:contentBean contentId="${contentConstants.TPA_LEGISLATIVE_UPDATES_TAB4}"
		type="${contentConstants.TYPE_MISCELLANEOUS}" beanName="Tab4" />
		
	<content:contentBean contentId="${contentConstants.TPA_LEGISLATIVE_UPDATES_TAB5}"
		type="${contentConstants.TYPE_MISCELLANEOUS}" beanName="Tab5" />
		
	<content:contentBean contentId="${contentConstants.TPA_LEGISLATIVE_UPDATES_TAB6}"
