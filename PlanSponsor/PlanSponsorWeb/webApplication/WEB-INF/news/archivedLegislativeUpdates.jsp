...
<content:contentUpdatesByGroup id="currentUpdates" collection="allCurrentUpdates" groupId="<%=ContentConstants.LEGISLATIVE_UPDATES_GROUP%>"/>
<content:contentUpdatesByGroup id="archivedUpdates" collection="allArchivedUpdates" groupId="<%=ContentConstants.LEGISLATIVE_UPDATES_GROUP%>"/>
...
<a name="X${archUpdate.id}"></a>
	...
	<c:if test="${not empty currentUpdates}">
			  <tr>
				<td class="redText" align="left"><b><content:getAttribute beanName="layoutPageBean" attribute="body1Header"/></b><br><br></td>
			  </tr>
...
<a href="/do/news/currentLegislativeUpdates/#X${update.id}">
					more&gt;&gt;</a>
					<br><br>
				</td>
