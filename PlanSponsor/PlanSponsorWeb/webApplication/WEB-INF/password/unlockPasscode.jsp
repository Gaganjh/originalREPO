...
<c:set var="myForm2" value="${USERINFO_KEY}" />
        ...
        <table width="525" border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td height="27"><b>Unlock security code confirmation</b></td>
          </tr>
          <tr>
            <td colspan="8">
...
<td width="132"><input type="submit" class="button100Lg" name="action" value="<%= ManagePasswordForm.BUTTON_LABEL_FINISH %>" />
          </tr>
        </table>
        </ps:form>
