...
<c:if test="${censusSummaryReportForm.allowedToEdit ==false}">
<c:if test="${censusSummaryReportForm.allowedToAutoEnrollment ==false}">
...
<c:if test="${censusSummaryReportForm.allowedToEdit ==false}">
<c:if test="${censusSummaryReportForm.allowedToAutoEnrollment ==true}">
<c:set var="excludes" value="${ContentConstants.MISCELLANEOUS_CENSUS_ADD_EMPLOYEE_HOWTO},${ContentConstants.MISCELLANEOUS_CENSUS_EDIT_EMPLOYEE_HOWTO}"/>
								<ps:howToBox howToLinks="howToLinks" howToTitle="HowToTitle" excludes="excludes"/>
</c:if>
</c:if>
		                	<%-- Edit = true, AE = false, Add = false/true --%>
<c:if test="${censusSummaryReportForm.allowedToEdit ==true}">
<c:if test="${censusSummaryReportForm.allowedToAutoEnrollment ==false}">
<c:if test="${censusSummaryReportForm.allowedToAdd ==false}">
...
<c:if test="${censusSummaryReportForm.allowedToAdd ==true}">
...
<c:if test="${layoutBean.getParam('suppressReportTools') !=true}">
	 	        <jsp:include page="censusSummaryReportToolsSection.jsp" flush="true" />
</c:if>
