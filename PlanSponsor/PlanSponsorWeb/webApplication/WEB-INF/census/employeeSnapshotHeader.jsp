					...
					if ((Integer.parseInt(contentId) == ContentConstants.COMMON_READ_THIS_REPORT_TEXT)) { %>			    
			          <content:contentBean contentId="<%=ContentConstants.COMMON_READ_THIS_REPORT_TEXT%>"
						...
						<%
							...
							boolean vestingSectionAvailable = VestingHelper
									.isVestingInformationAvailable(userProfile
									.getCurrentContract().getContractNumber());

							if (vestingSectionAvailable) {
								howToReadReportLinkParamName = "howToReadReportLinkWithVesting";
							} else {
								howToReadReportLinkParamName = "howToReadReportLinkWithoutVesting";
							}
