...
<%-- Tax Section --%>
/**
 * Handler for changes in the federal tax dropdown
 */ 
 ...
 */
 function handleFederalTaxInputChanged() {
	return handleFieldChanged(document.getElementById("recipientFederalTaxInputId"), 
	                          noIndex, noIndex, validateFederalTaxInput, recalculate, noUpdate, 
 ...
 */ 
 function handleRecalculateButtonClicked() {
  ...
  function handleSaveAndExitClicked() {
	...
	<%-- Handles send for review being clicked --%>
	function handleSendForReviewClicked() {
