...
<%-- GIFL 1C start --%>
		<% 
			...
			Boolean isParticipantGIFLEnabled = (Boolean)request.getSession(false).getAttribute("isParticipantGIFLEnabled");
			boolean giflInd = isParticipantGIFLEnabled.booleanValue();
			if(giflInd)
			{
		%>
			<tr>
