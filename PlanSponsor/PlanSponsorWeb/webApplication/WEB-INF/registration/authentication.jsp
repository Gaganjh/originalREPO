...
<table width="760" border="0" cellpadding="0" cellspacing="0">
	  ...
	  <tbody>
		<ps:form method="POST" modelAttribute="registerForm" name="registerForm" action="/do/registration/authentication/" >
			<tr>
				<td width="5%">
											...
											<tbody>
												...
												<tr>
													<td colspan="2" valign="top">
														<p class="boldText"><strong>Enter your contract number, SSN and PIN and click continue:</strong></p></td>
												</tr>
												<tr>
													<td colspan="2"><img src="/assets/unmanaged/images/s.gif" width="1" height="1"></td>
												</tr>
												<tr>
													<td width="135" class="highlight"><ps:label fieldId="contractNumber" mandatory="false">Contract number</ps:label></td>
													<td width="228">
<input type="text" name="contractNumber" size="18" maxlength="<%=Constants.CONTRACT_NUMBER_MAX_LENGTH%>" autocomplete="off" class="inputField" value="${e:forHtmlAttribute(registerForm.contractNumber)}">
													</td>
												</tr>
												<tr>
													<td class="highlight"><ps:label fieldId="ssn" mandatory="false">Social security number</ps:label></td>
													<td width="228">
													 <form:password path="ssnOne" id="ssnOne" cssClass="inputField"  showPassword="true" size="3" maxlength="3"/>
													 <form:password  path="ssnTwo" id="ssnTwo" cssClass="inputField"   showPassword="true" size="2" maxlength="2"/>
													 <form:password  path="ssnThree" id ="ssnThree" cssClass="inputField" showPassword="true"  size="4" maxlength="4"/>
													</td>
												</tr>
												<tr>
