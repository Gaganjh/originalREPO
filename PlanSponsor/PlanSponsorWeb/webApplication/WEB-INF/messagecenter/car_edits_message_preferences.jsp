...
<%@page import="java.util.Enumeration"%><style type="text/css">
...
cashAccountTemplates[0] = 'displayMap[179_8]';
cashAccountTemplates[1] = 'displayMap[178_8]';
cashAccountTemplates[2] = 'displayMap[180_8]';
...
function doSave(frm, action) {
    ...
    if (frm.elements['applyToAll'] != null && typeof(frm.elements['applyToAll']) != "undefined" && frm.elements['applyToAll'].checked) {
...
<ps:form method="post" modelAttribute="messagePrefForm" name="messagePrefForm" action="/do/mcCarView/editMessagePreferences" >
