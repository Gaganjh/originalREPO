...
<c:set var="howtoId" value="${layoutBean.getParam('howto')}" /> 
			          ...
			          <c:if test="${empty layoutBean.getParam('skipPrint')}">
			          ...
			          <tr>
			            ...
			            <td>
			          	...
			          	<%
			          		...
			          		if (userProfile.isBundledGACAR()
			          				&& ((MCUtils.isInGlobalContext(request)) || (userProfile
			          						.getCurrentContract().isBundledGaIndicator() && !MCUtils
			          						.getContractList(userProfile).isEmpty()))) { %>
