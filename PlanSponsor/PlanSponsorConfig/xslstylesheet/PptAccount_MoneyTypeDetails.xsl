								...
								<fo:table-row background-color="#deded8">
									<fo:table-cell padding-start="0.2cm">
										<fo:block font-family="Verdana" font-size="14pt">
											<xsl:value-of select="bodyHeader2" />
										</fo:block>
									</fo:table-cell>
									<fo:table-cell padding-start="0.2cm">
						...
						<fo:table>
							...
							<fo:table-header>
								<fo:table-row background-color="#deded8" display-align="center">
									<fo:table-cell padding-start="0.1cm" number-rows-spanned="2" xsl:use-attribute-sets="solid.blue.border" text-align="left">
										<fo:block padding-before="0.2cm" padding-after="0.1cm" xsl:use-attribute-sets="verdana_font.size_10">
											Investment Option
										</fo:block>
									</fo:table-cell>
									<fo:table-cell padding-start="0.1cm" number-rows-spanned="2" xsl:use-attribute-sets="solid.blue.border" text-align="center">
										<fo:block padding-before="0.2cm" padding-after="0.1cm" xsl:use-attribute-sets="verdana_font.size_10">
											Class
										</fo:block>
									</fo:table-cell>
									...
									<fo:table-cell padding-start="0.1cm" number-columns-spanned="2" xsl:use-attribute-sets="solid.blue.border" text-align="center">
										<fo:block padding-before="0.2cm" padding-after="0.1cm" xsl:use-attribute-sets="verdana_font.size_10">
											Balance Subtotals($)
										</fo:block>
									</fo:table-cell>
									...
									<fo:table-cell padding-start="0.1cm" number-rows-spanned="2" xsl:use-attribute-sets="solid.blue.border">
					...
					<fo:table-body>
						...
						<xsl:for-each select="reportDetails/reportDetail">
								...
								<fo:table-row>
									...
									<fo:table-row keep-with-previous="always" background-color="#deded8">
										<fo:table-cell padding-start="0.2cm"  number-columns-spanned="8">
											<fo:block font-family="Verdana" font-size="14pt">
										...
										<xsl:for-each select="fundDetail">
											<fo:table-row display-align="center">	
												...
												<fo:table-cell padding-end="0.1cm" xsl:use-attribute-sets="solid.blue.border.3sides">
													<fo:block padding-before="0.1cm" text-align="right" xsl:use-attribute-sets="verdana_font.size_10">
														<fo:inline>
															<xsl:if test="eeBalanceFund">
																<xsl:value-of select="eeBalanceFund" />
															</xsl:if>
														</fo:inline>
													</fo:block>
												</fo:table-cell>
												<fo:table-cell padding-end="0.1cm" xsl:use-attribute-sets="solid.blue.border.3sides">
													<fo:block padding-before="0.1cm" text-align="right" xsl:use-attribute-sets="verdana_font.size_10">
														<fo:inline>
															<xsl:if test="erBalanceFund">
																<xsl:value-of select="erBalanceFund" />
															</xsl:if>
														</fo:inline>
													</fo:block>
												</fo:table-cell>
											...
											<xsl:for-each select="moneyTypes">
												<fo:table-row>
													<fo:table-cell padding-start="0.1cm" xsl:use-attribute-sets="solid.blue.border" text-align="left">
														<fo:block padding-before="0.2cm" padding-after="0.1cm" xsl:use-attribute-sets="verdana_font.size_10">
													...
													<fo:table-cell padding-end="0.1cm" xsl:use-attribute-sets="solid.blue.border">
														<fo:block text-align="right" padding-before="0.2cm" padding-after="0.1cm" xsl:use-attribute-sets="verdana_font.size_10">
															...
															<xsl:if test="pbFundCategory">-</xsl:if>
															<xsl:if test="compositeRate">-</xsl:if>
														</fo:block>
													</fo:table-cell>
													<fo:table-cell padding-end="0.1cm" xsl:use-attribute-sets="solid.blue.border">
														<fo:block text-align="right" padding-before="0.2cm" padding-after="0.1cm" xsl:use-attribute-sets="verdana_font.size_10">
															<xsl:if test="eeBalance">
																<xsl:value-of select="eeBalance" />
															</xsl:if>
															<xsl:if test="not(eeBalance)">-</xsl:if>
														</fo:block>
													</fo:table-cell>
													<fo:table-cell padding-end="0.1cm" xsl:use-attribute-sets="solid.blue.border">
														<fo:block text-align="right" padding-before="0.2cm" padding-after="0.1cm" xsl:use-attribute-sets="verdana_font.size_10">
															<xsl:if test="erBalance">
																<xsl:value-of select="erBalance" />
															</xsl:if>
															<xsl:if test="not(erBalance)">-</xsl:if>
														</fo:block>
													</fo:table-cell>
													<fo:table-cell padding-end="0.1cm" xsl:use-attribute-sets="solid.blue.border.3sides">
