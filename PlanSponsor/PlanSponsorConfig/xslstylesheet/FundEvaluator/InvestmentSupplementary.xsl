...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format">
	<xsl:template name="InvestmentSupplementaryTemplate">
				...
				<fo:block space-before="32px">
					<fo:table table-layout="fixed" width="100%">
						...
						<fo:table-header>
							<fo:table-row>
								<fo:table-cell
									xsl:use-attribute-sets="Investment_Supplementary_table_level_1_Class_column_header_cell">
									<fo:block>
						...
						<fo:table-body>
							<xsl:for-each select="fundsByAssetClass/assetHouses/assetHouse">
								...
								<xsl:if test="count(fundsBySortOrder) &gt; 0">
									<xsl:variable name="assetClassID_var">
										...
										<xsl:for-each select="ancestor::iEvaluatorReport/fundDetails/fund[@id=$test_var]">
											...
											<fo:table-row display-align="center" height="13px">
												...
												<!--showing the list of Morningstar Benchmark Category -->
												<fo:table-cell padding-start="0.1cm"
													xsl:use-attribute-sets="solid_blue_border_1BottomSide_fundrank">
																	...
																	<fo:table-cell >
																		<xsl:choose>     
																			<xsl:when test="@fundMorningstarCategory !=null or @fundMorningstarCategory !=''">         
																				<fo:block text-align="center"><xsl:value-of select="@fundMorningstarCategory " /></fo:block>
																			</xsl:when>
																			<xsl:otherwise>
																	...
																	<fo:table-cell xsl:use-attribute-sets="Investment_Supplementary_table_level_3_column_header_cell">
																		<xsl:choose>     
																			<xsl:when test="@oneYearFundRank !=null or @oneYearFundRank !=''">         
																				<fo:block xsl:use-attribute-sets="fund_ranking_fund_detail"><xsl:value-of select="@oneYearFundRank" /></fo:block>
																			</xsl:when>
																			<xsl:otherwise>
														...
														<fo:table table-layout="fixed" width="100%">
															...
															<fo:table-body>
																<fo:table-row height="13px">
																	...
																	<fo:table-cell xsl:use-attribute-sets="Investment_Supplementary_table_level_3_column_header_cell">
																		<xsl:choose>     
																			<xsl:when test="@threeYearFundRank !=null or @threeYearFundRank !=''">         
																				<fo:block xsl:use-attribute-sets="fund_ranking_fund_detail"><xsl:value-of select="@threeYearFundRank" /></fo:block>
																			</xsl:when>
																			<xsl:otherwise>
																				<fo:block xsl:use-attribute-sets="fund_ranking_fund_detail">n/a</fo:block>
																			</xsl:otherwise>
																	...
																	<fo:table-cell xsl:use-attribute-sets="Investment_Supplementary_table_level_3_column_header_cell">
																		<xsl:choose>     
																			<xsl:when test="@fiveYearFundRank !=null or @fiveYearFundRank !=''">         
																				<fo:block xsl:use-attribute-sets="fund_ranking_fund_detail"><xsl:value-of select="@fiveYearFundRank" /></fo:block>
																			</xsl:when>
																			<xsl:otherwise>
																				<fo:block xsl:use-attribute-sets="fund_ranking_fund_detail">n/a</fo:block>
																			</xsl:otherwise>
																	...
																	<fo:table-cell xsl:use-attribute-sets="Investment_Supplementary_table_level_3_column_header_cell">
																		<xsl:choose>     
																			<xsl:when test="@tenYearFundRank !=null or @tenYearFundRank !=''">         
																				<fo:block xsl:use-attribute-sets="fund_ranking_fund_detail"><xsl:value-of select="@tenYearFundRank" /></fo:block>
																			</xsl:when>
																			<xsl:otherwise>
																				<fo:block xsl:use-attribute-sets="fund_ranking_fund_detail">n/a</fo:block>
																			</xsl:otherwise>
									...
									<xsl:if test="$isLastAssetHouse_var != 'yes' or $isLastAssetClassID_var != 'yes'">
