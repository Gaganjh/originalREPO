...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format">
    ...
    <xsl:template name="PerformanceAndExpensesTemplate">
                            ...
                            <fo:table table-layout="fixed" width="100%">
                                    ...
                                    <fo:table-row display-align="center">
                                        ...
                                        <fo:table-cell xsl:use-attribute-sets="performance_table_level_1_column_header_cell" number-columns-spanned="4">
                                            <fo:block display-align="before">
                                                ...
                                                <fo:block>
                                                    <xsl:value-of select="customization/asOfDateRorQe"/>
                                                    <fo:inline font-family="Arial Narrow" font-size="5pt" baseline-shift="super">*1</fo:inline>
                                                </fo:block>
                                            </fo:block>
                                        </fo:table-cell>
                                ...
                                <fo:table-body>
                                    ...
                                    <xsl:for-each select="fundsByAssetClass/assetHouses/assetHouse">
                                        <xsl:variable name="assetHouseID_var">
                                        ...
                                        <xsl:for-each select="assetClasses/assetClass">
                                          <xsl:if test="count(fundsBySortOrder) &gt; 0">
                                            ...
                                            <xsl:if test="$assetClassID_var !='BALLCFLSF' and $assetClassID_var !='GA3' and $assetClassID_var !='GA5' and $assetClassID_var !='G10'">

                                                <fo:table-row>
                                                    <fo:table-cell>
                                                        <xsl:attribute name="number-columns-spanned">18</xsl:attribute>
                                                        <fo:table table-layout="fixed" width="100%">
                                                            ...
                                                            <fo:table-body>
                                                                ...
                                                                <xsl:for-each select="fundsBySortOrder/fund">
                                                                    ...
                                                                    <xsl:for-each select="ancestor::iEvaluatorReport/fundDetails/fund[@id=$test_var]">
                                                                        ...
                                                                        <xsl:variable name="isRorSinceInceptionQeHypothetical_var">
                                                                    <xsl:value-of select="fundMetrics/rorQe/rorSinceInceptionQe/@isHypothetical"/>
                                                                        </xsl:variable>
                                                                    ...
                                                                    <fo:table-row display-align="center" height="12px">
                                                                        ...
                                                                        <xsl:choose>
																			<xsl:when test="$isRorSinceInceptionQeHypothetical_var = 'true'">
																				<fo:block xsl:use-attribute-sets="performance_table_cell_ror_sinceInception_hypothetical">
                                    ...
                                    <xsl:for-each select="fundDetails/guaranteedFundInterestRates">
                                        <fo:table-row height="13px">
                                            ...
                                            <fo:table-cell><fo:block></fo:block></fo:table-cell>
                                            <fo:table-cell padding-end="0.2cm" background-color="#E1A825" xsl:use-attribute-sets="performance_table_asset_class_title">
                                                <xsl:attribute name="number-columns-spanned">17</xsl:attribute>
                                                    <fo:block>
                                                            GUARANTEED ACCOUNTS
                                                    </fo:block>
                                                </fo:table-cell>
