...
<xsl:include href="pageDefinition.xsl" />
	...
	<xsl:template match="deferralChangeDetails">
							...
							<fo:table-body>
									<xsl:for-each select="txnDetails/txnDetail">
										<fo:table-row display-align="center">
											<xsl:if test="webComments">
												<fo:table-cell padding-start="0.1cm" border-collapse="collapse" number-rows-spanned="2" xsl:use-attribute-sets="solid.blue.border">
											...
											<xsl:if test="not(webComments)">
												...
												<fo:table-cell padding-end="0.1cm" xsl:use-attribute-sets="solid.blue.border">
													<fo:block padding-before="0.1cm" text-align="right" xsl:use-attribute-sets="verdana_font.size_10">				
															<xsl:value-of select="valueRequested" />
													</fo:block>
												</fo:table-cell>
												<fo:table-cell padding-end="0.1cm" xsl:use-attribute-sets="solid.blue.border">
													<fo:block padding-before="0.1cm" text-align="right" xsl:use-attribute-sets="verdana_font.size_10">				
															<xsl:value-of select="valueUpdated" />
													</fo:block>
												</fo:table-cell>
												<fo:table-cell padding-start="0.1cm" xsl:use-attribute-sets="solid.blue.border">
													<fo:block padding-before="0.1cm" xsl:use-attribute-sets="verdana_font.size_10">				
											...
											<xsl:if test="webComments">
											<fo:table-row display-align="center">
												<fo:table-cell border-collapse="collapse" number-columns-spanned="6" padding-start="0.1cm" xsl:use-attribute-sets="solid.blue.border.3sides">
													<fo:block padding-before="0.1cm" xsl:use-attribute-sets="verdana_font.size_10">	
														<xsl:apply-templates select="webComments" />
													</fo:block>
												</fo:table-cell>
											</fo:table-row>
											</xsl:if>
