...
<xsl:include href="HtmlToFoTransform.xsl" />
	...
	<xsl:template match="classConversion">
						...
						<fo:table>
							...
							<fo:table-body>
								...
								<fo:table-row>
									...
									<fo:table-cell padding-start="0.5cm"> <!--light grey color -->
										<fo:block padding-start="0.5cm" padding-before="0.2cm" xsl:use-attribute-sets="fonts_group1.size_11" font-weight="bold" background-color="#eceae3">
											<xsl:apply-templates select="summaryInfo/subHeader" />
										</fo:block>
										<fo:block padding-start="0.5cm" padding-before="0.2cm" xsl:use-attribute-sets="fonts_group1.size_11" background-color="#eceae3">
												<fo:inline>
													Transaction Type:
												</fo:inline>
										...
										<fo:block padding-start="0.5cm" xsl:use-attribute-sets="fonts_group1.size_11" background-color="#eceae3">
											<fo:inline>
												SSN: 
											</fo:inline>
											<fo:inline font-weight="bold">
										...
										<fo:block padding-start="0.5cm"  xsl:use-attribute-sets="fonts_group1.size_11" background-color="#eceae3">
											...
											<fo:inline font-weight="bold">
												<xsl:value-of select="summaryInfo/totalToAmt" />
											</fo:inline>
										</fo:block>
										<fo:block padding-start="0.5cm" padding-before="0.2cm" xsl:use-attribute-sets="fonts_group1.size_11" background-color="#eceae3">
											<fo:inline>
							...
							<fo:table-header>
								<fo:table-row background-color="#deded8" display-align="left">
									...
									<fo:table-cell padding-end="0.1cm" xsl:use-attribute-sets="solid.blue.border">
										<fo:block padding-before="0.1cm" padding-after="0.1cm" xsl:use-attribute-sets="verdana_font.size_10" text-align="right">
											Transfer Out ($)
										</fo:block>
									</fo:table-cell>
								...
								<xsl:for-each select="reportSummaryDetails/reportSummaryDetail">
									...
									<xsl:for-each select="fundTxn">
										<fo:table-row>
											...
											<fo:table-cell padding-end="0.1cm" xsl:use-attribute-sets="solid.blue.border.3sides">
												<fo:block padding-before="0.1cm" text-align="right" xsl:use-attribute-sets="verdana_font.size_10">
													<xsl:value-of select="toAmt" />
												</fo:block>
											</fo:table-cell>
											<fo:table-cell padding-end="0.1cm" xsl:use-attribute-sets="solid.blue.border.3sides">
												<fo:block padding-before="0.1cm" text-align="right" xsl:use-attribute-sets="verdana_font.size_10">
													<xsl:value-of select="toUnitValue" />
												</fo:block>
											</fo:table-cell>
											<fo:table-cell padding-end="0.1cm" xsl:use-attribute-sets="solid.blue.border.3sides">
												<fo:block padding-before="0.1cm" text-align="right" xsl:use-attribute-sets="verdana_font.size_10">
													<xsl:value-of select="toNoOfUnits" />
												</fo:block>
											</fo:table-cell>
										</fo:table-row>
									</xsl:for-each>
