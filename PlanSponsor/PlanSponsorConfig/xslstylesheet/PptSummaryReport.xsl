				...
				<fo:flow flow-name="xsl-region-body">
					...
					<fo:block space-before="0.5cm">
						...
						<fo:table>
							...
							<xsl:if test="filters/quickManagedAccountChecked or filters/customManagedAccountChecked">
									<fo:table-row>
										<fo:table-cell padding-before="0.1cm" padding-start="0.6cm">
											<fo:block font-weight="bold">
										...
										<fo:table-cell padding-before="0.1cm" padding-start="0.6cm">
											<fo:block>
												<xsl:value-of select="filters/quickManagedAccountChecked" />
												<xsl:value-of select="filters/customManagedAccountChecked" />
											</fo:block>
										</fo:table-cell>
									</fo:table-row>
								</xsl:if>
					...
					<fo:block space-before="0.2cm">
						<fo:table>
							<xsl:if test="not(descendant::*/outstandingLoans) and not(descendant::*/rothMoney) and not(descendant::*/defaultGateway) and not(descendant::*/defaultManagedAccount) and not(descendant::*/division)">
							...
							<xsl:if test="not(descendant::*/outstandingLoans) and not(descendant::*/rothMoney) and not(descendant::*/defaultGateway) and not(descendant::*/defaultManagedAccount) and descendant::*/division">
							...
							<xsl:if test="not(descendant::*/outstandingLoans) and descendant::*/rothMoney and not(descendant::*/defaultGateway) and not(descendant::*/defaultManagedAccount) and not(descendant::*/division)">
							...
							<xsl:if test="not(descendant::*/outstandingLoans) and descendant::*/rothMoney and not(descendant::*/defaultGateway) and not(descendant::*/defaultManagedAccount) and descendant::*/division">
								<fo:table-column column-width="16%" xsl:use-attribute-sets="table-borderstyle"/>
								<fo:table-column column-width="13%" xsl:use-attribute-sets="table-borderstyle"/>
								<fo:table-column column-width="9%" xsl:use-attribute-sets="table-borderstyle"/>
								<fo:table-column column-width="9%" xsl:use-attribute-sets="table-borderstyle"/>
							...
							<xsl:if test="not(descendant::*/outstandingLoans) and not(descendant::*/rothMoney) and descendant::*/defaultGateway and not(descendant::*/defaultManagedAccount) and not(descendant::*/division)">
								<fo:table-column column-width="17%" xsl:use-attribute-sets="table-borderstyle"/>
								<fo:table-column column-width="10%" xsl:use-attribute-sets="table-borderstyle"/>
								<fo:table-column column-width="10%" xsl:use-attribute-sets="table-borderstyle"/>
								<fo:table-column column-width="10%" xsl:use-attribute-sets="table-borderstyle"/>
							...
							<xsl:if test="not(descendant::*/outstandingLoans) and not(descendant::*/rothMoney) and descendant::*/defaultGateway and not(descendant::*/defaultManagedAccount) and descendant::*/division">
								<fo:table-column column-width="16%" xsl:use-attribute-sets="table-borderstyle"/>
								<fo:table-column column-width="10%" xsl:use-attribute-sets="table-borderstyle"/>
								<fo:table-column column-width="9%" xsl:use-attribute-sets="table-borderstyle"/>
								<fo:table-column column-width="9%" xsl:use-attribute-sets="table-borderstyle"/>
							...
							<xsl:if test="not(descendant::*/outstandingLoans) and descendant::*/rothMoney and descendant::*/defaultGateway and not(descendant::*/defaultManagedAccount) and not(descendant::*/division)">
							...
							<xsl:if test="not(descendant::*/outstandingLoans) and descendant::*/rothMoney and descendant::*/defaultGateway and not(descendant::*/defaultManagedAccount) and descendant::*/division">
							...
							<xsl:if test="not(descendant::*/outstandingLoans) and not(descendant::*/rothMoney) and not(descendant::*/defaultGateway) and descendant::*/defaultManagedAccount and not(descendant::*/division)">
								<fo:table-column column-width="17%" xsl:use-attribute-sets="table-borderstyle"/>
								<fo:table-column column-width="10%" xsl:use-attribute-sets="table-borderstyle"/>
								<fo:table-column column-width="10%" xsl:use-attribute-sets="table-borderstyle"/>
								<fo:table-column column-width="10%" xsl:use-attribute-sets="table-borderstyle"/>
							...
							<xsl:if test="not(descendant::*/outstandingLoans) and not(descendant::*/rothMoney) and not(descendant::*/defaultGateway) and descendant::*/defaultManagedAccount and descendant::*/division">
								<fo:table-column column-width="16%" xsl:use-attribute-sets="table-borderstyle"/>
								<fo:table-column column-width="10%" xsl:use-attribute-sets="table-borderstyle"/>
								<fo:table-column column-width="9%" xsl:use-attribute-sets="table-borderstyle"/>
								<fo:table-column column-width="9%" xsl:use-attribute-sets="table-borderstyle"/>
							...
							<xsl:if test="not(descendant::*/outstandingLoans) and not(descendant::*/rothMoney) and descendant::*/defaultGateway and descendant::*/defaultManagedAccount and not(descendant::*/division)">
								<fo:table-column column-width="16%" xsl:use-attribute-sets="table-borderstyle"/>
								<fo:table-column column-width="10%" xsl:use-attribute-sets="table-borderstyle"/>
								<fo:table-column column-width="9%" xsl:use-attribute-sets="table-borderstyle"/>
								<fo:table-column column-width="9%" xsl:use-attribute-sets="table-borderstyle"/>
							...
							<xsl:if test="not(descendant::*/outstandingLoans) and descendant::*/rothMoney and not(descendant::*/defaultGateway) and descendant::*/defaultManagedAccount and not(descendant::*/division)">
								<fo:table-column column-width="15%" xsl:use-attribute-sets="table-borderstyle"/>
								<fo:table-column column-width="9%" xsl:use-attribute-sets="table-borderstyle"/>
								<fo:table-column column-width="10%" xsl:use-attribute-sets="table-borderstyle"/>
								<fo:table-column column-width="10%" xsl:use-attribute-sets="table-borderstyle"/>
							...
							<xsl:if test="not(descendant::*/outstandingLoans) and not(descendant::*/rothMoney) and descendant::*/defaultGateway and descendant::*/defaultManagedAccount and descendant::*/division">
								<fo:table-column column-width="12%" xsl:use-attribute-sets="table-borderstyle"/>
								<fo:table-column column-width="9%" xsl:use-attribute-sets="table-borderstyle"/>
								<fo:table-column column-width="9%" xsl:use-attribute-sets="table-borderstyle"/>
								<fo:table-column column-width="9%" xsl:use-attribute-sets="table-borderstyle"/>
							...
							<xsl:if test="not(descendant::*/outstandingLoans) and descendant::*/rothMoney and not(descendant::*/defaultGateway) and descendant::*/defaultManagedAccount and descendant::*/division">
								<fo:table-column column-width="12%" xsl:use-attribute-sets="table-borderstyle"/>
								<fo:table-column column-width="9%" xsl:use-attribute-sets="table-borderstyle"/>
								<fo:table-column column-width="9%" xsl:use-attribute-sets="table-borderstyle"/>
								<fo:table-column column-width="9%" xsl:use-attribute-sets="table-borderstyle"/>
							...
							<xsl:if test="not(descendant::*/outstandingLoans) and descendant::*/rothMoney and descendant::*/defaultGateway and descendant::*/defaultManagedAccount and not(descendant::*/division)">
								<fo:table-column column-width="12%" xsl:use-attribute-sets="table-borderstyle"/>
								<fo:table-column column-width="9%" xsl:use-attribute-sets="table-borderstyle"/>
								<fo:table-column column-width="9%" xsl:use-attribute-sets="table-borderstyle"/>
								<fo:table-column column-width="9%" xsl:use-attribute-sets="table-borderstyle"/>
							...
							<xsl:if test="not(descendant::*/outstandingLoans) and descendant::*/rothMoney and descendant::*/defaultGateway and descendant::*/defaultManagedAccount and descendant::*/division">
							...
							<xsl:if test="descendant::*/outstandingLoans and not(descendant::*/rothMoney) and not(descendant::*/defaultGateway) and not(descendant::*/defaultManagedAccount) and not(descendant::*/division)">
								<fo:table-column column-width="17%" xsl:use-attribute-sets="table-borderstyle"/>
								<fo:table-column column-width="9%" xsl:use-attribute-sets="table-borderstyle"/>
								<fo:table-column column-width="10%" xsl:use-attribute-sets="table-borderstyle"/>
								<fo:table-column column-width="10%" xsl:use-attribute-sets="table-borderstyle"/>
							...
							<xsl:if test="descendant::*/outstandingLoans and not(descendant::*/rothMoney) and not(descendant::*/defaultGateway) and not(descendant::*/defaultManagedAccount) and descendant::*/division">
								<fo:table-column column-width="15%" xsl:use-attribute-sets="table-borderstyle"/>
								<fo:table-column column-width="10%" xsl:use-attribute-sets="table-borderstyle"/>
								<fo:table-column column-width="9%" xsl:use-attribute-sets="table-borderstyle"/>
								<fo:table-column column-width="9%" xsl:use-attribute-sets="table-borderstyle"/>
							...
							<xsl:if test="descendant::*/outstandingLoans and not(descendant::*/rothMoney) and descendant::*/defaultGateway and not(descendant::*/defaultManagedAccount) and not(descendant::*/division)">
								<fo:table-column column-width="17%" xsl:use-attribute-sets="table-borderstyle"/>
								<fo:table-column column-width="9%" xsl:use-attribute-sets="table-borderstyle"/>
								<fo:table-column column-width="9%" xsl:use-attribute-sets="table-borderstyle"/>
								<fo:table-column column-width="9%" xsl:use-attribute-sets="table-borderstyle"/>
							...
							<xsl:if test="descendant::*/outstandingLoans and not(descendant::*/rothMoney) and descendant::*/defaultGateway and not(descendant::*/defaultManagedAccount) and descendant::*/division">
								<fo:table-column column-width="10%" xsl:use-attribute-sets="table-borderstyle"/>
								<fo:table-column column-width="8%" xsl:use-attribute-sets="table-borderstyle"/>
								<fo:table-column column-width="8%" xsl:use-attribute-sets="table-borderstyle"/>
								<fo:table-column column-width="9%" xsl:use-attribute-sets="table-borderstyle"/>
							...
							<xsl:if test="descendant::*/outstandingLoans and descendant::*/rothMoney and not(descendant::*/defaultGateway) and not(descendant::*/defaultManagedAccount) and not(descendant::*/division) ">
							...
							<xsl:if test="descendant::*/outstandingLoans and descendant::*/rothMoney and not(descendant::*/defaultGateway) and not(descendant::*/defaultManagedAccount) and descendant::*/division ">
								<fo:table-column column-width="11%" xsl:use-attribute-sets="table-borderstyle"/>
								<fo:table-column column-width="9%" xsl:use-attribute-sets="table-borderstyle"/>
								<fo:table-column column-width="9%" xsl:use-attribute-sets="table-borderstyle"/>
								<fo:table-column column-width="9%" xsl:use-attribute-sets="table-borderstyle"/>
							...
							<xsl:if test="descendant::*/outstandingLoans and descendant::*/rothMoney and descendant::*/defaultGateway and not(descendant::*/defaultManagedAccount) and not(descendant::*/division) ">
								<fo:table-column column-width="12%" xsl:use-attribute-sets="table-borderstyle"/>
								<fo:table-column column-width="9%" xsl:use-attribute-sets="table-borderstyle"/>
								<fo:table-column column-width="9%" xsl:use-attribute-sets="table-borderstyle"/>
								<fo:table-column column-width="9%" xsl:use-attribute-sets="table-borderstyle"/>
							...
							<xsl:if test="descendant::*/outstandingLoans and descendant::*/rothMoney and descendant::*/defaultGateway and not(descendant::*/defaultManagedAccount) and descendant::*/division ">
								<fo:table-column column-width="10%" xsl:use-attribute-sets="table-borderstyle"/>
								<fo:table-column column-width="7%" xsl:use-attribute-sets="table-borderstyle"/>
								<fo:table-column column-width="8%" xsl:use-attribute-sets="table-borderstyle"/>
								<fo:table-column column-width="9%" xsl:use-attribute-sets="table-borderstyle"/>
							...
							<xsl:if test="descendant::*/outstandingLoans and not(descendant::*/rothMoney) and not(descendant::*/defaultGateway) and descendant::*/defaultManagedAccount and not(descendant::*/division)">
								<fo:table-column column-width="17%" xsl:use-attribute-sets="table-borderstyle"/>
								<fo:table-column column-width="9%" xsl:use-attribute-sets="table-borderstyle"/>
								<fo:table-column column-width="9%" xsl:use-attribute-sets="table-borderstyle"/>
								<fo:table-column column-width="9%" xsl:use-attribute-sets="table-borderstyle"/>
							...
							<xsl:if test="descendant::*/outstandingLoans and not(descendant::*/rothMoney) and not(descendant::*/defaultGateway) and descendant::*/defaultManagedAccount and descendant::*/division">
								<fo:table-column column-width="11%" xsl:use-attribute-sets="table-borderstyle"/>
								<fo:table-column column-width="8%" xsl:use-attribute-sets="table-borderstyle"/>
								<fo:table-column column-width="8%" xsl:use-attribute-sets="table-borderstyle"/>
								<fo:table-column column-width="9%" xsl:use-attribute-sets="table-borderstyle"/>
							...
							<xsl:if test="descendant::*/outstandingLoans and descendant::*/rothMoney and not(descendant::*/defaultGateway) and descendant::*/defaultManagedAccount and not(descendant::*/division) ">
								<fo:table-column column-width="12%" xsl:use-attribute-sets="table-borderstyle"/>
								<fo:table-column column-width="9%" xsl:use-attribute-sets="table-borderstyle"/>
								<fo:table-column column-width="9%" xsl:use-attribute-sets="table-borderstyle"/>
								<fo:table-column column-width="9%" xsl:use-attribute-sets="table-borderstyle"/>
							...
							<xsl:if test="descendant::*/outstandingLoans and not(descendant::*/rothMoney) and descendant::*/defaultGateway and descendant::*/defaultManagedAccount and not(descendant::*/division)">
								<fo:table-column column-width="12%" xsl:use-attribute-sets="table-borderstyle"/>
								<fo:table-column column-width="8%" xsl:use-attribute-sets="table-borderstyle"/>
								<fo:table-column column-width="8%" xsl:use-attribute-sets="table-borderstyle"/>
								<fo:table-column column-width="9%" xsl:use-attribute-sets="table-borderstyle"/>
								...
								<xsl:if test="descendant::*/outstandingLoans and descendant::*/rothMoney and descendant::*/defaultGateway and descendant::*/defaultManagedAccount and not(descendant::*/division) ">
								<fo:table-column column-width="12%" xsl:use-attribute-sets="table-borderstyle"/>
								<fo:table-column column-width="10%" xsl:use-attribute-sets="table-borderstyle"/>
								<fo:table-column column-width="7%" xsl:use-attribute-sets="table-borderstyle"/>
								<fo:table-column column-width="9%" xsl:use-attribute-sets="table-borderstyle"/>
							...
							<xsl:if test="descendant::*/outstandingLoans and descendant::*/rothMoney and not(descendant::*/defaultGateway) and descendant::*/defaultManagedAccount and descendant::*/division ">
								<fo:table-column column-width="12%" xsl:use-attribute-sets="table-borderstyle"/>
								<fo:table-column column-width="10%" xsl:use-attribute-sets="table-borderstyle"/>
								<fo:table-column column-width="7%" xsl:use-attribute-sets="table-borderstyle"/>
								<fo:table-column column-width="9%" xsl:use-attribute-sets="table-borderstyle"/>
							...
							<xsl:if test="descendant::*/outstandingLoans and not(descendant::*/rothMoney) and descendant::*/defaultGateway and descendant::*/defaultManagedAccount and descendant::*/division ">
								<fo:table-column column-width="12%" xsl:use-attribute-sets="table-borderstyle"/>
								<fo:table-column column-width="9%" xsl:use-attribute-sets="table-borderstyle"/>
								<fo:table-column column-width="8%" xsl:use-attribute-sets="table-borderstyle"/>
								<fo:table-column column-width="9%" xsl:use-attribute-sets="table-borderstyle"/>
							...
							<xsl:if test="descendant::*/outstandingLoans and descendant::*/rothMoney and descendant::*/defaultGateway and descendant::*/defaultManagedAccount and descendant::*/division ">
								<fo:table-column column-width="11%" xsl:use-attribute-sets="table-borderstyle"/>
								<fo:table-column column-width="7%" xsl:use-attribute-sets="table-borderstyle"/>
								<fo:table-column column-width="8%" xsl:use-attribute-sets="table-borderstyle"/>
								<fo:table-column column-width="8%" xsl:use-attribute-sets="table-borderstyle"/>
							...
							<fo:table-header>
								<fo:table-row background-color="#deded8" display-align="center">
									...
									<xsl:if test="descendant::*/defaultManagedAccount">
										<fo:table-cell padding-start="0.1cm" xsl:use-attribute-sets="solid.blue.border.3sides" text-align="left">
											<fo:block padding-before="0.1cm" xsl:use-attribute-sets="verdana_font.size_10">
												Managed
											</fo:block>
							...
							<fo:table-body>
								<xsl:for-each select="txnDetails/txnDetail">
									<fo:table-row display-align="center">
										...
										<xsl:if test="defaultManagedAccount">
											<fo:table-cell padding-end="0.1cm" xsl:use-attribute-sets="solid.blue.border.3sides" text-align="left">
												<fo:block padding-before="0.1cm" xsl:use-attribute-sets="verdana_font.size_10">
													<xsl:value-of select="defaultManagedAccount" />
												</fo:block>
											</fo:table-cell>
										</xsl:if>
									</fo:table-row>
