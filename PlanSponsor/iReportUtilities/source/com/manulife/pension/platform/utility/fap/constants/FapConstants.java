package com.manulife.pension.platform.utility.fap.constants;
...
public interface FapConstants extends CommonConstants {
	...
	// JH Signature Fund Scorecard Tab Columns key
	public static final String FUNDSCORECARD_TAB_COLUMNS_MAP = "jhSignatureFundScorecardTabColumnsMap";
	...
	public static final String PERFORMANCE_FEES_TAB = "Performance & Fees<br/>&nbsp;";
	public static final String STANDARD_DEVIATION_TAB = "Standard <br/>Deviation";
	public static final String FUND_CHAR_I_TAB = "Fund Characteristics I<br/>&nbsp;";
	public static final String FUND_CHAR_II_TAB = "Fund Characteristics II<br/>&nbsp;";
	public static final String MORNINGSTAR_TAB = "Morningstar <br/>&nbsp;";
	public static final String FUND_CHECK_TAB = "FundCheck® <br/> Commentary";
	...
	public static final String TPA_FUND_CHECK_TAB = "FundCheck® <br/> Commentary";
	...
	public static final String FUND_CHECK_TAB_ID = "fundCheck";
	public static final String FUNDSCORECARD_TAB_ID = "jhSignatureFundScorecard";
	...
	public static final String FUND_CHECK_URL = "/do/fap/fabByFundCheck/";
	...
	public static final String FUND_CHECK_LEVEL2COLUMNS = "FundCheck";
	public static final String PRICES_YTD_LEVEL2COLUMNS_CSV = "PricesAndYTDCsv";
	public static final String FUNDSCORECARD_LEVEL2COLUMNS = "JHSignatureFundScorecard";
