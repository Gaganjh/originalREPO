...
public class MorningstarRatingsAndTickersByRiskReturnReport extends AbstractRiskReturnReport {
    public MorningstarRatingsAndTickersByRiskReturnReport(ReportOptions options) {
